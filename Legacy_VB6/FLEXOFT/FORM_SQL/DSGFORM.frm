...
Begin VB.Form DSGFORM 
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.Frame Frame12 
         BackColor       =   &H00C0FFFF&
         Caption         =   "Lineas a Imprimir de Grilla"
         Height          =   850
         Left            =   120
         TabIndex        =   96
         Top             =   3300
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   120
      OleObjectBlob   =   "DSGFORM.frx":6658
      Top             =   7320
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   300
      OleObjectBlob   =   "DSGFORM.frx":688C
      TabIndex        =   39
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
...
Sub CrearNuevoBoton(NOMBRE As String, Caption As String, PosX As Integer, PosY As Integer, ancho As Integer, Alto As Integer)

    Set oControl = Controls.Add("VB.CommandButton", NOMBRE)
    oControl.Visible = True
    oControl.Caption = Caption
    oControl.Width = ancho
    oControl.Height = Alto
    oControl.Left = PosX
    oControl.Top = PosY
...
Private Sub Option3_Click()
    PRINTGRI$ = "0"
    If Option3.Value = True Then PRINTGRI$ = "0"
End Sub
Private Sub Option4_Click()
    PRINTGRI$ = "0"
    If Option4.Value = True Then PRINTGRI$ = "1"
End Sub
Private Sub Option5_Click()
    PRINTGRI$ = "0"
    If Option5.Value = True Then PRINTGRI$ = "2"
End Sub
...
Private Sub Command13_Click()
    DEVALOBA.Label14 = Label14
    DEVALOBA.Height = 5100
    DEVALOBA.Caption = "Parametro Reemplazable"
    '
    If Label19.Caption = "TEXT" Then
       DEVALOBA.Height = DEVALOBA.Frame3.Top + DEVALOBA.Frame3.Height + 100 + (DEVALOBA.Height - DEVALOBA.ScaleHeight)
       DEVALOBA.Caption = "Caja de Texto - Entrada de Datos"
    End If
    '
    DEVALOBA.Show 1
    MODO$ = "": Label19 = ""
...
'      If Option4.Value = True Then PRINTGRI$ = "1"
'      If Option5.Value = True Then PRINTGRI$ = "2"
    TTXX$ = TTXX$ + Chr$(124) + "PRINTGRI = " + PRINTGRI$
...
Sub DATGENFOR()
    ...
    If PRINTGRI$ = "0" Then Option3.Value = True
    If PRINTGRI$ = "1" Then Option4.Value = True
    If PRINTGRI$ = "2" Then Option5.Value = True
    '
    Text16 = FORM_OPX$
    '
End Sub
