VERSION 5.00
Begin VB.Form FSEGELE 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Ensayo de Seguridad Eléctrica"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Impresión de Ensayo de Seguridad Eléctrica"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FSEGELE.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FSEGELE"
...
Private Sub Command2_Click()
    '
    Call GRACONTROL("", "FUENTIE", Text4.TEXT)
    '
    '
    Call CIERRARCH("*.*")
