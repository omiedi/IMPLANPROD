...
Begin VB.Form PENDIENTES 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   315
         Index           =   1
         ItemData        =   "PENDIENTES.frx":0000
         Left            =   1440
         List            =   "PENDIENTES.frx":0002
         Sorted          =   -1  'True
         TabIndex        =   16
         Text            =   "Combo1"
         Top             =   600
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   315
         Index           =   0
         ItemData        =   "PENDIENTES.frx":0004
         Left            =   1440
         List            =   "PENDIENTES.frx":0006
         Sorted          =   -1  'True
         TabIndex        =   12
         Text            =   "Combo1"
         Top             =   240
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "PENDIENTES.frx":0008
      Top             =   0
   End
