...
Private Sub Command2_Click()
    ...
    Call GRACONTROL("", "STIKIMPO", Text6.TEXT)
    '
...
Private Sub Text6_Change()
  Text3.TEXT = ECOARCH$("INDIFRM", UCase$(Text6.TEXT))
End Sub
