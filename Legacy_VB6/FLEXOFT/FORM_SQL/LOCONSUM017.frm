     ...
     With MoviTemp
       ...
       If Err < 1 Then
         Do While Not .EOF
           ...
           locon$ = !IdenLote    ' !LotConsum
           CATO = 0
           '
           IDLO$ = locon$   ' TRIM$(Mid$(LOCON$, 32 * KKI% - 31, 24))
           CAPAR = !Cantsalid   ' XVALO(Mid$(LOCON$, 32 * KKI% - 7, 8))
           CATO = CATO + CAPAR
