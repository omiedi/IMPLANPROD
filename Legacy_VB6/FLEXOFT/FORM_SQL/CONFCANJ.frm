...
Begin VB.Form CONFCANJ 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ListBox List2 
         ...
         EndProperty
         Height          =   1860
         ItemData        =   "CONFCANJ.frx":030A
         Left            =   105
         List            =   "CONFCANJ.frx":030C
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   1860
         ItemData        =   "CONFCANJ.frx":237A
         Left            =   105
         List            =   "CONFCANJ.frx":237C
         MousePointer    =   1  'Arrow
         Sorted          =   -1  'True
         TabIndex        =   14
         Top             =   630
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   420
      OleObjectBlob   =   "CONFCANJ.frx":237E
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "CONFCANJ.frx":25B2
      TabIndex        =   19
      Top             =   315
      Visible         =   0   'False
      Width           =   1590
...
Sub GRABOCANJE(CI%, CIELEM%, TIPOCANJ%, AGRE, QUIT)
    ...
    SQLX$ = "SELECT * FROM CANJPREDEF WHERE CODICONJ < 1 "
    Dim CANJTMP As ADODB.Recordset
    Set CANJTMP = New ADODB.Recordset
    CANJTMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
    '
    With CANJTMP
         .AddNew
         !CODICONJ = CI%
...
50  VTB% = VENTABU%("CANJCOMP/" + ATRI$)
   
    If VTB% < 0 Then Exit Sub
    '
    'VALIDO
    CODICONJ% = CODINT%(Label11)
    FIN& = ULTREG&("!CANJCOMP")
    For J& = 1 To FIN&
      ...
      If CODICONJ% = CI% Then Call COMUNI("Código de Componente: (" & CODEXT$(CI%) & ") Igual a Código de Producto "): GoTo 50
    Next J&
    '
    OBJ_LIST.Clear
    '
