VERSION 5.00
Begin VB.Form CONFCOTI 
   BackColor       =   &H00CDDADA&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario de Cotización"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "CONFCOTI.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "CONFCOTI"
