...
Begin VB.Form ABMCERTI09 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   120
      OleObjectBlob   =   "ABMCERI09.frx":063C
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "ABMCERI09.frx":0870
      TabIndex        =   1
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
   ...
   Begin VB.Menu mnuarchivo 
      ...
      Begin VB.Menu MNUVENTANA 
         Caption         =   "Ventana Carga"
      End
      Begin VB.Menu mnuSelec 
         Caption         =   "Lista Seleccion"
      End
...
Private Sub Command2_Click()
    ...
    Call SELECHO("ECORDEF/Indice General de Ordenes de Compra (Pendientes-Cumplidas-Anuladas)")
    NORFA$ = TRIM$(VALACT1$("ECORDEF"))
    If NORFA$ = "" Then GoTo 99
    '
    Screen.MousePointer = 11
    STATORF% = XVALO(VALOBADA("ORDEFABR", "StatuOrf", "IdSubOr = '" & NORFA$ & "'"))
    If STATORF% >= 8 Then
       Call MENSERR(24, "Orden '" + NORFA$ + "' Anulada")
       GoTo 99
    End If
    '
    CI1% = CODIFAB%(NORFA$)
