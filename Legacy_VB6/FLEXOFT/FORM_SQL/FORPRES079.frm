   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.ListBox List1 
            ...
            EndProperty
            Height          =   3210
            ItemData        =   "FORPRES079.frx":030A
            Left            =   -10
            List            =   "FORPRES079.frx":030C
            TabIndex        =   36
            Top             =   420
            Width           =   10575
         End
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   2625
         OleObjectBlob   =   "FORPRES079.frx":40CE
         Top             =   0
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
         ...
         Index           =   0
         Left            =   0
         OleObjectBlob   =   "FORPRES079.frx":4302
         TabIndex        =   102
         Top             =   0
         Visible         =   0   'False
         Width           =   1485
...
10  NC% = XVALO(Text1.TEXT)
    ...
    CAPARDOC% = 30
    '
    If NC% < 1 Then ' Se agregan estos parametros para los casos en que esta tomando la informacion del prospect y todavia no son clientes (No figuran en la base de datos de clientes)
      NCLIE$ = TRIM$(Label26)
      '
