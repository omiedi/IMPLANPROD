VERSION 5.00
Begin VB.Form FSTPFET 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Fuga de Ensayo a Tierra"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Impresión de Fuga de Ensayo a Tierra"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FSTPFET.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FSTPFET"
