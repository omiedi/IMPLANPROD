...
Begin VB.Form IMPOREM07 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.PictureBox Picture8 
         ...
         Begin VB.PictureBox Picture2 
            ...
            Begin VB.ListBox List4 
               ...
               ItemData        =   "IMPOREM07.frx":206C
               Left            =   0
               List            =   "IMPOREM07.frx":206E
               TabIndex        =   19
               Top             =   250
               Width           =   1.30000e5
            End
      ...
      Begin VB.ListBox List1 
         ...
         Height          =   1140
         IntegralHeight  =   0   'False
         ItemData        =   "IMPOREM07.frx":2070
         Left            =   120
         List            =   "IMPOREM07.frx":2072
         TabIndex        =   11
         Top             =   2910
         Width           =   10400
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2625
      OleObjectBlob   =   "IMPOREM07.frx":2992
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "IMPOREM07.frx":2BC6
      TabIndex        =   32
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
...
Private Sub Command4_Click()
   ...
   Do While Not EOF(NX%)
      ...
      SQLX$ = SQLX$ + " WHERE NroOcom = '" & CE1$ & "'"
      Dim PEDDDENCA As ADODB.Recordset
      Set PEDDDENCA = New ADODB.Recordset
      PEDDDENCA.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
      On Error Resume Next
      With PEDDDENCA
        .MoveFirst
      ...
      SQLX$ = SQLX$ + " WHERE DoSecLar = '" & NFAC1$ & "'"
      SQLX$ = SQLX$ + " AND FechMov = '" & FEC3$ & "'"
      '.FindFirst SQLX$
...
Function NUCICU%(CUI1$) 'DEVUELVE EL NUMERO DE CLIENTE
  ...
  SQLX$ = " SELECT Nume_cli FROM DEUDOR12"
  SQLX$ = SQLX$ + " WHERE Cuit_Cli = '" & CUI1$ & "' "
  Dim DEUDDDOR12 As ADODB.Recordset
  Set DEUDDDOR12 = FLEXCONN.Execute(FILTSQL$(SQLX$))
  With DEUDDDOR12
    On Error Resume Next
    .MoveFirst
    If Err < 1 Then
