...
Begin VB.Form SEGUIM_COLEGIO1 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command2 
         Height          =   795
         Left            =   40
         Picture         =   "SEGUIM_GOLEGIO1.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   18
...
Private Sub Command1_Click()
    ...
    Call ABREADMIN
    '
    Call CARGA_INDICE_ALUMNOS(1)
    '
    If RESPUESTA_BUSQUEDA$ = "" Then GoTo 99
    '
    Text2 = RESPUESTA_BUSQUEDA$
...
Sub CARGA_DATOS_ALUMNMOS()
   ...
   With ALUMTMP
        Text19 = SAFETEXT$(!NOMBRE_APELLIDO)
        Text14 = SAFETEXT$(!DOMCILIO)
        Text7 = SAFETEXT$(!LOCALIDAD)
...
Sub LIMPIAR()
List1.Clear
For Each CONTROLX In SEGUIM_COLEGIO.Controls ' RECORRO LOS CONTROLES DEL FORM ACTIVO
