...
Begin VB.Form FSTREINEQ 
   BackColor       =   &H00CDDADA&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Reingreso de Equipos"
   ClientHeight    =   1605
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6315
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   420
      OleObjectBlob   =   "FSTREINEQ.frx":0A68
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "FSTREINEQ.frx":0C9C
      TabIndex        =   29
      Top             =   315
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FSTREINEQ.frx":0D16
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FSTREINEQ"
...
Private Sub Command2_Click()
    '
    Call GRACONTROL("", "REINEQ", Text4.TEXT)
    '
    '
    Call CIERRARCH("*.*")
