VERSION 5.00
Begin VB.Form FSTPRDM 
   BackColor       =   &H00C0E0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Registro de Medición"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00C0E0FF&
      Caption         =   "Impresión de Registro de Medición"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FSTPRDM.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FSTPRDM"
...
Private Sub Command2_Click()
    '
    Call GRACONTROL("", "REGMEDI", Text4.TEXT)
    '
    '
    Call CIERRARCH("*.*")
