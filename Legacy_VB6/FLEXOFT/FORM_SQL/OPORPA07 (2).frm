...
Begin VB.Form OPORPA07 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "OPORPA07.frx":4DB8
      TabIndex        =   40
      Top             =   0
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "OPORPA07.frx":4E32
      Top             =   1200
   End
End
...
2    OPX% = COMALTER%("Elija el Tipo de Retención\\Ingresos Brutos\Ganancias")
     ...
     If OPX% = 1 Then
        Call CARGALISEL("LISIIBB", "CAJABANC", "NUMECOMP/I9;DESCRIMOV/A32", "Tipomovim='RTIB' order by numecomp desc")
10      Call SELECHO("LISIIBB/Retenciones de I. Brutos")
        '
        IDRET& = XVALO(Mid$(VALACT2$("LISIIBB"), 14))
        If IDRET& > 0 Then
            Screen.MousePointer = 11
            NURETBA& = IDRET&
            ...
            '
'            Call MUESTRADOC(IDRET&)
'            GoTo 10
        End If
        GoTo 2
        
    ElseIf OPX% = 2 Then
        Call CARGALISEL("LISGANA", "PDOC_TBL", "NUMEDOC/I9;REFERENCIA/A64", "TIPODOCU='Retencion Ganancias'")
