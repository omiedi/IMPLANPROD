...
Begin VB.Form MOFBRE11 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3480
      OleObjectBlob   =   "MOFBRE11.frx":0614
      Top             =   0
   End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton Command50 
            ...
            Height          =   600
            Left            =   1825
            Picture         =   "MOFBRE11.frx":0E5C
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Re-Apertura O/P's con Saldo"
            Top             =   0
            Width           =   525
         End
         Begin VB.CommandButton Command3 
            ...
            Height          =   600
            Left            =   0
            Picture         =   "MOFBRE11.frx":0FA6
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Cierre Parcial / Total de Orden de Produccion"
            Top             =   0
            Width           =   530
         End
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.CommandButton Command2 
            ...
            Height          =   600
            Left            =   0
            Picture         =   "MOFBRE11.frx":12B0
            Style           =   1  'Graphical
            TabIndex        =   1
            ToolTipText     =   "Batch Record Elñectronico - Secuencia de Procesos"
            Top             =   0
            Width           =   560
         End
         Begin VB.Label Label2 
            BackStyle       =   0  'Transparent
            Caption         =   "     Batch Record              Electronico"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.PictureBox Picture10 
         ...
         Begin VB.CommandButton Command19 
            ...
            Height          =   600
            Left            =   0
            Picture         =   "MOFBRE11.frx":15BA
            Style           =   1  'Graphical
            TabIndex        =   0
            ToolTipText     =   "Generar Nueva Orden de Produccion"
            Top             =   0
            Width           =   530
         End
   ...
   Begin VB.PictureBox Picture14 
      ...
      Begin VB.CommandButton Command29 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "MOFBRE11.frx":2780
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Ayuda en linea (Si Disponible)"
         Top             =   860
         Width           =   650
      End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "MOFBRE11.frx":59A0
      TabIndex        =   79
      Top             =   420
      Visible         =   0   'False
      Width           =   1485
...
Private Sub Command19_Click()
   ...
   '
   If DERACCE%("GENORPRO", "Ordenes de Produccion") >= 2 Then
      GENORPRO11.Show 1
   End If
   '
...
Private Sub Command2_Click()
   ...
   If UCase$(Left$(APLINVO$, 6)) = "SECAUT" Then
        OPP% = 1: GoTo 19
   End If
   If UCase$(Left$(APLINVO$, 6)) = "PASOAP" Then
        OPP% = 2: GoTo 19
   End If
   If UCase$(Left$(APLINVO$, 6)) = "PRINTE" Then
        OPP% = 3: GoTo 19
   End If
   '
...
19 CONDI$ = "NUORPROD <> '' order by NuOrProd "
   ...
   If OPP% = 2 Then
'      If USNBR% > 100 Then
'         Call MENSERR(24, "Supervisor No Autorizado a Ejecucion Paso a Paso.\   \Debe Autorizar a Usuario Tercero para su Ejecucion.")
'         GoTo 99
'      End If
      '
...
Private Sub Command29_LostFocus()
    Command19.SetFocus
End Sub
...
Private Sub Form_Load()
    ...
    '
    ' ESTO ES PARA COLGARLO CUANDO PASO EL PERIODO DE DEMOSTRACION
'    If EXISTE%(App.Path + "\" + App.EXEName + ".EXE") > 0 Then
'       FECOMPI = FECHANUM(Format(FileDateTime(App.Path + "\" + App.EXEName + ".EXE"), "dd/mm/yy"))
'       HOX = HOY(HOS$)
'       If DIENTRE(FECOMPI, HOX) > 15 Then
'          Call Form_Load
'       End If
'    End If
    '
    ...
    End If
    '
    If UCase$(Left$(APLINVO$, 6)) = "CIEROF" Then
      Command3_Click
      Call FINAL("")
    End If
    If UCase$(Left$(APLINVO$, 6)) = "APEROF" Then
      Command50_Click
      Call FINAL("")
    End If
    '
    '
    If UCase$(Left$(APLINVO$, 6)) = "BATREC" Then
      Command2_Click
      Call FINAL("")
    End If
    If UCase$(Left$(APLINVO$, 6)) = "SECAUT" Then
