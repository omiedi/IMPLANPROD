...
Begin VB.Form REMIDATO 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   720
      OleObjectBlob   =   "REMIDATO.frx":0000
      Top             =   3000
   End
   ...
   Begin VB.Menu mnuConsultasyListados 
      ...
      Begin VB.Menu mnuVerRemiof 
         Caption         =   "Visualizar Remitos Oficiales"
      End
...
Sub ReimpresionDeRemito(rto$, OK%, Optional TIPODOC1$, Optional NOPRESENTAMENSA%)
    ...
    If TRIM$(FORIPRE$) <> "" Then
      ...
      NUMEDOC$ = NROREMIT$
      TIPODOC$ = TRIM$(TIPODOC1$)
      If TRIM$(TIPODOC$) = "" Then 'SI VIENE CON INFORMACIÓN SE QUEDA CON LA QUE TRAE DEL PARAMETOR
        TIPODOC$ = "Remito"
      End If
      '
...
'    Text3 = ""
    ...
    If Me.Text3 <> "" Then
        ...
        CONDI$ = CONDI$ + " AND DoPriLAR LIKE '%" & Text3 & "%' AND CANTSALID > 0 AND FECHMOV='" & FETEXCOR1$(FF%) & "'"
        VUELTA% = 0: j& = 0
