...
Begin VB.Form CCTEIMP14 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cuenta Corriente de Clientes (Pagos de Impuestos)"
   ClientHeight    =   7905
   ClientLeft      =   45
   ClientTop       =   660
   ClientWidth     =   12555
   ...
   Begin VB.TextBox Text6 
      ...
      TabIndex        =   12
      TabStop         =   0   'False
      Text            =   "Detalle de Cuenta Corriente (Pago de Impuestos)"
      Top             =   2100
      Width           =   12255
   End
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
         ...
         Index           =   0
         Left            =   0
         OleObjectBlob   =   "CCTEIMP14.frx":066A
         TabIndex        =   3
         Top             =   0
         Visible         =   0   'False
         Width           =   1485
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   120
      OleObjectBlob   =   "CCTEIMP14.frx":06C8
      Top             =   120
   End
   ...
   Begin VB.Menu mnua 
      Caption         =   "Ajuste"
      Begin VB.Menu mnuajs 
         Caption         =   "Ajuste de Saldo Cta. Cte."
      End
   End
End
Attribute VB_Name = "CCTEIMP14"
...
'Call APLICAR_SKIN(Me, LUDAT$ & "\SKINS\dogmax.skn")
    ...
    '
    Call CARGA_ENCABEZADO(CCTEIMP14.MSF1, "Documento/A14;Fecha/D8;Impuesto/A18;Concepto/A18;Debe/F12.2;Haber/F12.2;Saldo/F12.2;", CCTEIMP14)
    '
    Call ABRECABAN
End Sub

Private Sub mnuAjs_Click()
    If DERACCE%("AJUSIMPU", "AJUSTE DE SALDO DE CUENTA CORRIENTE DE IMPUESTOS") <= 1 Then Exit Sub
    NC% = XVALO(Text4)
    If NC% < 1 Then
    ...
    End If
    '
    SALDOX# = CCTEANEX14.SALDOAFECHAIMPUESTO#(NC%, , , 0, 1)
    AJUSTE14.Text28 = ""
    AJUSTE14.Text2 = ""
    ...
    '
    AJUSTAX# = XVALO(AJUSTE14.SALDO_AJUSTADO#)
    DIFERENCIA# = AJUSTAX# - SALDOX#
...
'    End If
    ...
    FEX = HOY(HO$)
    FETX$ = FECHATEX$(FEX)
    NRECIB$ = "ASI-" + Mid$(FETX$, 7, 2) + Mid$(FETX$, 4, 2) + Mid$(FETX$, 1, 2) + "-"
    '
    CONDI$ = " TipoMovim = 'AJIM' AND CodiCom_Cor LIKE '" & NRECIB$ + "%' "
...
40        .AddNew
          ...
          !DESCRI_IMPU = Left$("Aj.Saldo Imp.- " + RASOCLI$(NC%), 64)
          FEX1% = FEX
...
'      SQLX$ = SQLX$ + " or Status = 2) "
      SQLX$ = SQLX$ + " WHERE (tipomovim = 'CHENTR' or TIPOMOVIM = 'CHRCIM' OR TIPOMOVIM = 'DVDIFIM' OR TIPOMOVIM = 'AJIM' )"
      If NC% > 0 Then
      ...
      If DES% > 0 And HAS% > 0 Then
         ...
         SALFE# = CCTEANEX14.SALDOAFECHAIMPUESTO(NC%, DES%, HAS%, 0, 1)
         I& = MSF1.Rows
