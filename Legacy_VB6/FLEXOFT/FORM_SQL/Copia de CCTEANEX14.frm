...
'Call APLICAR_SKIN(Me, LUDAT$ & "\SKINS\dogmax.skn")
    ...
    '
    Call CARGA_ENCABEZADO(CCTEANEX14.MSF1, "Documento/A12;Fecha/D8;Concepto 1/A18;Concepto 2/A18;Debe/F12.2;Haber/F12.2;Saldo/F12.2;", CCTEANEX14)
    '
    Call ABRECABAN
End Sub
...
Private Sub mnuAjs_Click()
    ...
    End If
    '
    SALDOX# = SALDOAFECHAIMPUESTO#(NC%, , , 0, 1)
    AJUSTE14.Text28 = ""
    AJUSTE14.Text2 = ""
    AJUSTE14.Text1 = FORMATNUM$(SALDOX#, "F12.2")
    AJUSTE14.Show 1
...
'      SQLX$ = SQLX$ + " or Status = 2) "
      SQLX$ = SQLX$ + " WHERE (tipomovim = 'CHENTR' or TIPOMOVIM = 'CHRCIM' OR TIPOMOVIM = 'DVDIFIM')  "
...
Function SALDOAFECHAIMPUESTO#(NC%, Optional DES%, Optional HAS%, Optional SOLO_IMP_PAGOS%, Optional INCLUIR_AJUSTE_CTACTE_GENERAL%)
   ...
   CONDI$ = CONDI$ + " OR TIPOMOVIM = 'AJIMSAL' "
   End If
   CONDI$ = CONDI$ + ")"
   CONDI$ = CONDI$ + " AND NUCLIEN = " & NC% & " AND STATUS < 9"
