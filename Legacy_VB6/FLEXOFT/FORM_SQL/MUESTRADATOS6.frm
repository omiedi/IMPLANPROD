...
Begin VB.Form MUESTRADATOS6 
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   400
      Left            =   7920
      Picture         =   "MUESTRADATOS6.frx":0000
      TabIndex        =   6
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2625
      OleObjectBlob   =   "MUESTRADATOS6.frx":030A
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   120
      OleObjectBlob   =   "MUESTRADATOS6.frx":053E
      TabIndex        =   1
      Top             =   240
      Visible         =   0   'False
      Width           =   1485
   ...
   End
End
Attribute VB_Name = "MUESTRADATOS6"
...
Private Sub Command3_Click()
    ...
    OrdenCompra$ = ""
    CondicionOrdenesSeleccionadas$ = ""
    CondicionOrdenesSeleccionadasConsigna$ = ""
    'RECORRO Y GRABO
    For i& = 1 To MSF.Rows - 1
          If MSF.TextMatrix(i&, 0) = "*" Then
             OrdenCompra$ = TRIM$(MSF.TextMatrix(i&, 1))
             CondicionOrdenesSeleccionadas$ = CondicionOrdenesSeleccionadas$ & " NUME_OCOM=" & OrdenCompra$ & " OR"
             NOCO$ = OrdenCompra$
             While Len(NOCO$) < 6: NOCO$ = "0" & NOCO$: Wend
             CondicionOrdenesSeleccionadasConsigna$ = CondicionOrdenesSeleccionadasConsigna$ & " NRO_OCOM LIKE 'OC-" & NOCO$ & "%' OR "
           End If
    Next i&
    If TRIM$(CondicionOrdenesSeleccionadas$) = "" Then
       Call COMUNI("No se Ha Seleccionado Ninguna O.Compra")
       GoTo 99
    End If
    CondicionOrdenesSeleccionadas$ = "(" & Mid$(CondicionOrdenesSeleccionadas$, 1, Len(TRIM$(CondicionOrdenesSeleccionadas$)) - 2) & ")"
    CondicionOrdenesSeleccionadasConsigna$ = "(" & Mid$(CondicionOrdenesSeleccionadasConsigna$, 1, Len(TRIM$(CondicionOrdenesSeleccionadasConsigna$)) - 2) & ")"
    FORECEP07.OrdenesSeleccionadas$ = CondicionOrdenesSeleccionadas$
    FORECEP07.OrdenesSeleccionadasConsignaciones = CondicionOrdenesSeleccionadasConsigna$
    Unload Me
