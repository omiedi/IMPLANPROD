...
Begin VB.Form SECUPROC09 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CheckBox Check1 
         BackColor       =   &H00C0FFC0&
         Caption         =   "Modo de Demostracion (Permite Avanzar sin Completar Obligatorios)"
         Height          =   255
         Left            =   480
         TabIndex        =   28
         Top             =   5520
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   4740
         ItemData        =   "SECUPROC09.frx":3276
         Left            =   225
         List            =   "SECUPROC09.frx":3278
         Sorted          =   -1  'True
         TabIndex        =   13
         Top             =   645
         Width           =   6630
   ...
   Begin VB.CommandButton Command5 
      ...
      Left            =   3225
      TabIndex        =   0
      ToolTipText     =   "Despliega Lista de Seleccion de Ordenes en Proceso"
      Top             =   315
      Width           =   175
   End
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3480
      OleObjectBlob   =   "SECUPROC09.frx":327A
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "SECUPROC09.frx":34AE
      TabIndex        =   27
      Top             =   420
      Visible         =   0   'False
      Width           =   1485
...
Private Sub Check1_Click()
   If DERACCE%("MODODEMO", "Ejecutar BRE en Modo Demostracion") < 2 Then
      Check1.Value = 0
   End If
End Sub
