...
'           CONDI$ = CONDI$ + "  AND FECHEMISI >= '" & FECH_COM_EJERCICIO & "'"
         ...
         ElseIf IMPOHABEX# > 0 Then
            CONDI$ = "IHABECOMP = " & IMPOHABE_PTO & " AND FECHACRED <= '" & FECH_EXTRACTO & "'"
           '***DESCOMENTAR ESTA LINEA DE BAJO'*******
'            CONDI$ = CONDI$ + "  AND FECHEMISI >= '" & FECH_COM_EJERCICIO & "'"
         ...
         If ENCONTRADO% = 1 Then
            ...
            CONDI2$ = "CODICOM_LAR = '" & COMPROBTE$ & "' AND FECHCONTA = '" & FECONTA & "'"
            CONDI2$ = CONDI2$ + " AND CUECONTAI = " & CUEII%
            ...
            If CantRegistros&("CAJABANC", CONDI2$, "NOMESS") > 0 Then
              ...
              Call ACTUREGISTRO("CONCILIA", "CONCEPTO", CONDI1$, DESCIRIMOVIMIENTO$, REGAF&, "NOMESS")
...
Sub VISUALI_EXTRACT_IMPOR()
   ...
   Call CARGALISEL("CONCITODO", "CONCILIA", "CODICONCI/A12;REFECONCI/A32", "CODICONCI <> ''", "NOMESS/DISTINCT")
