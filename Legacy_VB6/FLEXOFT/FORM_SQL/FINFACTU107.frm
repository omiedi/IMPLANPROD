...
Begin VB.Form FINFACTU107 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "FINFACTU107.frx":2A48
      Top             =   1680
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   60
      OleObjectBlob   =   "FINFACTU107.frx":2C7C
      TabIndex        =   72
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
...
Private Sub Command1_Click()
   ...
   If TRIM$(Control$("STOCKS", "CONEGATI")) = "SI" And FORFACPRINT.Label6.Caption <> "(T.Libre)" And FORFACPRINT.CONSICLI% < 1 And FORFACPRINT.TIFADOC% <= 3 Then
     If FINFACTUR07.VALIDASTOCK(DEP%) < 1 Then
        Exit Sub
     End If
   End If
   '
