...
Begin VB.Form MUESTRADATOS5 
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   400
      Left            =   7920
      Picture         =   "MUESTRADATOS5.frx":0000
      TabIndex        =   7
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2625
      OleObjectBlob   =   "MUESTRADATOS5.frx":030A
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   120
      OleObjectBlob   =   "MUESTRADATOS5.frx":053E
      TabIndex        =   1
      Top             =   240
      Visible         =   0   'False
      Width           =   1485
   ...
   End
End
Attribute VB_Name = "MUESTRADATOS5"
...
5   Call SELECHO("ECUECON")
    CUECON$ = TRIM$(VALACT1$("ECUECON"))
    If CUECON$ = "" Then GoTo 99
    CodCueCon% = CUEINT(CUECON$)
             
    'RECORRO Y GRABO
    For i& = 1 To MSF.Rows - 1
          If MSF.TextMatrix(i&, 0) = "*" Then
             Codigo$ = MSF.TextMatrix(i&, 1)
             CONDI$ = "CODIGO = '" & Codigo$ & "'"
             Call ACTUREGISTRO("MASTER", "CueContaI", CONDI$, CStr(CodCueCon%), REGAF&, "NOMESS")
             Call COLOREAR_GRILLA_SOLAFILA(GRID, vbYellow, MSF.Row, 0, 0, 0) ' BLANQUEO LA FILA
             MSF.TextMatrix(i&, 3) = CUECON$
           End If
    Next i&
    APROBO% = 1
