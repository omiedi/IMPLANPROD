...
Private Sub Command7_Click()
   ...
   '
   CONDI$ = "IDSUBOR = '" & NORFA$ & "'"
   Call CARGALISEL("TANUCODI", "TANUMSE", "NUMEROSERIE/A16;Cod_Exte/A16", CONDI$, "NOMESS")
   Call SELECHO("TANUCODI/Tabla de Números de Serie")
   NUMSER$ = TRIM$(VALACT1$("TANUCODI"))
   If NUMSER$ = "" Then GoTo 99
   '
   Text3 = NUMSER$
   '
