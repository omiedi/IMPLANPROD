...
Begin VB.Form AMAS_GES07 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2625
      OleObjectBlob   =   "AMAS_GES07.frx":5064
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "AMAS_GES07.frx":5298
      TabIndex        =   70
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
...
OPMAST07.Option1(8).Value = True
Call OPMAST07.Command16_Click
End Sub
...
' de aca para abajo es todo el codigo anterior
'  se mofifico para que grabe en sql (Omar)
'   '
...
Sub GRAGENITEM()
   ...
   If YACAR%(0) < 1 Then    ' SOLO CAMBIO LA DESCRIPCION
      ...
      If TRIM$(Text3) <> "" Then
        If TRIM$(Text3) <> DE$ Then
          DE$ = TRIM$(Text3)
          MODESCRI% = 1
          strsql = ("Update Master set descripcion= '" & DE$ & "' where codint= ") & CI%
           FLEXCONN.Execute (FILTSQL$(strsql))
          'Master.Edit
   ...
   strsql = ("Select * from Master where codint=" & CI%)
   ...
   PHABIT%(CI%) = (-1) ' ACA DABA ERROR DE SUBINDICE FUERA DE INTERVALO
...
'  '     Call REPLA(REMAS$, MKI$(FCPI%), 127, 2)
   ...
   RMaster!ESPECIFICACION = Especif$
   '
30 RMaster.Update
   If MODESCRI% > 0 Then
     UPDATMASTER% = 1
...
OPMAST07.Option1(0).Value = True
Call OPMAST07.Command16_Click
End Sub

Private Sub TaUnMe_Click()
OPMAST07.Option1(9).Value = True
Call OPMAST07.Command16_Click
End Sub
