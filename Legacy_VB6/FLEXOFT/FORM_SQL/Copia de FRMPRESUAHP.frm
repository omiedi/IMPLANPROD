...
Begin VB.Form FRMPRESUAHP 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   270
      Left            =   5055
      OleObjectBlob   =   "FRMPRESUAHP.frx":06FC
      TabIndex        =   71
      Top             =   7920
      Width           =   1455
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   6975
      OleObjectBlob   =   "FRMPRESUAHP.frx":0774
      TabIndex        =   72
      Top             =   2160
      Visible         =   0   'False
      Width           =   1365
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   270
      Left            =   9615
      OleObjectBlob   =   "FRMPRESUAHP.frx":07D2
      TabIndex        =   73
      Top             =   7000
      Width           =   975
   End
...
Sub PRESENTA_INFO_ARTICULO(CIXI%)
   '
...
''       INFOSIAHP.MSF1.TextMatrix(j&, 10) = FECHATEX$(FECHA_COSTO_POR_PROV%(NPROV&, CI1%))
   ...
   With RS
     Do While Not .EOF
       ...
       '
       'CARGO LA GRILLA
       INFOSIAHP.MSF1.TextMatrix(j&, 1) = SAFETEXT$(RASOCLI$(-1 * NPROV&))
...
80 'INFOSIAHP.txtcodigo = txtcodigo
...
'''    NUCOLU% = 6: TEPRUEBA = "1234567890123456789": MSF1.ColWidth(NUCOLU% - 1) = TEPRUEBA.Width: MSF1.ColAlignment(NUCOLU% - 1) = 6: MSF1.TextMatrix(0, NUCOLU% - 1) = "Importe"
    Call CARGA_ENCABEZADO(FRMPRESUAHP.MSF1, "Código/A24;Cod.Cte/A24;Descripción/A24;Cantidad/F9.1;Prov/F5;R.Social/A24;Costo/F10.2;Pr.Venta/F10.2;Importe/F10.2;Via Apr./A10", FRMPRESUAHP)
    '
End Sub
Function NUPRESUP&()
   '
         ...
         RS2.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
          With RS2
            For I& = 1 To ULTREG&("!PROVIADE") ' RECORRO EL ARCHIVO Y GRABO
              ...
              !COD_INTE = CI%
              !VIA = 0
              If ROUND(PRECIOX#, 2) <> ROUND(XVALO!PRECIO) Then
              !PRECIO = PRECIOX#
              !MONEDA = MON%
...
Private Sub cargar_datos()
    ...
    MSF1.TextMatrix(MSF1.Rows - 1, 7) = FORMATNUM$(INFOSIAHP.TXTCOSTO.TEXT, "f12.3")
    MSF1.TextMatrix(MSF1.Rows - 1, 8) = FORMATNUM$(INFOSIAHP.TXTPRECIOVENTA, "f12.3")
...
Private Sub txtcodigo_Change()
    ...
    If Command1.Enabled = False Then
      If INFOSIAHP.Visible = False Then
        'VALIDO SI NO ESTA ABIERTO EL FRM POR QUE SI NO DA ERROR CUANDO ASIGNA DESDE INFOSIAHP EL CODIGO ORIGINAL
