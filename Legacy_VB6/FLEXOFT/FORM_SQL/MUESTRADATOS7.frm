...
Begin VB.Form MUESTRADATOS7 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Detalle de Composición de Deuda"
   ClientHeight    =   9480
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   15735
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Criterio de Obtención de Máximo de Pedido de Reposición para Stocks"
      BeginProperty Font 
         Name            =   "Arial Narrow"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   400
      Left            =   11880
      Picture         =   "MUESTRADATOS7.frx":0000
      TabIndex        =   7
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2625
      OleObjectBlob   =   "MUESTRADATOS7.frx":030A
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   120
      OleObjectBlob   =   "MUESTRADATOS7.frx":053E
      TabIndex        =   1
      Top             =   240
      Visible         =   0   'False
      Width           =   1485
   ...
   End
End
Attribute VB_Name = "MUESTRADATOS7"
...
Private Sub Command1_Click()
   ...
   If TRIM$(AREXPO$) <> "" Then
     If MSF_2.Visible = True Then
      Call GENEXCEL(AREXPO$, MUESTRADATOS7.MSF_2)
     Else
      Call GENEXCEL(AREXPO$, MUESTRADATOS7.GRID)
     End If
   End If
   '
...
Private Sub GRID_MouseDown(Button As Integer, Shift As Integer, x As Single, Y As Single)
     ...
     If Button = 2 Then
        Call INVICTRL
        GLOBALFRM_strContenidoCelda$ = TRIM$(GRID.TextMatrix(REG&, COL&))
        PopupMenu menu
        Call INVICTRL
     End If
