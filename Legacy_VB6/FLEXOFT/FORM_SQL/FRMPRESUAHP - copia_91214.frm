...
Begin VB.Form FRMPRESUAHP 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
            Height          =   240
            Left            =   100
            OleObjectBlob   =   "FRMPRESUAHP.frx":1B004E
            TabIndex        =   58
            Top             =   240
            Width           =   1095
         End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
         Height          =   240
         Left            =   1560
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B00BA
         TabIndex        =   60
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B0126
         TabIndex        =   61
         Top             =   525
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B0198
         TabIndex        =   62
         Top             =   815
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel10 
         Height          =   240
         Left            =   7815
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B020A
         TabIndex        =   63
         Top             =   240
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel11 
         Height          =   255
         Left            =   7815
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B027A
         TabIndex        =   64
         Top             =   525
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel13 
         Height          =   255
         Left            =   7815
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B02E8
         TabIndex        =   65
         Top             =   810
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   240
         Left            =   11865
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B0350
         TabIndex        =   66
         Top             =   240
         Width           =   1065
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel18 
         Height          =   285
         Left            =   12120
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B03BC
         TabIndex        =   67
         Top             =   1100
         Width           =   1200
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   285
         Left            =   11900
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B0434
         TabIndex        =   69
         Top             =   1120
         Visible         =   0   'False
         Width           =   360
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   1560
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B049A
         TabIndex        =   70
         Top             =   1080
         Width           =   1095
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel12 
         Height          =   255
         Left            =   7815
         OleObjectBlob   =   "FRMPRESUAHP.frx":1B050A
         TabIndex        =   88
         Top             =   1080
         Width           =   1095
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   15
      OleObjectBlob   =   "FRMPRESUAHP.frx":1B057E
      Top             =   120
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   6975
      OleObjectBlob   =   "FRMPRESUAHP.frx":1B07B2
      TabIndex        =   71
      Top             =   2160
      Visible         =   0   'False
      Width           =   1365
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   270
      Left            =   11295
      OleObjectBlob   =   "FRMPRESUAHP.frx":1B0810
      TabIndex        =   72
      Top             =   6885
      Width           =   975
   End
...
Sub PRESENTA_INFO_ARTICULO(CIXI%, Optional FILA&, Optional SINSTOCK%)
   ...
   If XVALO(INFOSIAHP.TXTPESO) = 0 Then INFOSIAHP.TXTPESO.BackColor = &H80000005: INFOSIAHP.TXTPESO.Locked = False ' LO PONE EN BLANCO
'   ESTO SE MUESTRA EN EL CASO QUE SEA SIN STOCK, Y SI ES ASI NO DEBERIA MOSTAR COSTO SI NO QUE SE DEBERIA CARGAR.
   ...
   ENCA$ = "Proveedor/A16;Vía Ent./A12;Stock/F8;Reserv./F8;Tránsito/F8;F.Ing./D8;Cto.Fob U$S/F10.2;Costo Nac./F11.2;%/F6.2;P.Vta.U$S/F10.2;Cant./F7;Dispon./F7;Lote/A18;NUMEROPROVE/A0"
...
''''''           End If
           ...
           INFOSIAHP.MSF1.TextMatrix(j&, 6) = FECHATEX$(FEX%)
             COSFOB# = COSTOFOB#(LOTE$) ' TRAE EL COSTO DE LA ORDEN DE COMPRA
          ...
          'CONDI$ = " VAL_COMPRA > 13490 AND VAL_COMPRA < 13510 "
           ...
           INFOSIAHP.MSF1.TextMatrix(j&, 8) = TRIM$(FORMATNUM$(GASNAC#, "F10.2"))
             PREVENTAX# = PRECIOVENTA_X_FORMULA(XVALO(GASNAC#), VIA_LOTE%, CI1%, MODONACIONALIZACION%)
...
90 INFOSIAHP.txtcodigo = txtcodigo
   ...
   INFOSIAHP.MONEMIS = MONEMIS.Caption
   INFOSIAHP.Show 1
   '
End Sub
Function PRECIOVENTA_X_FORMULA(COSTO1#, VIA%, CI%, CALCULAR_VALOR_SOBRE_FOB%)
   ...
   VALOR2 = COSTOKG * XVALO(PESUNI(CI%))
   'PES = XVALO(PESUNI(CI%))
   If INVERSO <> 0 Then
...
'  Next I&
  ...
  Call llevar_al_final_flexgrid(FRMPRESUAHP.MSF1)
...
'
    ...
    Call CARGA_ENCABEZADO(FRMPRESUAHP.MSF1, "Código/A22;Cod.Cte/A22;Descripción/A22;Q/F4.A;Prov/AO;Proveedor/A12;Costo/F10.2;Pr.Venta/F8.2;Importe/F10.2;Via Apr./A10;LOTES/A0;CANTI/F0;NPROV/F0;KILOS/A0;DEMORA/F7", FRMPRESUAHP)
    '1.CODIGO
    '2.CODIGO CLIENTE
    '3.DESCRIPCION
    '4.CANTIDAD
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   If XVALO(Text20) > 0 Then
      ...
      Command19.Enabled = True 'BOTON DE LISTA DE SELECCIN
      If Text21.Visible = True Then Text21.Visible = False 'CARTEL DE MODIFICACION DE PRESUPUESTO
      If Command9.Visible = True Then Command9.Visible = False
      Text1 = ""
   Else
      Close
      End
...
Sub PREPORCOP(NPRESU&)   '
   ...
   With PRESUTEMP
      Do While Not .EOF
        I& = I& + 1
        If I& = 1 Then MONEMI% = XVALO(!MonedEmi)
        CI1% = XVALO(!CodiInt)
...
15 MONEMI% = MONEMI% + 1
   ...
   '
      ...
      Call ACTU_TOTAL
      INFOSIAHP.MONEMIS = MONEMIS.Caption
      INFOSIAHP.MONEMIS = MONEMIS.ForeColor
'      Call CARLISPRES
