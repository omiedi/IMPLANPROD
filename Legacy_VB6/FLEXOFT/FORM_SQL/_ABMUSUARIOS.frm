...
Begin VB.Form ABMUSUARIOS 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   1440
      OleObjectBlob   =   "_ABMUSUARIOS.frx":0000
      Top             =   4560
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   3720
         OleObjectBlob   =   "_ABMUSUARIOS.frx":0234
         TabIndex        =   12
         Top             =   480
         Width           =   735
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   400
         OleObjectBlob   =   "_ABMUSUARIOS.frx":02A0
         TabIndex        =   13
         Top             =   1200
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   255
         Left            =   400
         OleObjectBlob   =   "_ABMUSUARIOS.frx":030C
         TabIndex        =   14
         Top             =   1680
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   255
         Left            =   405
         OleObjectBlob   =   "_ABMUSUARIOS.frx":037C
         TabIndex        =   15
         Top             =   2640
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
         Height          =   255
         Left            =   405
         OleObjectBlob   =   "_ABMUSUARIOS.frx":03E6
         TabIndex        =   16
         Top             =   3120
         Width           =   1335
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   400
         OleObjectBlob   =   "_ABMUSUARIOS.frx":0460
         TabIndex        =   18
         Top             =   2160
         Width           =   1335
      End
