   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.Label Label22 
            ...
            Caption         =   "DESCRIPCION GENERAL - ESPECIFICACION"
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   9
               Charset         =   0
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   0
         OleObjectBlob   =   "FORCOLIB07.frx":205E
         Top             =   1800
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
         ...
         Index           =   0
         Left            =   2640
         OleObjectBlob   =   "FORCOLIB07.frx":2292
         TabIndex        =   92
         Top             =   120
         Visible         =   0   'False
         Width           =   1485
...
15 SENDBYMAIL$ = ""
   ...
   For Each PRX1 In Printers
       If InStr(UCase$(PRX1.DeviceName), "PDFWRITER") > 0 Or InStr(UCase$(PRX1.DeviceName), "BIOPDF") > 0 Or InStr(UCase$(PRX1.DeviceName), "BULLZIP") > 0 Then GoTo 20
   Next
...
Private Sub Label11_DblClick()
   ...
   PREDOL# = XVALO(Text19) * COEFCON
   Text19 = FORMATNUM$(PREDOL#, "F12.2")
   Call CALTOCOM
   '
End Sub
...
Private Sub Text19_LostFocus()
   Text19 = FORMATNUM$(XVALO(Text19), "F11.2")
End Sub
...
123 If COPRECIO < 0.99 Then
    ...
    Dim OCCCOMENCA As ADODB.Recordset
    Set OCCCOMENCA = New ADODB.Recordset
    OCCCOMENCA.Open FILTSQL$(SQLX$), FLEXCONN, adOpenDynamic, adLockPessimistic, adCmdText
    ...
    PREUNPE# = XVALO(Text19)            ' CVD(Mid$(ZZ$, 67, 8)) * TICAMONE(MONEMI%) / COEFUNI
    ...
    OCCCOMDETA.Open FILTSQL$(SQLX$), FLEXCONN, adOpenDynamic, adLockPessimistic, adCmdText
    ...
    With OCCCOMDETA
      ...
      On Error GoTo 0
       ...
       !INet_Item = XVALO(Total(0))     ' CVD(Mid$(ZZ$, 87, 8))
...
Sub PRICOMPRA()
    ...
    If TRIM$(FORIPRE$) <> "" Then
      ...
      '
      NC1% = DESTIDOC%
      CANTU = XVALO(Text20)                      ' CVS(Mid$(X$, 55, 4))
      PreUnid# = XVALO(Text19)
