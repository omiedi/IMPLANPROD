...
Begin VB.Form PREVIEW07 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List4 
         ...
         ItemData        =   "PREVIEW07.frx":0000
         Left            =   -30
         List            =   "PREVIEW07.frx":0002
         TabIndex        =   1
         Top             =   420
         Width           =   40000
      End
      Begin VB.PictureBox Picture7 
         ...
         Begin VB.ListBox List1 
            ...
            Height          =   480
            IntegralHeight  =   0   'False
            ItemData        =   "PREVIEW07.frx":0004
            Left            =   -30
            List            =   "PREVIEW07.frx":0006
            TabIndex        =   8
            Top             =   0
            Width           =   40000
         End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   2040
      OleObjectBlob   =   "PREVIEW07.frx":0008
      TabIndex        =   18
      Top             =   480
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "PREVIEW07.frx":0082
      Top             =   1200
   End
   ...
   Begin ComctlLib.ImageList imlToolbarPics 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":02B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":05D0
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":08EA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":0C04
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":0F1E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":1238
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":1552
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":186C
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":1B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":1EA0
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":21BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":2394
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":24A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":27C0
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "PREVIEW07.frx":3B36
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
   ...
   Call PONELOGO
   '
   On Error Resume Next 'EN CASO QUE LAS FUENTES NO SEAN SOPORTADAS POR LABEL1.FONTNAME EVITA EL ERROR
...
Private Sub Toolbar1_ButtonClick(ByVal Button As ComctlLib.Button)
   Select Case UCase$(Button.key)
      Case "PRINT"
        Call WLITAB07.Image1_Click(0)
        Call WLITAB07.Command1_Click
      Case "SEARCH"
        Call Search
      Case "FULLSCREEN"
        Call FULLSCREEN
...
Sub Search()
   ABUS$ = InputBox$("Busqueda por Texto", "Búsqueda por Texto", ARBUSQUE$)
   If ABUS$ = "" Then
     Exit Sub
   End If
   '
