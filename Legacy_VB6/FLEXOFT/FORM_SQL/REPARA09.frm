...
Begin VB.Form REPARA09 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "REPARA09.frx":2210
...
10 Call SELECHO("DEUDOR1")
   ...
   If NC% > 0 Then
     If rasocli$(NC%) <> "" Then
       ...
       PRESRE09.Label8 = Text28
       PRESRE09.Label10 = Text1
       '
...
Sub GRADESREP()
   ...
   U& = 0
   '
10 TEX$ = Left$(TTYZ$, U&) + Chr$(13) + Chr$(10)
   Call FRATEXTO(TEX$, 62)
   For LL% = 1 To CARETEX%
...
20 While KK& < Len(RNC$) - 3
   ...
   For LL% = 1 To List3.ListCount
     ...
     If TRIM$(DESOPE$(LL% - 1)) <> "" Then
       TEX$ = RTrim$(DESOPE$(LL% - 1))
       While Len(TEX$) > 0
         TTYY$ = CODD$ + Mid$(RESECO$(LL% - 1), 17, 2) + Left$(TEX$, 238)
         KK& = KK& + 4
         If KK& <= Len(RNC$) - 3 Then
             RENOTA& = CVS(Mid$(RNC$, KK&, 4))
           Else
