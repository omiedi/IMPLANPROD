...
Begin VB.Form SENDCOMIS07 
   ...
   Begin VB.Menu mnuArchivo 
      Caption         =   "Archivo"
      Begin VB.Menu MnuActualizarDetalleDeuda 
         Caption         =   "Actualizar Detalle de Deuda"
      End
   End
End
Attribute VB_Name = "SENDCOMIS07"
...
'          ACUMUIMPO# = ACUMUIMPO# + IMPO#
   ...
   If Check3.Value = 1 Then JKI% = JKI% + 1: MAI_ADJUN$(JKI%) = "C:\FLEXOFT\CUECOVEN.TXT"
   '
   OPX% = COMALTER%("Confirma Envío Por Mail\\Cancelar\Enviar")
...
'   Label4 = ""
   Label4 = TRIM$(VALOBADA("VENDEDOR", "EMAILVEND", "VEND_CLI = " & XVALO(Label1)))
...
Private Sub MnuActualizarDetalleDeuda_Click()
   FAPECOB07.FAPECOB2
   Call COMUNI("Detalle de Deuda Actualizado")
End Sub
