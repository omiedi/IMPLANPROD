VERSION 5.00
Begin VB.Form RCFINALEYM 
   BackColor       =   &H00CDDADA&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Control Final"
   ClientHeight    =   1785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00CDDADA&
      Caption         =   "Impresión de Control Final"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "RCFINALEYM.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "RCFINALEYM"
...
Private Sub Command2_Click()
    '
    Call GRACONTROL("", "CTFINEYM", Text4.TEXT)
    '
    '
    Call CIERRARCH("*.*")
