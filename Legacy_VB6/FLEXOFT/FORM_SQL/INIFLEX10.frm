...
Begin VB.Form INIFLEX10 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   3480
      OleObjectBlob   =   "INIFLEX10.frx":1D2A
      TabIndex        =   30
      Top             =   6240
      Visible         =   0   'False
      Width           =   495
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3480
      OleObjectBlob   =   "INIFLEX10.frx":1DA4
      Top             =   5520
   End
   ...
   Begin VB.PictureBox Picture10 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel Label7 
         Height          =   255
         Left            =   0
         OleObjectBlob   =   "INIFLEX10.frx":340E
         TabIndex        =   38
         Top             =   5040
         Width           =   3615
      End
      Begin ACTIVESKINLibCtl.SkinLabel Label6 
         Height          =   255
         Left            =   0
         OleObjectBlob   =   "INIFLEX10.frx":3476
         TabIndex        =   39
         Top             =   900
         Width           =   3615
      End
   ...
   Begin ComctlLib.ImageList imlSmallIcons 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   8
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":42CFF
            Key             =   "closed"
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":43221
            Key             =   "cylinder"
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":43743
            Key             =   "open1"
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":45295
            Key             =   "leaf"
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":457B7
            Key             =   "open"
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":45CD9
            Key             =   "smlBook"
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":4633B
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "INIFLEX10.frx":4699D
            Key             =   "closed1"
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "INIFLEX10"
...
Private Sub MSFlexGrid2_Click()
    ...
    With MSFlexGrid2
        If .Row > 0 Then
            ...
            CLANODO = TRIM$(.TextMatrix(.Row, 1)) ' Código (columna 1)
...
Private Sub Form_Resize()
   ...
   Picture3.Height = Height - Picture3.Top
      ...
      Me.MSFlexGrid2.Top = TreeView2.Top
      On Error Resume Next
      TreeView2.Height = Height - TreeView2.Top - 450
      Me.MSFlexGrid2.Height = TreeView2.Height
      On Error GoTo 0
   Call CARGAIMAGEN
   Picture7.Refresh
   Picture8.Refresh
...
Sub ACOMODATODO()
    ...
    Me.MSFlexGrid1.Width = Treeview1.Width
    TreeView2.Width = Frame1.Left + 50
    Me.MSFlexGrid2.Width = TreeView2.Width
    ...
    Me.MSFlexGrid1.Top = Treeview1.Top
    Treeview1.Height = TreeView2.Top - Label7.Height - Treeview1.Top
    Me.MSFlexGrid1.Height = Treeview1.Height
    Picture7.Refresh
    Picture8.Refresh
    Picture10.Refresh
    '
