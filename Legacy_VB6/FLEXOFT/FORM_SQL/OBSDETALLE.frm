...
Begin VB.Form OBSDETALLE 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Observación en Detalle"
   ClientHeight    =   1980
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7860
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "OBSDETALLE.frx":2376
      Top             =   1680
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   60
      OleObjectBlob   =   "OBSDETALLE.frx":25AA
      TabIndex        =   13
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
