...
Private Sub Command8_Click()
   ...
   If OPX% = 1 Then
       Call CONECRUN("BRECEP07/CONRECEP", "Recepcion de Proveedores")
     ElseIf OPX% = 2 Then
       Call ACCDIR("OCOMPRA")
   End If
...
Sub CoCoPen(ORDEN%)
   ...
   OCOMTEMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
...
Sub COCOMP0()
   '
    ...
    Set OCOMP0TEMP = New ADODB.Recordset
    OCOMP0TEMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
...
10 OKKX% = 0
   ...
   OCOMPTEMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
    On Error GoTo 90
    With OCOMPTEMP
        .MoveFirst
        JJ& = 0
...
Sub GENEMATCON()
    ...
    LIMACONTMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
    '
    With LIMACONTMP
     On Error Resume Next
       .MoveFirst
