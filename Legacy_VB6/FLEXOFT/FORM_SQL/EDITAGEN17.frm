...
Begin VB.Form EDITAGEN17 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   300
      OleObjectBlob   =   "EDITAGEN17.frx":0000
      TabIndex        =   3
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "EDITAGEN17.frx":007A
      Top             =   1800
   End
...
Sub QuitarFiladeMSF2(ID)
        For REG& = 1 To Agenda17.MSF2.Rows - 1
          If XVALO(Agenda17.MSF2.TextMatrix(REG&, 16)) = XVALO(ID) Then
             Call cmdEliminaItem(Agenda17.MSF2, REG&)
             Exit For
          End If
        Next
End Sub
...
Private Sub txtcodigo2_Change()
   ...
   CONTINU% = Agenda17.CONTINUIDAD%(txtcodigo2)
...
Private Sub TXTHORORGANIZADO_Change()
    X1 = Agenda17.ERRTIEMPO%(TXTHORORGANIZADO)
