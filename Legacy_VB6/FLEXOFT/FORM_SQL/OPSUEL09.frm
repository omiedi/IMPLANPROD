...
Begin VB.Form OPSUEL09 
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.OptionButton Option1 
            BackColor       =   &H00C0FFC0&
            Caption         =   "Competencias Profesionales"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   1995
      OleObjectBlob   =   "OPSUEL09.frx":2680
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "OPSUEL09.frx":28B4
      TabIndex        =   25
      Top             =   0
      Visible         =   0   'False
      Width           =   960
...
Private Sub Form_Load()
  ...
  TABLA$(10) = "COMPETEN"      'COMPETENCIAS PRODUCTIVAS
  '
...
Sub CARTABLA(Index)
   ...
   If Index = 0 Then
    ...
    ElseIf Index = 5 Then
       REMDET09.Show 1        'REMUNERACIONES ORDINARIAS
       Call FRESHALL
       Call COSUJO09.HACECONCEP
    ElseIf Index = 6 Then
       RETDET09.Show 1         'RETENCIONES LEGALES Y APORTES
       Call FRESHALL
       Call COSUJO09.HACECONCEP
    ElseIf Index = 7 Then
    ...
    ElseIf Index = 10 Then
       Call CARCOMPRO   'Competencias profecionales
   End If
   '
End Sub
'
...
Sub CARCOMPRO()
    Call BLANARCH("!COMPETEN")
    J& = 0
    'SE LEE EL ARCHIVO DEL SERVIDOR Y SE GENERA EL LOCAL
    For U& = 1 To ULTREG&("COMPETEN")
        X$ = REGLEIDO$("COMPETEN", U&)
        COSECC = TRIM(Left$(X$, 8))
        If COSECC <> "" Then
            Call REGAPP("!COMPETEN", X$)
        End If
    Next U&
    Call CIERRARCH("COMPETEN")
    Call CIERRARCH("!COMPETEN")
    '
    ATRI$ = "BORDEIZQ=W" + TRIM$(Str$(Left - 390))
    ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(Str$(Top + 50))
    VTB% = VENTABU%("COMPETEN/" + ATRI$) 'XQ COMPETEN.PRF ME MUESTRA LOS DEPOSITOS
    If VTB% < 0 Then Exit Sub
    '
    J& = 0
    For U& = 1 To ULTREG&("!COMPETEN")
        ...
        If COSECC <> "" Then
            J& = J& + 1
            Call GRAREG("COMPETEN", X$, J&)
        End If
    Next U&
    '
    Call SETULTREG("COMPETEN", J&)
    Call CIERRARCH("COMPETEN")
    Call CIERRARCH("!COMPETEN")
End Sub
