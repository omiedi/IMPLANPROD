...
Sub Command2_Click()
  Command2.Enabled = False
    ...
    If FLIM% > 0 Then
      SQLX$ = SQLX$ + " AND Fentre_Sol <= '" & FM1 & "' "
    End If
    'Set ATENTMP = Compras.OpenRecordset(SQLX$, 4)
    Dim ATENTMP As ADODB.Recordset
    Set ATENTMP = New ADODB.Recordset
    ATENTMP.OPEN FILTSQL$ (SQLX$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
...
5     Screen.MousePointer = 11
    ...
    Set OCANULTEMP = New ADODB.Recordset
    OCANULTEMP.OPEN FILTSQL$ (SQLX$), FLEXCONN, adOpenKeyset, adLockPessimistic
    With OCANULTEMP
        On Error Resume Next
        .MoveFirst
        If Err Then
...
15  AUTOENT07.Label14 = NUOCO&
    '
    AUTOENT07.LICOPEN.ListIndex = 0
    AUTOENT07.Label18 = Str$(AUTOENT07.PRONUAE&)
    HOII% = HOY(HOS$)
    AUTOENT07.Text14 = FECHATEX$(HOII%)
    AUTOENT07.Show 1
    '
...
Sub MODIOCOM()         ' MODIFICAR ORDEN DE COMPRA
    ...
    VRIMPTEMP.OPEN FILTSQL$ (SQLX$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
    With VRIMPTEMP
...
3   Call SELECHO("!INDIOCOM/Indice General de Ordenes de Compra (Pendientes-Cumplidas)")
    ...
    Dim EncoCabi As ADODB.Recordset
    Set EncoCabi = New ADODB.Recordset
    EncoCabi.OPEN FILTSQL$ (SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
    'With OcomEnca
    With EncoCabi
      ...
      '
      FOCAMOD07.Label11 = DEMONECO$(MONEMI%)
      FOCAMOD07.LText1 = NPRO%
      FOCAMOD07.Text6 = ATEN$
      FOCAMOD07.TEXT21(0) = !Cpag_Ocom
      FOCAMOD07.TEXT21(1) = EMBAL%
      FOCAMOD07.Text10 = !Lentrega
      FOCAMOD07.Text13 = Obse_Ocom
      FOCAMOD07.Text7 = ""    ' destino
      FOCAMOD07.Text18 = ""   ' sector
      FOCAMOD07.Text14 = ""   ' fecha de entrega
      FOCAMOD07.Text15 = !Mone_Cos
      FOCAMOD07.Text11 = NUOCO&
      FOCAMOD07.Text9 = FECHATEX$(FECHEMI%)
      'FACAMOD07.PORDESCU = !Pdes_Ocom
      'FACAMOD07.Total(4) = FORMATNUM(!Iotr1_Ocom, "F10.2")
       ' PORPER = 0
       ' On Error Resume Next
        'PORPER = 100 * Val(FACAMOD07.Total(4)) / (!ToBru_Ocom - !IDes_Ocom)
        'On Error GoTo 0
       ' If PORPER > 99.9 Then PORPER = 99.9
      'FACAMOD07.Text17 = TRIM$(FORMATNUM(PORPER, "F5.1"))
      FOCAMOD07.Text13 = !Obse_Ocom
      On Error Resume Next
      FOCAMOD07.Label13 = !Anex_Ocom
      FOCAMOD07.Label15 = TRIM$(Str$(!Stat_Ocom))
      ...
      On Error Resume Next
        ...
        End If
      On Error GoTo 0
      FOCAMOD07.Label16 = TRIM$(Str$(NROREV%)) 'FORMATNUM$(NROREV1%, "F2.0") LO COMENTE XQ DEVUELVE "" SI NUMERO =0
      '\\\OT-06-0082-WAR-FIN///
      On Error GoTo 0
      '
    End With
    Set EncoCabi = Nothing
    '
    Screen.MousePointer = 11
    REDETA$ = ""
    ARCHILIB$ = "!1OCOMDET"
    ...
    Set COMDET = New ADODB.Recordset
    COMDET.OPEN FILTSQL$ (SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, cmdtext
    With COMDET
      On Error Resume Next
      .MoveFirst
      If Err Then
      ...
      Do While Not .EOF
        ...
        '
        FOCAMOD07.Text7 = CODCUE$(!IContab)
        On Error Resume Next
        FACAMOD07.Text18 = !Sect_Ocom
        On Error GoTo 0
        '
      .MoveNext
      Loop
    ...
    FOCAMOD07.Text14 = FECHATEX$(FENTREGEN%)
    '
    Call FOCAMOD07.CARCOANT
    Call FOCAMOD07.CARLISCO
    Call FOCAMOD07.CALTOCOM
    '\\\OT-06-0149-WAR-19/04/06///
    FOCAMOD07.Text122 = FORMATNUM(1, "F11.4")
    HOII% = HOY(HOS$)
    FOCAMOD07.Label21(5) = HOS$ 'COTIZACION DEL DIA DE LA FECHA
    TICAMBX# = TICAMONE(MONEMI%)
    FOCAMOD07.Text122 = FORMATNUM(TICAMBX#, "F11.4")
    '\\\OT-06-0149-WAR-FIN///
    FOCAMOD07.Show 1
    GoTo 3
    '
