...
'   NSERIE$ = TRIM$(Text1)
'   If NSERIE$ <> "" Then
'    CUERPO$ = "Reparación - Recepción del Equipo"
...
Sub BLANFORMU()
   ...
   '
   '\\\OT-08-0944-OD-16/10/08///
   'HABILITO EL BOTON Y EL TEXT DE CODIGO POR SI HABIA QUEDADO DESHABILITADO
   Text13.Enabled = True
   Command18.Enabled = True
   '\\\OT-08-0944-OD-FIN///
