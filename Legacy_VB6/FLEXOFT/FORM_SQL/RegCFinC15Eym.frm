...
Begin VB.Form RegCFinC15Eym 
   BackColor       =   &H00E2D3C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "REGISTRO DE CONTROL FINAL C15"
   ClientHeight    =   9195
   ClientLeft      =   45
   ClientTop       =   915
   ClientWidth     =   14250
   ...
   Begin VB.PictureBox Picture13 
      ...
      Begin VB.CommandButton Command23 
         Height          =   650
         Left            =   105
         Picture         =   "RegCFinC15Eym.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Command26 
         Height          =   650
         Left            =   105
         Picture         =   "RegCFinC15Eym.frx":066A
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         Height          =   650
         Left            =   120
         Picture         =   "RegCFinC15Eym.frx":0AAC
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Command29 
         Height          =   630
         Left            =   105
         Picture         =   "RegCFinC15Eym.frx":0DB6
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Command1 
         Height          =   640
         Left            =   105
         Picture         =   "RegCFinC15Eym.frx":10C0
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Salir"
         Top             =   120
      ...
      Begin VB.Image Image2 
         Height          =   390
         Left            =   -300
         Picture         =   "RegCFinC15Eym.frx":120A
   ...
   Begin MSFlexGridLib.MSFlexGrid MSF 
      Bindings        =   "RegCFinC15Eym.frx":312C
      Height          =   7365
      Left            =   120
      TabIndex        =   28
      Top             =   1800
   ...
   Begin VB.Image Image3 
      Height          =   480
      Left            =   120
      Picture         =   "RegCFinC15Eym.frx":3140
      Top             =   1080
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image Image1 
      Height          =   480
      Left            =   120
      Picture         =   "RegCFinC15Eym.frx":344A
      Top             =   1080
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "RegCFinC15Eym"
...
Sub ActualizarOperacion27(NUSERIE$)
   CONDI$ = "(OP = 0 OR OP IS NULL)  and numeroserie = '" & NUSERIE$ & "' AND DESCRIPCION = 'Modo DEA (sólo si aplica modelo)'"
   
   CANTI = CantRegistros("CONTFINEYM", CONDI$, "NOMESS")
   If CANTI >= 1 And CANTI <= 10 Then ' menor a 10 por las dudas.
      Call ACTUREGISTRO("CONTFINEYM", "OP", CONDI$, 27, REGAF&, "NOMESS")
   End If
...
Private Sub Command2_Click()
   '\\\OT-08-0936-OD-08/10/08///
    ...
    CIXI% = CODINT%(Label95)
    RESULTADOX$ = "C"
    EXCEP$ = EXCEPCION_CONTROL_EYM$(CIXI%, "RegCFinC15Eym")
...
ERROR_GUARDAR:
    ...
    Call PRINTREGCFC15(NUSERIE$, REVIS%)
    '
...
99  Command2.Enabled = True
   '\\\OT-08-0936-OD-fin///
End Sub
Sub PRINTREGCFC15(NUSERIE$, ULTREVIS%)
...
'    End If
    ...
    Else
      RUTAEXCEL$ = CONTROL("REGICFIN", "CF_EXC15")
    End If
    ...
    For i& = 1 To Me.MSF.Rows - 1
        ...
        .TextMatrix(i&, 1) = "" 'LIMPIO ESTAS DOS FILAS P.Q. NO LAS LEO Y SEGUN EL CASO LAS ESCRIBO
         .TextMatrix(i&, 2) = ""
       NroIImpresoMSF% = XVALO(MSF.TextMatrix(i&, 1))
       Select Case NroIImpresoMSF%
         Case 16, 17, 18, 19, 20, 21, 23, 25
            .TextMatrix(i&, 2) = Me.MSF.TextMatrix(i&, 3)
            If i& = 27 And NroIImpresoMSF% = 25 Then '
               GoTo 30 'ACA VA A ENTRAR EN LA REPETICION DEL REGISTRO 25 SOLO EN LA SEGUNDA
            End If
         Case Else
30          If Me.MSF.TextMatrix(i&, 8) = "OK" Then
               .TextMatrix(i&, 1) = "A"
...
'    VENTABNEW.Show 1
    ...
    Call Param_Print_Excel(RUTAEXCEL$, "RD Control Final C-15 Rev.E", VENTABNEW.MSF, PDES$, "1", 12, 1, "", 1, 1)     'imprime en excel la primera columna de mi msf en la columna 1 a partir de la fila 12 en el excel (este graba pero no lo imprime)
    Call Param_Print_Excel(RUTAEXCEL$, "RD Control Final C-15 Rev.E", VENTABNEW.MSF, PDES$, "2", 12, 7, "", 1, 1) 'imprime en excel la 2 columna de mi msf en la columna 8 a partir de la fila 12 en el excel (este graba pero no lo imprime)
    Call Param_Print_Excel(RUTAEXCEL$, "RD Control Final C-15 Rev.E", VENTABNEW.MSF, PDES$, "3", 4, 18, "", 1, 0)       'imprime en excel la 3 columna de mi msf en la columna 1 a partir de la fila 54 en el excel  (este imprime con los 3 cambios )
...
'   Call PRINTMEDI(0) '  0 IMPRESION SIMPLE --- UNO GRABACION
    ...
    Call PRINTREGCFC15(NUSERIE$, ULTREVIS%)
    '
End Sub
...
Private Sub Form_Load()
    ...
    ' Establece el tamaño inicial del formulario
    Me.Width = 14340
    Me.Height = 9930
...
'    If MSF.TextMatrix(REG&, 8) = "N/A" And REG& <> 35 And Label15.Visible = False Then Exit Sub
    If MSF.TextMatrix(REG&, 8) = "N/A" Then Exit Sub
    ...
    If (IDFILA& >= 16 And IDFILA& <= 21) Or (IDFILA& = 23 Or (IDFILA& = 25 And REG& = 26)) Then
        MSF.COL = 3
        With TXTMOVIL
          .ZOrder 0
          .Width = MSF.CellWidth
    ...
    Else
        COLX& = 8: COLUM% = 8
        ResulValidacion$ = VALIDARRESULTADOOKYMAL$(MSF, REG&, COLX&)
        NroRegImpreso& = XVALO(MSF.TextMatrix(REG&, 1))
        MSF.TextMatrix(REG&, 8) = ResulValidacion$
        If ResulValidacion$ = "MAL" Then
              Call APlicarEnBloqueRepetido(MSF, ResulValidacion$, NroRegImpreso&, 1, 8, vbRed)
           Else
              Call APlicarEnBloqueRepetido(MSF, ResulValidacion$, NroRegImpreso&, 1, 8, vbBlack)
        End If
...
'      If TRIM$(MSF.TextMatrix(REG&, 3)) = "" And TRIM$(MSF.TextMatrix(REG&, 3)) = "" Then
      IDFILA& = XVALO(MSF.TextMatrix(REG&, 1)) 'ESTO SE CAMBIO A DIFERENCIA DEL ORIGINAL FRM RegCFinEym
      '  IDFILA& = REG&
'      If (IDFILA& >= 10 And IDFILA& <= 15) Or IDFILA& = 17 Or IDFILA& = 34 Then
      If (IDFILA& >= 16 And IDFILA& <= 21) Or (IDFILA& = 23 Or (IDFILA& = 25 And REG& = 26)) Then
...
Private Sub Text8_DblClick()
   '\\\OT-08-0936-OD-08/10/08///
    NSERIE$ = SERIES_CONTROLFINAL_C15
    If NSERIE$ <> "" Then
      Text8 = NSERIE$
   ...
   '\\\OT-08-0936-OD-08/10/08///
End Sub
 Function SERIES_CONTROLFINAL_C15()
   ...
   Dim obj As New RECORXET
   Set RS1 = obj.RS_COD_LLEVAN_CONTROL_DB_C15("RegCFinC15Eym")
   Call Carga_MSF_Recordset(RS1, Campos$, FRMZELECHO.msf2)
   Set obj = Nothing
   RS1.Close
   Set RS1 = Nothing
   ...
   If TRIM$(RESP_ZELE_VECT(1)) <> "" Then
      SERIES_CONTROLFINAL_C15 = TRIM$(RESP_ZELE_VECT(1))
   End If
    '
End Function
Function SiAplicaoNoEym$(NroFilaEym%, Modelo$)
  ...
  NumRegistroDataSql$ = TRIM$(CStr(NroFilaEym%)) 'POR QUE LOS CAMPO SON TIPO TEXTOS
   ...
   SQLX$ = SQLX$ + " "
   CONDI$ = "TRIM(LISTA) = 'CONFIGURACION C.F. C15' AND TRIM(Campo20)= '" & NumRegistroDataSql$ & "'"
...
Private Sub Text8_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
             ...
             NUSERIE$ = TRIM$(Text8)
             Call ActualizarOperacion27(NUSERIE$)
...
'             '
             ...
             SQLX$ = SQLX$ + " AND COD_EXTE LIKE  'DB%' "
             SQLX$ = SQLX$ + " order by OP,CONTFINEYM_ID  "
             Set rs = READSET(SQLX$)
             With rs
               Do While Not .EOF
                      i& = i& + 1
...
Sub CARGA_REGISTRO_ContFinal()
    ...
    MSF.TextMatrix(3, 2) = "Auto Test"
    
    MSF.TextMatrix(4, 1) = "4"
    MSF.TextMatrix(4, 2) = "Alimentación desde red de c.a."
    
    MSF.TextMatrix(5, 1) = "4"
    MSF.TextMatrix(5, 2) = "Cargador de batería"
    
    MSF.TextMatrix(6, 1) = "5"
    MSF.TextMatrix(6, 2) = "Display"

    MSF.TextMatrix(7, 1) = "6"
    MSF.TextMatrix(7, 2) = "Teclas"
    
    MSF.TextMatrix(8, 1) = "7"
    MSF.TextMatrix(8, 2) = "Fecha y hora"
    
    MSF.TextMatrix(9, 1) = "8"
    MSF.TextMatrix(9, 2) = "Oximetría (sólo si aplica modelo)"
    
    MSF.TextMatrix(10, 1) = "9"
    MSF.TextMatrix(10, 2) = "Registro gráfico (sólo si aplica modelo)"
    
    MSF.TextMatrix(11, 1) = "10"
    MSF.TextMatrix(11, 2) = "Control de volumen"
'    MSF.TextMatrix(11, 3) = ""
'    MSF.TextMatrix(11, 4) = "J"
'    MSF.TextMatrix(11, 5) = "1.5"
'    MSF.TextMatrix(11, 6) = "< VM >"
'    MSF.TextMatrix(11, 7) = "2.5"
'    MSF.TextMatrix(11, 8) = ""
    
    MSF.TextMatrix(12, 1) = "11"
    MSF.TextMatrix(12, 2) = "Derivaciones ECG"
'    MSF.TextMatrix(12, 3) = ""
'    MSF.TextMatrix(12, 4) = "J"
'    MSF.TextMatrix(12, 5) = "9"
'    MSF.TextMatrix(12, 6) = "< VM >"
'    MSF.TextMatrix(12, 7) = "11"
    
    MSF.TextMatrix(13, 1) = "12"
    MSF.TextMatrix(13, 2) = "Control de amplitud"
'    MSF.TextMatrix(13, 3) = ""
'    MSF.TextMatrix(13, 4) = "J"
'    MSF.TextMatrix(13, 5) = "47"
'    MSF.TextMatrix(13, 6) = "< VM >"
'    MSF.TextMatrix(13, 7) = "53"
    
    MSF.TextMatrix(14, 1) = "13"
    MSF.TextMatrix(14, 2) = "Frecuencia Cardíaca"
'    MSF.TextMatrix(14, 3) = ""
'    MSF.TextMatrix(14, 4) = "J"
'    MSF.TextMatrix(14, 5) = "190"
'    MSF.TextMatrix(14, 6) = "< VM >"
'    MSF.TextMatrix(14, 7) = "210"
'    MSF.TextMatrix(14, 8) = ""
    
    MSF.TextMatrix(15, 1) = "14"
    MSF.TextMatrix(15, 2) = "Alarmas"
'    MSF.TextMatrix(15, 3) = ""
'    MSF.TextMatrix(15, 4) = "J"
'    MSF.TextMatrix(15, 5) = "285"
'    MSF.TextMatrix(15, 6) = "< VM >"
'    MSF.TextMatrix(15, 7) = "315"
'    MSF.TextMatrix(15, 8) = ""
    
    MSF.TextMatrix(16, 1) = "15"
    MSF.TextMatrix(16, 2) = "Test externo (x5)"
'    MSF.TextMatrix(16, 3) = ""
'    MSF.TextMatrix(16, 4) = "J"
'    MSF.TextMatrix(16, 5) = "342"
'    MSF.TextMatrix(16, 6) = "< VM >"
'    MSF.TextMatrix(16, 7) = "378"
'    MSF.TextMatrix(16, 8) = ""
    
    MSF.TextMatrix(17, 1) = "16"
    MSF.TextMatrix(17, 2) = "Entrega 2 Joules"
    MSF.TextMatrix(17, 3) = ""
    MSF.TextMatrix(17, 4) = "J"
    MSF.TextMatrix(17, 5) = "1.5"
    MSF.TextMatrix(17, 6) = "< VM >"
    MSF.TextMatrix(17, 7) = "2.5"
    MSF.TextMatrix(17, 8) = ""
    
    MSF.TextMatrix(18, 1) = "17"
    MSF.TextMatrix(18, 2) = "Entrega 10 Joules"
    MSF.TextMatrix(18, 3) = ""
    MSF.TextMatrix(18, 4) = "J"
    MSF.TextMatrix(18, 5) = "9"
    MSF.TextMatrix(18, 6) = "< VM >"
    MSF.TextMatrix(18, 7) = "11"
    MSF.TextMatrix(18, 8) = ""

    
    MSF.TextMatrix(19, 1) = "18"
    MSF.TextMatrix(19, 2) = "Entrega 50 Joules"
    MSF.TextMatrix(19, 3) = ""
    MSF.TextMatrix(19, 4) = "J"
    MSF.TextMatrix(19, 5) = "47"
    MSF.TextMatrix(19, 6) = "< VM >"
    MSF.TextMatrix(19, 7) = "53"
    MSF.TextMatrix(19, 8) = ""
    
    MSF.TextMatrix(20, 1) = "19"
    MSF.TextMatrix(20, 2) = "Entrega 200 Joules"
    MSF.TextMatrix(20, 3) = ""
    MSF.TextMatrix(20, 4) = "J"
    MSF.TextMatrix(20, 5) = "190"
    MSF.TextMatrix(20, 6) = "< VM >"
    MSF.TextMatrix(20, 7) = "210"
    MSF.TextMatrix(20, 8) = ""
    
    MSF.TextMatrix(21, 1) = "20"
    MSF.TextMatrix(21, 2) = "Entrega 300 Joules"
    MSF.TextMatrix(21, 3) = ""
    MSF.TextMatrix(21, 4) = "J"
    MSF.TextMatrix(21, 5) = "285"
    MSF.TextMatrix(21, 6) = "< VM >"
    MSF.TextMatrix(21, 7) = "315"
    MSF.TextMatrix(21, 8) = ""
    
    MSF.TextMatrix(22, 1) = "21"
    MSF.TextMatrix(22, 2) = "Entrega 360 Joules"
    MSF.TextMatrix(22, 3) = ""
    MSF.TextMatrix(22, 4) = "J"
    MSF.TextMatrix(22, 5) = "342"
    MSF.TextMatrix(22, 6) = "< VM >"
    MSF.TextMatrix(22, 7) = "378"
    MSF.TextMatrix(22, 8) = ""
    
    MSF.TextMatrix(23, 1) = "22"
    MSF.TextMatrix(23, 2) = "Entrega interna 360 Joules (x3)"
    MSF.TextMatrix(23, 3) = ""
    MSF.TextMatrix(23, 4) = ""
    MSF.TextMatrix(23, 5) = ""
    MSF.TextMatrix(23, 7) = ""
    ...
    MSF.TextMatrix(24, 1) = "23"
    MSF.TextMatrix(24, 2) = "Tiempo de carga a 200 Joules"
    MSF.TextMatrix(24, 3) = ""
    MSF.TextMatrix(24, 4) = "S"
    MSF.TextMatrix(24, 5) = "10"
    MSF.TextMatrix(24, 6) = "< VM <"
    MSF.TextMatrix(24, 7) = "10"
    MSF.TextMatrix(24, 8) = ""


    MSF.TextMatrix(25, 1) = "24"
    MSF.TextMatrix(25, 2) = "Descarga automática de energía acumulada"
    MSF.TextMatrix(25, 3) = ""
    MSF.TextMatrix(25, 4) = ""
    MSF.TextMatrix(25, 5) = ""
    MSF.TextMatrix(25, 7) = ""
    ...
    MSF.TextMatrix(26, 1) = "25"
    MSF.TextMatrix(26, 2) = "Demora en modo sincronizado"
    MSF.TextMatrix(26, 3) = ""
    MSF.TextMatrix(26, 4) = "MS"
    MSF.TextMatrix(26, 5) = "50"
    MSF.TextMatrix(26, 6) = "< VM <"
    MSF.TextMatrix(26, 7) = "50"
    MSF.TextMatrix(26, 8) = ""

    MSF.TextMatrix(27, 1) = "25"
    MSF.TextMatrix(27, 2) = "Presencia de espiga en QRS"
    MSF.TextMatrix(27, 3) = ""
    MSF.TextMatrix(27, 4) = ""
    MSF.TextMatrix(27, 5) = ""
    MSF.TextMatrix(27, 7) = ""
    ...
    MSF.TextMatrix(28, 1) = "26"
    MSF.TextMatrix(28, 2) = "ECG desde paletas de desfibrilación"
    MSF.TextMatrix(28, 3) = ""
    MSF.TextMatrix(28, 4) = ""
    MSF.TextMatrix(28, 5) = ""
    MSF.TextMatrix(28, 7) = ""
    ...
    MSF.TextMatrix(29, 1) = "27"
    MSF.TextMatrix(29, 2) = "Modo DEA (sólo si aplica modelo)"
    MSF.TextMatrix(29, 3) = ""
    MSF.TextMatrix(29, 4) = ""
    MSF.TextMatrix(29, 5) = ""
    MSF.TextMatrix(29, 7) = ""
    ...
    MSF.TextMatrix(30, 1) = "28"
    MSF.TextMatrix(30, 2) = "Marcapasos modo fijo (sólo si aplica modelo)"
    MSF.TextMatrix(30, 3) = ""
    MSF.TextMatrix(30, 4) = ""
    MSF.TextMatrix(30, 5) = ""
    MSF.TextMatrix(30, 7) = ""
    ...
    MSF.TextMatrix(31, 1) = "28"
    MSF.TextMatrix(31, 2) = "Marcapasos modo demanda (sólo si aplica modelo)"
    MSF.TextMatrix(31, 3) = ""
    MSF.TextMatrix(31, 4) = ""
    MSF.TextMatrix(31, 5) = ""
    MSF.TextMatrix(31, 7) = ""
    ...
    MSF.TextMatrix(32, 1) = "28"
    MSF.TextMatrix(32, 2) = "Verificar STOP de Marcapasos (sólo si aplica modelo)"
    MSF.TextMatrix(32, 3) = ""
    MSF.TextMatrix(32, 4) = ""
    MSF.TextMatrix(32, 5) = ""
    MSF.TextMatrix(32, 7) = ""
    ...
    MSF.TextMatrix(34, 1) = "30"
    MSF.TextMatrix(34, 2) = "Reporte (sólo si aplica modelo)"
    MSF.TextMatrix(34, 3) = ""
    MSF.TextMatrix(34, 4) = ""
    MSF.TextMatrix(34, 5) = ""
    MSF.TextMatrix(34, 7) = ""
    ...
    MSF.TextMatrix(35, 1) = "31"
    MSF.TextMatrix(35, 2) = "Valores de fábrica"
    MSF.TextMatrix(35, 3) = ""
    MSF.TextMatrix(35, 4) = ""
    MSF.TextMatrix(35, 5) = ""
    MSF.TextMatrix(35, 7) = ""
    ...
    MSF.TextMatrix(36, 1) = "32"
    MSF.TextMatrix(36, 2) = "Seguridad eléctrica (según IEC 60601-1)"
    MSF.TextMatrix(36, 3) = ""
    MSF.TextMatrix(36, 4) = ""
    MSF.TextMatrix(36, 5) = ""
    MSF.TextMatrix(36, 7) = ""
