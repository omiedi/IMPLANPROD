...
Begin VB.Form FORFAC07 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel Label6 
         Height          =   255
         Left            =   6000
         OleObjectBlob   =   "FORFAC07.frx":0000
         TabIndex        =   199
         Top             =   1150
         Width           =   1935
      End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "FORFAC07.frx":1D85
      TabIndex        =   124
      Top             =   1200
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "FORFAC07.frx":1DFF
      Top             =   1200
   End
   ...
   Begin VB.Menu Setup 
      ...
      Begin VB.Menu ingbru 
         Caption         =   "Ingresos Brutos - Tabla de Provincias"
      End
      Begin VB.Menu gfleteprocueco 
         Caption         =   "Cta. Contable Prov. Gastos de Flete"
      End
      Begin VB.Menu CtaXDefectoProvCargaXDetalle 
         Caption         =   "Cta. X Defecto en Carga X Detalle"
      End
      ...
      Begin VB.Menu SetupAcreedores 
         Caption         =   "Configuración de Funcionamiento de Acreedores"
      End
   End
...
20  CAMPOS$ = "Cta.Pr./f7;R.Social/A32;Cta.Cont-(Default x Detalle)/A26;Referencia/A32"
    ...
    Call VectProveedor.CARGAVECTORCTAXDFTO
    J& = 0
    SQLX$ = " Select nume_cli ,raso_cli  from proved12 with(nolock)"
