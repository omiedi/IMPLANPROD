...
Begin VB.Form FAPOCAB07 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image2 
         Height          =   390
         Left            =   -315
         Picture         =   "FAPOCAB07.frx":0D72
         Top             =   2310
         Width           =   1515
      End
   End
End
Attribute VB_Name = "FAPOCAB07"
...
3       Call SELECHO("INDOCPEN/Indice General de Ordenes de Compra Pendientes de Aprobación.")
        ...
        'Set VEROCTEMP = Compras.OpenRecordset(SQLX$, dbOpenSnapshot)
        'NO VUELVO A DECLARAR VEROCTEMP P/Q ESTA DECLARADA ARRIBA
        Set VEROCTEMP = New ADODB.Recordset
        VEROCTEMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
...
4           'If PRX% = 0 Then
            ...
            'End If
            'If .NoMatch = False Then
        SQLX$ = " UPDATE DetoCabi SET Stat_Ocom = 0 "
        SQLX$ = SQLX$ + " WHERE  Nume_Ocom = " & NPX & ""
...
Screen.MousePointer = 11
   ...
   OCOMPETEMP.Open FILTSQL$(SQLX$), FLEXCONN, adOpenKeyset, adLockReadOnly, adCmdText
