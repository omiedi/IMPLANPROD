VERSION 5.00
Begin VB.Form FSTPINFE 
   BackColor       =   &H00C0FFC0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración de Formulario Informe de Ensayo"
   ClientHeight    =   1755
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FSTPINFE.frx":298A
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FSTPINFE"
...
Private Sub Command2_Click()
    '
    Call GRACONTROL("", "INFENSA", Text4.TEXT)
    '
    '
    Call CIERRARCH("*.*")
