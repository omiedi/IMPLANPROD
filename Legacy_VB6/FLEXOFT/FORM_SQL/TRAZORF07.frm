...
Begin VB.Form TRAZORF07 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   420
      OleObjectBlob   =   "TRAZORF07.frx":39F4
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   1320
      OleObjectBlob   =   "TRAZORF07.frx":3C28
      TabIndex        =   99
      Top             =   0
      Visible         =   0   'False
      Width           =   1590
...
Sub ARMALILOT1(CIXI%, LOTEAC$)
    ...
    SQLX$ = SQLX$ + "OR CanConsu IS NULL or CanReser IS NULL )"
