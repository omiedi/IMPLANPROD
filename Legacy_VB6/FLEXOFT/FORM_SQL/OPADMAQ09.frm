...
Begin VB.Form OPADMAQ09 
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   1155
      OleObjectBlob   =   "OPADMAQ09.frx":2680
      TabIndex        =   22
      Top             =   0
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2730
      OleObjectBlob   =   "OPADMAQ09.frx":26FA
      Top             =   0
   End
End
Attribute VB_Name = "OPADMAQ09"
