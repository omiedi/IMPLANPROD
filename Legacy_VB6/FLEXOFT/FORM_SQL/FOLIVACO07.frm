...
Begin VB.Form FOLIVACO07 
   BackColor       =   &H00C7D9CC&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " Configuración Libro IVA Compra"
   ClientHeight    =   1650
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00C7D9CC&
      Caption         =   "IMPRESIÓN DE LIBRO IVA COMPRAS"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "FOLIVACO07.frx":0A68
      TabIndex        =   30
      Top             =   0
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "FOLIVACO07.frx":0AE2
      Top             =   1200
   End
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "FOLIVACO07.frx":0D16
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "FOLIVACO07"
...
Private Sub Command2_Click()
    ...
    Call GRACONTROL("FORIPRE", "LIVACOM", Text4.TEXT)
    Call CIERRARCH("*.*")
    Hide
    '\\\OT-06-0558-RG-FIN///     '
End Sub
...
Private Sub Form_Load()
    '\\\OT-06-0558-RG-21/12/06///
    Text4.TEXT = CONTROL$("FORIPRE", "LIVACOM")
