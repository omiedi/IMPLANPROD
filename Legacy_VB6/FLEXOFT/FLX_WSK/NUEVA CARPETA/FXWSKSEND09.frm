...
Begin VB.Form FXWSKSEND09 
   ...
   Begin VB.Frame fraOptions 
      ...
      Begin VB.ComboBox cboPriority 
         Height          =   315
         ItemData        =   "FXWSKSEND09.frx":0000
         Left            =   120
         List            =   "FXWSKSEND09.frx":0002
         TabIndex        =   39
         Text            =   "cboPriority"
...
On Error GoTo 80
    With poSendMail
        ...
        Result = "": MAI_SENDOK% = 0
        .Send                                  ' Required
        If Result = "OK" Then MAI_SENDOK% = 1
...
On Error GoTo 0
    ...
    Exit Sub
    '
80  ERRDE$ = Err.Number + " - " + Err.Description
    On Error GoTo 0
    MsgBox ERRDE$
    Unload Me
    '
...
Private Sub poSendMail_SendFailed(Explanation As String)
    ...
    If InStr(FXMAIWSK09.MODENVI, "/AUTO") < 1 Then
...
Private Sub Timer1_Timer()
   ' ESTE ES PARA TRAERLO AL FRENTE
   Static VECES%
   If Visible = True Then
     If VECES% < 10 Then          ' que lo haga 10 veces
       VECES% = VECES% + 1
       On Error Resume Next
       Me.ZOrder (0)
       AppActivate Caption
...
Private Sub Timer2_Timer()
   ' ESTE ES PARA APAGARLO AUTOMATICAMENTE A LOS 60 SEGUNDOS
   Static CONTA%
   If MAI_AUTO% > 0 Then
      CONTA% = CONTA% + 1
      If CONTA% > 60 Then
