...
Sub FACITEMI1(OKEY%)
   ...
   End If
   '
   FORFACDIP.Text1.TEXT = Str$(NC%)
   FORFACDIP.Text2.TEXT = RASOCLI$(NC%)
   FORFACDIP.Text3.TEXT = DOMICLI$(NC%)
   FORFACDIP.Text4.TEXT = CPOSCLI$(NC%)
   FORFACDIP.Text5.TEXT = LOCACLI$(NC%)
   FORFACDIP.Text7.TEXT = TRIM$(CUITCLI$(NC%)) + " - " + POSIVAC$(NC%)
   '
   PIVAFAC% = PIVACLI%(NC%)
   If PIVAFAC% <> 0 Then
      If PIVAFAC% <> 5 Then
...
39 Next UU&
   ...
   PREUCO = ITOTCO# / CACO
   FORFACDIP.Label10.Caption = CSTRING$(MKD$(ITOTCO#), 3, 12, 2, 2)
   '
   ILISTA& = 0
...
Sub CLEARFORFACDIP()
   ...
   Call BLANARCH("!CARITPED")
   '
   FORFACDIP.List2.Clear
   FORFACDIP.Text1.TEXT = ""
   FORFACDIP.Text2.TEXT = ""
   FORFACDIP.Text3.TEXT = ""
   FORFACDIP.Text4.TEXT = ""
   FORFACDIP.Text5.TEXT = ""
   FORFACDIP.Text6.TEXT = "X"
   FORFACDIP.Text7.TEXT = ""
   '
   FEFAC% = HOY(HO$)
   FORFACDIP.Text9.TEXT = HO$
    '
   FORFACDIP.Text11.TEXT = ""
   '
   FORFACDIP.Label14.Caption = ""
   FORFACDIP.Label18.Caption = ""
   FORFACDIP.Label20.Caption = ""
   '
   FORFACDIP.Text1.SetFocus
   '
End Sub
'
Sub CLEARDEBILIB()
