...
Private Sub BOTNEXT_Click()
     '
     If InStr(Label10.Caption, "Anulacion de Comprobantes") > 0 Then
         Exit Sub
     End If
     '
     NCII% = Val(Text1.TEXT)
...
Private Sub Command7_Click()
    ...
    Call CONECRUN("#SVD151", "Condiciones de Pago Clientes")
