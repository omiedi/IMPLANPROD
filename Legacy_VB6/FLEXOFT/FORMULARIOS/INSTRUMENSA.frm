...
Begin VB.Form INSTRUMENSA 
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   10350
      Picture         =   "INSTRUMENSA.frx":1F7C
      Top             =   7150
      Width           =   2010
   End
End
Attribute VB_Name = "INSTRUMENSA"
...
Private Sub Command10_Click()
   ...
   If TRIM$(Label37) = "" Or ECOARCH$("INSTRUME", AJUSTI$(Label37, 12)) = "" Then
      ...
      GoTo 99
   End If
   FICALIBRA.Label37 = Label37
   FICALIBRA.Label14 = Text3
   FICALIBRA.Label28 = Label28
   FICALIBRA.Label16 = Label16
   '
   FICALIBRA.Label2(0) = Text1
   FICALIBRA.Label2(1) = Text2
   FICALIBRA.Label2(2) = Text4
   FICALIBRA.Label2(3) = Text5
   FICALIBRA.Label2(4) = Text6
   FICALIBRA.Label2(5) = Text7
   FICALIBRA.Label2(6) = Text8
   FICALIBRA.Label2(7) = Text9
   FICALIBRA.Label2(8) = Label14
   '
   FICALIBRA.List2.Clear
   TTYZ$ = Text28.TEXT
   LOCADE& = Len(TTYZ$)
