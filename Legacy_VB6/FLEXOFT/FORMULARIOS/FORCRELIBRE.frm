VERSION 5.00
Begin VB.Form FORCRELIBRE 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Notas de Crédito de Texto Libre"
   ClientHeight    =   5640
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   11910
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BOTNEXT 
         ...
         Height          =   1000
         Left            =   10920
         Picture         =   "FORCRELIBRE.frx":0E74
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Aprueba - Registra - Imprime Nota de Crédito"
         Top             =   4410
         Width           =   855
      End
...
Private Sub Text10_Change()
    ...
    If PIVAFAC% <> 5 Then FORCRELIDIP.Label18.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVA / 100), 3, 10, 2, 2)
    If RENOIN% = 1 Then
       FORCRELIDIP.Label23.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVARNI / 100), 3, 10, 2, 2)
       ALITOTA = ALIVA + ALIVARNI
    End If
    FORCRELIDIP.Label20.Caption = CSTRING$(MKD$(TOPEDIDO# * (1 + ALITOTA / 100)), 3, 10, 2, 2)
    '
End Sub
...
Private Sub Text10_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      TOPEDIDO# = Val(Text10.TEXT)
      FORCRELIDIP.Text10.TEXT = CSTRING$(MKD$(TOPEDIDO#), 3, 10, 2, 2)
   End If
End Sub
