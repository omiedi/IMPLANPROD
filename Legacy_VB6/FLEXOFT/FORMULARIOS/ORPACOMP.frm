...
Private Sub Command1_Click()
    ...
    '
    If DERACCE%("CARMEPAG", "Actualizar Tabla Medios de Pago") < 2 Then
      GoTo 390
    End If
    '
    LU$ = LUDAT$
     ...
     If OBX$ <> "" Then
       ...
       If NCY% > 0 Then
         If NCY% <> NCX% Then
           ...
           RESCUPRO.Text1.TEXT = TRIM$(Str$(NCX%))
           RESCUPRO.Show 1
           RESCUPRO.Text1.TEXT = TRIM$(Str$(NCY%))
           RESCUPRO.Show 1
           '
         End If
       End If
...
Private Sub Command3_Click()
    Hide
    Call IMPUPRO1
    'Call OPNOIN("Imputación Creditos y Anticipos Proveedores")
End Sub
...
15             If TICUEPRO((-1) * NP%) = 1 Then ' CUENTA DE GASTOS
               ...
               If Abs(ITOT#) >= 0.005 Then
                 ...
                 If ITOT# > 0 Then
                   ...
                   Else
                     Call REPLA(Z$, MKD$(Abs(ITOT#)), 57, 8)
                 End If
                 JJ& = JJ& + 1
                 Call GRAREG("LISORPA", Z$, JJ&)
               End If
            ...
            Next UX%
            Call MENSERR(24, "Medio de Pago" + Str$(QUE%) + " no Definido\en Orden de Pago Número " + TRIM$(Str$(NOPA)))
            ' Call FINAL("")
            CUEH% = 0
            GoTo 19
            '
