...
Begin VB.Form FLEXLOG4 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   2100
      OleObjectBlob   =   "FLEXLOG4.frx":030A
      Top             =   840
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   735
      OleObjectBlob   =   "FLEXLOG4.frx":4BB4
      TabIndex        =   23
      Top             =   210
      Visible         =   0   'False
      Width           =   1485
   ...
   Begin ACTIVESKINLibCtl.Skin Skin2 
      Left            =   0
      OleObjectBlob   =   "FLEXLOG4.frx":4C2E
      Top             =   0
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      Height          =   225
      Index           =   1
      Left            =   0
      OleObjectBlob   =   "FLEXLOG4.frx":4E62
      TabIndex        =   25
      Top             =   2415
      Visible         =   0   'False
      Width           =   1485
...
Function VERICONEC%(CONNSTRI$)
    ...
    '   MsgBox "Conexion SQL Abierta Exitosamente" & vbCrLf & vbCrLf & "Servidor: " & SERNA$ & " - B.D.Ini: " & BINIC$
        BIENVENIDA.Label8.Caption = MAITEX$
        BIENVENIDA.Label9.Caption = MAITEX1$
        BIENVENIDA.Label3.Caption = USERNA$
        BIENVENIDA.Label5.Caption = SERNA$
        BIENVENIDA.Label7.Caption = BINIC$
        BIENVENIDA.Show 1
