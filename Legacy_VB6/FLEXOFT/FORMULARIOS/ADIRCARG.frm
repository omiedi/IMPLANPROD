...
Begin VB.Form ADIRCARG 
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   3920
      Picture         =   "ADIRCARG.frx":1386
      Top             =   2240
      Width           =   2010
   End
End
Attribute VB_Name = "ADIRCARG"
...
Private Sub Command14_Click()
    ...
    If EXISTE%("ORCOMP03.EXE") > 0 Then
        Call CONECRUN("ORCOMP03", "Gestion de Ordenes de Compra")
      ElseIf EXISTE%("ORCOMP02.EXE") > 0 Then
        Call CONECRUN("ORCOMP02", "Gestion de Ordenes de Compra")
      Else
        Call CONECRUN("OCOMPRA", "Gestion de Ordenes de Compra")
    End If
...
Private Sub Command35_Click()
    ...
    If EXISTE%("PROMRP02.EXE") > 0 Then
         Call CONECRUN("PROMRP02", "Programacion de Materiales - MRP-II")
       Else
         Call CONECRUN("PROGMAT", "Programacion de Materiales - MRP-II")
    End If
