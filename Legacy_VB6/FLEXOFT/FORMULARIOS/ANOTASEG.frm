...
Private Sub Command20_Click()
   ...
   Call FISEGVEN.Text5_DblClick
   If Err Then
      On Error GoTo 0
      Call FISECOM.Text5_DblClick
   End If
   Exit Sub
