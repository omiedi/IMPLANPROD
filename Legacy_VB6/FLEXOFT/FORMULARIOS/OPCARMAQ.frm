VERSION 5.00
Begin VB.Form OPCARMAQ 
   BackColor       =   &H00FFFFC0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Planilla de Carga de Máquinas"
   ClientHeight    =   2190
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6570
