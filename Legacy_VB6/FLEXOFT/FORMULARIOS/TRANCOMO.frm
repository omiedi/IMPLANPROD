...
Begin VB.Form TRANCOMO 
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   4380
      Picture         =   "TRANCOMO.frx":161A
      Top             =   4290
      Width           =   2010
   End
End
Attribute VB_Name = "TRANCOMO"
   ...
   If OBX$ <> "" Then
     ...
     For U& = 1 To Len(RFF$) Step 4
       ...
       If CVI(Mid$(X$, 225, 2)) <= 8224 Or CVS(Mid$(X$, 227, 4)) < 0.05 Then
         ...
         LIQUIENT.List2.AddItem TTXX$
       End If
     Next U&
     Screen.MousePointer = 1
     '
     If LIQUIENT.List2.ListCount < 1 Then
       Call MENSERR(24, "Sin Entregas Pendientes")
       GoTo 10
     End If
     '
     LIQUIENT.Label4 = TRIM$(Str$(NC%))
     LIQUIENT.Label7 = RASOCLI$(NC%)
     LIQUIENT.Label8 = DOMICLI$(NC%)
     LIQUIENT.Label10 = CPOSCLI$(NC%)
     LIQUIENT.Label12 = LOCACLI$(NC%)
     LIQUIENT.Label14 = FECHATEX$(FF%)
     LIQUIENT.Label13 = DELIQ$
     '
     LIQUIENT.Show 1
     '
   End If
