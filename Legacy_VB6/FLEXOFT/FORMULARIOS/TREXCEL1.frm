...
Private Sub Form_Load()
   ...
   N1% = FreeFile
   '
   If FileLen("C:\FLEXOFT\TREXCEL.TRF") < 1 Then
      MsgBox "Falta Archivo de Transferencia"
      Close: End
   End If
   '
   On Error GoTo 10
   Open "C:\FLEXOFT\TREXCEL.TRF" For Input Shared As #N1%
   On Error GoTo 0
   '
   On Error GoTo 20
