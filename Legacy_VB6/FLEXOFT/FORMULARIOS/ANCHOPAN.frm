...
Begin VB.Form ANCHOPAN 
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "8.- Ajustar Tamaño de Fuentes a ""Fuentes Pequeñas""."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "11.- Para ayuda llámenos al: 54-11-4541-1515."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "10.- Reinicie la ejecución de FLEXOFT."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "9.- Click sobre todos los botones Aceptar que  van                        "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label4 
      BackStyle       =   0  'Transparent
      Caption         =   "1.- Cancele la ejecución haciendo Click sobre el botón                 "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Para optimizar el funcionamiento de FLEXOFT es conveniente re-configurar su monitor."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
