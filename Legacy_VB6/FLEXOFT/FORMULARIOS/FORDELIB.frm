...
Private Sub Text10_Change()
   ...
   If PIVAFAC% <> 5 Then FORDELIB.Label18.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVABA / 100), 3, 10, 2, 2)
   If RENOIN% = 1 Then
      FORDELIB.Label23.Caption = CSTRING$(MKD$(TOPEDIDO# * (ALIVABA / ALIVA) * ALIVARNI / 100), 3, 10, 2, 2)
   End If
   FORDELIB.Label20.Caption = CSTRING$(MKD$(TOPEDIDO# + Val(Label18.Caption) + Val(Label23.Caption)), 3, 10, 2, 2)
   '
End Sub
...
Private Sub Text10_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      TOPEDIDO# = Val(Text10.TEXT)
      FORDELIB.Text10.TEXT = CSTRING$(MKD$(TOPEDIDO#), 3, 10, 2, 2)
   End If
End Sub
