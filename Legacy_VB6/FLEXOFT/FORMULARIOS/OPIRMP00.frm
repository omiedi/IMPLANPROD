...
Begin VB.Form OPIRMP00 
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "OPIRMP00.frx":0D72
      Top             =   5270
      Width           =   2010
   End
End
Attribute VB_Name = "OPIRMP00"
...
Private Sub Command2_Click()
    ...
    Call GRACONTROL("", "FORMIREC", Text1.TEXT)
    Call GRACONTROL("", "CODMIREC", Text5.TEXT)
    '
    MONUME$ = "AUTO": If Option1.Value = True Then MONUME$ = "MANUAL"
    Call GRACONTROL("", "NUMEBREC", MONUME$)
    '
    MONUME$ = TRIM$(Text7)
    Call GRACONTROL("BOLRECEP", "LETRANO", MONUME$)
    '
