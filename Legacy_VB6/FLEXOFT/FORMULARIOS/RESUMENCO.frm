...
Private Sub Form_Load()
    ...
    If InStr(UCase$(EPAC$), "SABO") Or InStr(UCase$(EPAC$), "DOSIVAC") > 0 Or InStr(UCase$(EPAC$), "FERVI") > 0 Then
    '\\\OT-06-0559-RG-FIN///
