VERSION 5.00
Begin VB.Form FORFACMAI 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Facturación en Cuenta Corriente - Formato Itemizado"
   ClientHeight    =   7800
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   11910
...
Private Sub Command5_Click()
   ...
   Z$ = List1.TEXT
   Call REPLA(Z$, CSTRING$(MKS$(PREUCO), 3, 8, 2, 2), 66, 8)
