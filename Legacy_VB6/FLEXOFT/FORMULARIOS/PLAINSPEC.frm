...
Begin VB.Form PLAINSPEC 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   0
      OleObjectBlob   =   "PLAINSPEC.frx":1DBC
      Top             =   1680
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   120
      OleObjectBlob   =   "PLAINSPEC.frx":1FF0
      TabIndex        =   54
      Top             =   0
      Visible         =   0   'False
      Width           =   1485
...
Sub GRAENCAPLA()
   ...
   Call REPLA(YY$, MKI$(XVALO(Text1)), 17, 2)
   Call REPLA(YY$, MKI$(XVALO(Text3)), 19, 2)
...
20 ATRI$ = "/NC"
   ...
   ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(str$(PLAINSPEC.Top + MARCOFICHA(1).Top + Picture3.Top))
   ATRI$ = ATRI$ + "/BORDEIZQ=W" + TRIM$(str$(PLAINSPEC.Left + MARCOFICHA(1).Left + Picture3.Left))
   '
