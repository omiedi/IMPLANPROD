...
Begin VB.Form IFORTIP 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "IFORTIP.frx":0454
      Height          =   5790
      Left            =   0
      OleObjectBlob   =   "IFORTIP.frx":0464
      TabIndex        =   1
      Top             =   2310
      Width           =   11775
   End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "F:\CLIENTES\SABO_WIN\TIPIFICA\ANEXOS ARO PLASTICO.xls"
      Height          =   255
      Index           =   4
      Left            =   105
      TabIndex        =   13
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "F:\CLIENTES\SABO_WIN\TIPIFICA\ANEXO RESORTES.xls"
      Height          =   255
      Index           =   3
      Left            =   105
      TabIndex        =   11
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "F:\CLIENTES\SABO_WIN\TIPIFICA\ANEXO CARCAZAS.xls"
      Height          =   255
      Index           =   2
      Left            =   105
      TabIndex        =   9
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "F:\CLIENTES\SABO_WIN\TIPIFICA\ANEXO ACELERANTES.xls"
      Height          =   255
      Index           =   1
      Left            =   105
      TabIndex        =   7
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "F:\CLIENTES\SABO_WIN\TIPIFICA\ANEXOS MEZCLAS.xls"
      Height          =   255
      Index           =   0
      Left            =   105
      TabIndex        =   2
...
Private Sub Command4_Click()
   N1% = FreeFile
   Open "C:\FLEXOFT\TEXTIPIF.TXT" For Output As #N1%
   For KKU% = 0 To 4
     Data1.DatabaseName = Label1(KKU%).Caption
     Data1.RecordSource = Label2(KKU%).Caption
     Data1.Refresh
     ...
     For U& = 11 To URECORD&
       ...
       DBGrid1.Col = 3
       DEDEX$ = DEDEX$ + TRIM$(DBGrid1.Text)
       Call REPLA(TTXX$, DEDEX$, 17, 48)
       '
       DBGrid1.Col = 4
       CODIN$ = TRIM$(DBGrid1.Text)
       Call REPLA(TTXX$, CODIN$, 81, 16)
       '
       DEDEX$ = TRIM$(Label3(KKU%)) + " " + CODIN$
       Call REPLA(TTXX$, DEDEX$, 97, 48)
       '
       DBGrid1.Col = 6
       NOMAR$ = TRIM$(DBGrid1.Text)
       Call REPLA(TTXX$, NOMAR$, 65, 16)
       '
       DBGrid1.Col = 11
       PORPER$ = AJUSTD$(Format$(Val(DBGrid1.Text), "#####0.000"), 12)
       Call REPLA(TTXX$, PORPER$, 145, 12)
       '
       DBGrid1.Col = 13
       CONTOT$ = AJUSTD$(Format$(Val(DBGrid1.Text), "#####0.0000000"), 12)
       Call REPLA(TTXX$, CONTOT$, 157, 12)
       '
       If Val(CONTOT$) > 0.000001 Then
         Print #N1%, TTXX$
       End If
       '
19   Next U&
