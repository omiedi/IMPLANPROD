...
Begin VB.Form IMPORGEN 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ListBox List1 
         ...
         ItemData        =   "IMPORGEN.frx":0000
         Left            =   120
         List            =   "IMPORGEN.frx":0002
         TabIndex        =   34
         Top             =   2910
         Width           =   10400
      End
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.ListBox List4 
            ...
            Height          =   1700
            IntegralHeight  =   0   'False
            ItemData        =   "IMPORGEN.frx":0618
            Left            =   0
            List            =   "IMPORGEN.frx":061A
            TabIndex        =   23
            Top             =   250
            Width           =   30000
         End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "IMPORGEN.frx":061C
         Height          =   3750
         Left            =   150
         OleObjectBlob   =   "IMPORGEN.frx":062C
         TabIndex        =   20
         Top             =   360
         Width           =   11295
      End
...
Private Sub Option1_Click(Index As Integer)
   ...
   Case 5
     ...
     "C.Postal        Localidad                                       Teléfono                Fax                     Contacto                        CUIT        Gp.Cliente"
   Case 6
     ...
     List2.AddItem "  5  Localidad                  String   <= 48 car"
     List2.AddItem "  6  Teléfono                   String   <= 24 car"
     List2.AddItem "  7  Persona de Contacto        String   <= 32 car"
     ...
     "Teléfono                Fax                     Contacto                CUIT             Tipo      "
   Case 7
     List2.AddItem "  1  Nivel de Agrupación        Num      0 - 4"
...
Sub PREIMPORPLA()
   ...
   For U& = 1 To URECORD&
     ...
     If NIVEI% < 0 Or NIVEI% > 4 Then NIVEI% = 0
...
Sub IMPORCLI()
   ...
   For U& = 1 To FIN&
     ...
     Call REPLA(XX$, Chr$(1), 136, 1) ' posicion iva = Resp.Inscripto
     ...
     Call REPLA(YY$, TRIM$(CONTACTX$), 385, 32)
     '
     REGY& = REGY& + 1
...
Sub IMPORPRO()
   ...
   For U& = 1 To FIN&
     ...
     Call REPLA(XX$, TRIM$(FANT$), 97, 10)
     Call REPLA(XX$, TRIM$(CUIT$), 107, 15)
     Call REPLA(XX$, TRIM$(IBRU$), 122, 15)
     Call REPLA(XX$, COPROVI$, 149, 1)
     Call REPLA(XX$, Chr$(CONDI%), 150, 1)
     Call REPLA(XX$, MKI$(TIPOCTA%), 151, 1)
     Call REPLA(XX$, Chr$(1), 152, 1) ' posicion iva = Resp.Inscripto
     'Call REPLA(XX$, Chr$(LIPRE%), 151, 1)
     'Call REPLA(XX$, Chr$(COVEN%), 152, 1)
     'Call REPLA(XX$, MKS$(LICRE), 153, 4)
     Call REPLA(XX$, MKI$(CUEMA%), 159, 2)
