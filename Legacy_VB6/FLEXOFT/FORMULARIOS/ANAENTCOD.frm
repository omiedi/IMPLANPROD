...
Begin VB.Form ANAENTCOD 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0E0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Análisis Estadistico - Entregas por Producto"
   ClientHeight    =   8355
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11910
   ...
   Begin MSChartLib.MSChart MSChart1 
      Height          =   4005
      Left            =   105
      OleObjectBlob   =   "ANAENTCOD.frx":07B4
      TabIndex        =   0
      Top             =   2415
      Width           =   11700
   End
        ...
        If CODIPE% <= HACODI% Then
          ...
          If CI% > 0 Then
            ...
            If AQQ% > 0 Then
              ...
              End If
              '
              TOVEN(ICLI%, 1 + CODIPE% - DECODI%) = TOVEN(ICLI%, 1 + CODIPE% - DECODI%) + CVD(Mid$(Z$, 51, 8))
            End If
          End If
        End If
      End If
