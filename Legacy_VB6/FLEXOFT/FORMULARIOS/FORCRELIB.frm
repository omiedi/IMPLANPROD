...
Private Sub Text10_Change()
    ...
    If PIVAFAC% <> 5 Then FORCRELIB.Label18.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVA / 100), 3, 10, 2, 2)
    If RENOIN% = 1 Then
       FORCRELIB.Label23.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVARNI / 100), 3, 10, 2, 2)
       ALITOTA = ALIVA + ALIVARNI
    End If
    FORCRELIB.Label20.Caption = CSTRING$(MKD$(TOPEDIDO# * (1 + ALITOTA / 100)), 3, 10, 2, 2)
    '
End Sub
...
Private Sub Text10_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      TOPEDIDO# = Val(Text10.TEXT)
      FORCRELIB.Text10.TEXT = CSTRING$(MKD$(TOPEDIDO#), 3, 10, 2, 2)
   End If
End Sub
