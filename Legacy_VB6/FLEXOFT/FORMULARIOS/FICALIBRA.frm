...
Begin VB.Form FICALIBRA 
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   1860
      ItemData        =   "FICALIBRA.frx":0BB2
      Left            =   105
      List            =   "FICALIBRA.frx":0BB4
      TabIndex        =   42
      Top             =   4200
      Width           =   10605
   End
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   10360
      Picture         =   "FICALIBRA.frx":17AC
      Top             =   7180
      Width           =   2010
   End
End
Attribute VB_Name = "FICALIBRA"
...
Private Sub COMMAND21_CLICK()
   ...
   Call GRADAFICAL
   '
   RECALIBRA.Label37 = Label37
   RECALIBRA.Label14 = Label14
   RECALIBRA.Label28 = Label28
   RECALIBRA.Label16 = Label16
   '
   For KKI% = 0 To 8
     RECALIBRA.Label2(KKI%) = Label2(KKI%)
   Next KKI%
   '
   RECALIBRA.List2.Clear
   For KKI% = 1 To List2.ListCount
     RECALIBRA.List2.AddItem FICALIBRA.List2.List(KKI% - 1)
   Next KKI%
   '
   RECALIBRA.Label15.Caption = 1 + ULTREG&("RECALIB")
   RECALIBRA.Show 1
   Call CARECALIB
   '
...
Private Sub List1_DblClick()
   ...
   Next KKI%
   '
   RECALIBRA.Label15.Caption = TRIM$(Mid$(List1.TEXT, 75, 8))
   RECALIBRA.Show 1
   Call CARECALIB
   '
End Sub
