...
10  NC% = Val(Label11)
    ...
    CODPARAM$(5) = "TOT-TIEM": DOCPARAM$(5) = HORMINSE$(3600 * Val(Label19))
    CAPARDOC% = 5
    '
    CODTABU1$(1) = "NOP-OPER"
    CODTABU1$(2) = "DES-OPER"
