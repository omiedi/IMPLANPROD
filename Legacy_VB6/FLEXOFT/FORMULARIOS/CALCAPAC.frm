...
Begin VB.Form CALCAPAC 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ListBox List5 
         ...
         EndProperty
         Height          =   1500
         ItemData        =   "CALCAPAC.frx":1374
         Left            =   90
         List            =   "CALCAPAC.frx":1376
         TabIndex        =   21
         Top             =   3150
         Width           =   4080
      End
      ...
      Begin VB.ListBox List4 
         ...
         EndProperty
         Height          =   1500
         ItemData        =   "CALCAPAC.frx":1378
         Left            =   90
         List            =   "CALCAPAC.frx":137A
         TabIndex        =   16
         Top             =   660
         Width           =   4080
      End
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   10370
      Picture         =   "CALCAPAC.frx":2996
      Top             =   7570
      Width           =   2010
   End
End
Attribute VB_Name = "CALCAPAC"
