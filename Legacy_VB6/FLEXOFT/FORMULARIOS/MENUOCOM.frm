...
Begin VB.Form MENUOCOM 
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   720
      Left            =   4830
      Picture         =   "MENUOCOM.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   34
      ToolTipText     =   "Acceso a Ordenes de Compra CERRADAS"
      Top             =   4095
      Width           =   750
   End
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   4230
      Picture         =   "MENUOCOM.frx":2132
      Top             =   6105
      Width           =   2010
   End
End
Attribute VB_Name = "MENUOCOM"
...
Private Sub Command6_Click()
    ...
    Call CONECRUN("ORCOMP03", "Ordenes de Compra Proveedores Externos")
    Command6.Enabled = True
End Sub

Private Sub Command8_Click()
    Command8.Enabled = False
    Call ACCDIR("AUTENTRE")
