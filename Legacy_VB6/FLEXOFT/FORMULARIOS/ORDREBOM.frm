...
Sub GRAOREPA(OKX%)
   ...
   End If
   '
10 ORDREBOM.Label25 = TRIM$(Str$(NPP&))
   '
   ...
   '
   XX$ = REGLEIDO$("PRESREPA", REPRESU&)
   PREUNINE = CVS(Mid$(XX$, 117, 4))
   Label26 = FORMATNUM$(PREUNINE, "F12.2")
   Call REPLA(XX$, MKS$(Val(Label2)), 125, 4)
   Call GRAREG("PRESREPA", XX$, REPRESU&)
   '
   Call REPLA(XX$, MKS$(Val(Label2)), 1, 4)
