...
Begin VB.Form INSTRUCCI 
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   10340
      Picture         =   "INSTRUCCI.frx":1B3A
      Top             =   3800
      Width           =   2010
   End
End
Attribute VB_Name = "INSTRUCCI"
...
Private Sub Command10_Click()
   ...
   End If
   '
   If XVALO(Text7) < 1 Or XVALO(Text7) > 9999 Then
   ...
   hojanu% = XVALO(Text7)
   '
   If XVALO(Text8) < 1 Or XVALO(Text8) > 9999 Then
   ...
   If List1.ListCount > 0 Then
     NACTU% = 1 + XVALO(Mid$(List1.List(List1.ListCount - 1), 97, 6))
   End If
   '
