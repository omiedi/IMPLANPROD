...
Begin VB.Form FORCREDEVDIP 
   ...
   End
End
Attribute VB_Name = "FORCREDEVDIP"
...
Private Sub Command5_Click()
    ...
    FORCREDEVDIP.Label14.Caption = CSTRING$(MKD$(TOPEDIDO#), 3, 11, 2, 2)
    If PIVAFAC% <> 5 Then FORCREDEVDIP.Label18.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVA / 100), 3, 11, 2, 2)
    If RENOIN% = 1 Then
       FORCREDEVDIP.Label23.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVARNI / 100), 3, 11, 2, 2)
       ALITOTA = ALIVA + ALIVARNI
    End If
    FORCREDEVDIP.Label20.Caption = CSTRING$(MKD$(TOPEDIDO# * (1 + ALITOTA / 100)), 3, 11, 2, 2)
    '
End Sub
...
Private Sub Text11_LostFocus()
   NROPRO& = 0
   If Left$(Text11.TEXT, 3) = "NC." Then NROPRO& = Val(Mid$(Text11.TEXT, 4))
   Call NUFACTURA(NROPRO&)
   Text11.TEXT = "NC." + TRIM$(Str$(NROPRO&))
End Sub
