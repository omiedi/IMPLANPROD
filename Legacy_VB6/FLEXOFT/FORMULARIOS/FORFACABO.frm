VERSION 5.00
Begin VB.Form FORFACABO 
   BackColor       =   &H00C0FFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Facturación de Abonos Mensuales - Texto Libre"
   ClientHeight    =   5640
   ClientLeft      =   60
   ClientTop       =   315
   ClientWidth     =   11910
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BOTNEXT 
         ...
         Height          =   1000
         Left            =   10920
         Picture         =   "FORFACABO.frx":0E74
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Aprueba - Registra - Imprime Factura de Abono"
         Top             =   4410
         Width           =   855
      End
...
Private Sub LABEL10_Change()
    ...
    TOPEDIDO# = Val(Label10.Caption)
    If PIVAFAC% <> 5 Then Label18.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVA / 100), 3, 10, 2, 2)
    If RENOIN% = 1 Then
       Label23.Caption = CSTRING$(MKD$(TOPEDIDO# * ALIVARNI / 100), 3, 10, 2, 2)
       ALITOTA = ALIVA + ALIVARNI
    End If
    Label20.Caption = CSTRING$(MKD$(TOPEDIDO# * (1 + ALITOTA / 100)), 3, 10, 2, 2)
    '
End Sub
