    ...
    If AEF$(Index + 1) <> "" Then
       If CLF%(Index + 1) > 0 Then
          If LEF%(Index + 1) > 0 Then
             ...
             End If
             '
             WEDTAB04.FIECO(Index).TEXT = VDEC$
             '
          End If
       End If
    End If
