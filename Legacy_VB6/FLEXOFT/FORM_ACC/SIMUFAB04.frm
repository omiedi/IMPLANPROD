...
Begin VB.Form SIMUFAB04 
   ...
   Begin VB.Frame Frame5 
      BackColor       =   &H00C0E0C0&
      Caption         =   "Necesidad de Componentes"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin VB.ListBox List4 
         ...
         EndProperty
         Height          =   2220
         ItemData        =   "SIMUFAB04.frx":3834
         Left            =   90
         List            =   "SIMUFAB04.frx":3836
         TabIndex        =   15
         Top             =   660
         Width           =   5760
      End
...
DESDEL = CDbl(CVDAT(DES%))
HASTAL = CDbl(CVDAT(HAS%))
'
     ...
     Next JL&
     Screen.MousePointer = 1
     If CLICONPE04.LICOPEN.ListCount > 0 Then
       Descrip$ = "Pedidos Pendientes del " & FECHATEX$(DES%) & " al " & FECHATEX$(HAS%)
       CLICONPE04.Text1 = Descrip$
25     CLICONPE04.Show 1
       Call FRESHALL
       If CLICONPE04.Label2.Caption <> "OK" Then
         Call COMUNI("Cancelado !!!")
         GoTo 9999
       End If
       '
       ' VERIFICA REPETICIÓN DEL NOMBRE DEL PROGRAMA
       Descrip$ = TRIM$(CLICONPE04.Text1)
       If Descrip$ = "" Then
       ...
       Next JL&
       '
       For JL& = 1 To CLICONPE04.LICOPEN.ListCount
         If CLICONPE04.LICOPEN.Selected(JL& - 1) = True Then
           ICLIE1& = Val(Left$(CLICONPE04.LICOPEN.List(JL& - 1), 6))
           If ICLIE1& > 0 Then
