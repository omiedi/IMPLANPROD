...
Private Sub Command14_Click()
    ...
    Call CONECRUN("ORCOMP04", "Gestion de Ordenes de Compra")
...
Private Sub Command35_Click()
    ...
    Call CONECRUN("PROMRP04", "Programacion de Materiales - MRP-II")
