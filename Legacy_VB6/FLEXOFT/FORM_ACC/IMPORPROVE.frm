...
Begin VB.Form IMPROVE 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "IMPORPROVE.frx":0000
         Height          =   3960
         Left            =   105
         OleObjectBlob   =   "IMPORPROVE.frx":0010
         TabIndex        =   9
         Top             =   315
         Width           =   11295
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label9 
         ...
         Caption         =   "\FLGUIDI\TRAIDOS\MIGRACION NUCLEO\Proveedores\"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Sub IMPORPROV()
   ...
   On Error Resume Next
   Proved12.MoveFirst
   CONTAD% = Proved12!Nume_Cli
   While Proved12.EOF = False 'busca el maximo
     Proved12.MoveNext
     If Proved12!Nume_Cli > CONTAD% Then CONTAD% = Proved12!Nume_Cli
   Wend
   On Error GoTo 0
   '
   TEPRUE = ""
   Data1.DatabaseName = ULOI$ + Label9 + Label1
   Data1.RecordSource = "'Datos Acreedores'$"
   Data1.Refresh
   On Error Resume Next
   ...
   For U& = 1 To URECORD&
     ...
     DBGrid1.Row = U& - 1
     '
     DBGrid1.Col = 0                    'CODIGO (TEXT)
     codtext$ = TRIM$(DBGrid1.TEXT)
     If NUMEPRO(codtext$) > 0 Then GoTo 19
     '
     DBGrid1.Col = 2                    'RAZON SOCIAL
     RASOCL$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 3
     FANTAS$ = TRIM$(DBGrid1.TEXT)      'NOMBRE FANTASIA
     '
     DBGrid1.Col = 4
     DIRECCI$ = TRIM$(DBGrid1.TEXT)     'DOMICILIO
     '
     DBGrid1.Col = 5                    'LOCALIDAD
     LOCALI$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 6                    'CODPROV
     PROVI$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 7                    'PAIS
     PAIS$ = TRIM$(DBGrid1.TEXT)
     If PAIS$ = "ARG" Then PAISOK$ = "ARGENTINA"
     If PAIS$ = "BRA" Then PAISOK$ = "BRASIL"
     If PAIS$ = "EUA" Then PAISOK$ = "ESTADOS UNIDOS"
     If PAIS$ = "REI" Then PAISOK$ = "REI"
     If PAIS$ = "" Then PAISOK$ = ""
     '
     DBGrid1.Col = 8                    'COD POSTAL
     CPOSTA$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 9                    'TELEFONO
     TELEF$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 10                   'SEGUNDO TELEFONO
     If DBGrid1.TEXT = "" Then
       TELEF2$ = "-"
     Else
       TELEF2$ = TRIM$(DBGrid1.TEXT)
     End If
     '
     DBGrid1.Col = 11
     FAXPROV$ = TRIM$(DBGrid1.TEXT)     'FAX
     '
     DBGrid1.Col = 14
     CUITPRO$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 16                   'IMP INGRESOS BRUTOS
     INGBRU$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 19                   'MAIL
     MAILPRO$ = TRIM$(DBGrid1.TEXT)
     '
     DBGrid1.Col = 26                   'POSICION DE IVA
     PIVA$ = TRIM$(DBGrid1.TEXT)
     If PIVA$ = "EXENT" Then PIVAOK% = 4
     If PIVA$ = "INSCR" Then PIVAOK% = 1
     If PIVA$ = "FINAL" Then PIVAOK% = 0
     If PIVA$ = "EXPOR" Or PIVA$ = "IMPOR" Then PIVAOK% = 5
     If PIVA$ = "NOINS" Then PIVAOK% = 2
     If PIVA$ = "MONOT" Then PIVAOK% = 6
     If PIVA$ = "NI075" Then PIVAOK% = 2
     If PIVA$ = "NI100" Then PIVAOK% = 2
     If PIVA$ = "INARE" Then PIVAOK% = 1
     If PIVA$ = "IN150" Then PIVAOK% = 1
     If PIVA$ = "IN100" Then PIVAOK% = 1
     If PIVA$ = "IN075" Then PIVAOK% = 1
     If PIVA$ = "" Then PIVAOK% = 0
     '
     DBGrid1.Col = 26                   'POSICION DEL IVA TEXTO
     If DBGrid1.TEXT = "" Then
       PIVATXT$ = "-"
     Else
       PIVATXT$ = TRIM$(DBGrid1.TEXT)
     End If
     '
     DBGrid1.Col = 27
     If DBGrid1.TEXT = "" Then
       CRET$ = "-"
     Else
       CRET$ = TRIM$(DBGrid1.TEXT)         'RETENCION CAMPO AGREGADO
     End If
     '
     On Error GoTo 0
     With Proved12
       ...
       !Nume_Cli = CONTAD%                  'CODIGO ENTERO
       !Codi_Cli = codtext$                 'CODIGO TEXT
       !Tcpr_Cli = 0                        'TIPO CTA
       !Raso_Cli = RASOCL$                  'RAZON SOCIAL
       !Fant_Cli = FANTAS$                  'FANTASIA
       !Domi_Cli = DIRECCI$                 'DIRECCION
       !Loca_Cli = LOCALI$                  'LOCALIDAD
       !Prov_Cli = PROVI$                   'COD PROVINCIA
       !Pais_Cli = PAISOK$                  'PAIS VALIDADO
       !Cpos_Cli = CPOSTA$                  'CODIGO POSTAL
       !Tele_Cli = TELEF$                   'TELEFONO
       !Tele2_Cli = TELEF2$                 '2º TELEFONO
       !Faxi_Cli = FAXPROV$                 'FAX
       !Cuit_Cli = CUITPRO$                 'CUIT SIN VALIDAR
       !Cpag_Cli = 0                        'POR DEFAULT (XQ' NO SE JUSTIFICAN 60/900)
       !Nibr_Cli = INGBRU$                  'IMP BRUTOS
       !Mail_Cli = MAILPRO$                 'MAIL
       !Piva_Cli = PIVAOK%                  'POS IVA
