VERSION 5.00
Begin VB.Form CLICEN04 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0FFE0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Presupuestación - Licencias Módulos Preconfigurados"
   ClientHeight    =   6720
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11100
   Icon            =   "CLICEN04.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List1 
         ...
         ItemData        =   "CLICEN04.frx":36B8
         Left            =   -30
         List            =   "CLICEN04.frx":36BA
         TabIndex        =   47
         Top             =   360
         Width           =   9820
      End
   ...
   Begin VB.Label Label19 
      ...
      BackColor       =   &H00FFFF80&
      BackStyle       =   0  'Transparent
      Caption         =   "Subtot.Licencias Basicas:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label Label8 
      ...
      BackColor       =   &H00FFFF80&
      BackStyle       =   0  'Transparent
      Caption         =   "Total Licencias (1 Puesto):"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Private Sub Form_Load()
  ...
  'LEO LA LISTA DE PRECIOS DE EQUIPOS
  Text21 = CONTROL("LIPREVEN", "EQUIPO")
  '
End Sub
'
...
10    NUPRESU$ = TRIM$(Label31)
    ...
    ATRI$ = ATRI$ + "/TITUPAN=Detalle de Cotización - Licencias/"
    ATRI$ = ATRI$ + "/BORDEIZQ=W" + TRIM$(Str$(Left + Picture2.Left))
    ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(Str$(Top + Picture2.Top))
14  VTB% = VENTABU%(PRF$ + ATRI$)
    If VTB% >= 0 Then
    'BORRA LOS REGISTROS
      With DetaPresu
20      .FindFirst "Nro_PRESU = '" & NUPRESU$ & "' AND rubro_det = 1 "
      ...
      For KKIL& = 1 To J&
         ...
         If ITE% <= 0 Then GoTo 7
          For kiu% = 1 To Len(VECIT$) Step 2
            If CVI(Mid$(VECIT$, kiu%, 2)) = ITE% Then
              Call MENSERR(24, "Codigo '" + TRIM$(CODEXT$(ITE%)) + "' Repetido.")
              GoTo 14
            End If
          Next kiu%
          VECIT$ = VECIT$ + MKI$(ITE%)
         ...
         '
          With DetaPresu
           ...
           Text13 = FORMATNUM(TOTPIS1#, "F12.2")
           Text38 = FORMATNUM(TOTPIS2#, "F12.2")
7         Next KKIL&
     End If
    End If
  End If
