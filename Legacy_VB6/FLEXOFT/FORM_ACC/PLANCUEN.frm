...
25   Z4$ = REGBLAN$("CUECON")
   ...
   '
   KK1% = COPYFILE%(LUDAT$ + "CUENTAS.DAT", LUDAT$ + "CUENTAS.OLD")
   KK2% = COPYFILE%(LUDAT$ + "DENOCUE.DAT", LUDAT$ + "DENOCUE.OLD")
   KK3% = COPYFILE%(LUDAT$ + "INVECUE.DAT", LUDAT$ + "INVECUE.OLD")
   KK4% = COPYFILE%(LUDAT$ + "PLAGRAL.DAT", LUDAT$ + "PLAGRAL.OLD")
   '
   Screen.MousePointer = 1
   '
End Sub
