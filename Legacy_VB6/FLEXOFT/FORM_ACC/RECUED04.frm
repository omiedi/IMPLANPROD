...
Begin VB.Form RECUED04 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   640
         Left            =   105
         Picture         =   "RECUED04.frx":0454
         Style           =   1  'Graphical
         TabIndex        =   40
         ToolTipText     =   "Anotador de Novedades de Clientes"
         Top             =   6090
         Width           =   650
      End
...
10  Screen.MousePointer = 1
    RECUCLI04.Text10.TEXT = TRIM$(Str$(NCMIN%))
    RECUCLI04.Text9.TEXT = RASOCLI$(NCMIN%)
    RECUCLI04.Text8.TEXT = TRIM$(Str$(NCMAX%))
    RECUCLI04.Text7.TEXT = RASOCLI$(NCMAX%)
    '
    HOO% = HOY(HO$)
    RECUCLI04.Text6.TEXT = "01" + Mid$(HO$, 3)
    RECUCLI04.Text5.TEXT = HO$
    '
    RECUCLI04.Show 1
    '
End Sub
...
Sub CARESCUE()
    ...
    If NC% > 0 Then
        ...
        Label26 = CODICLI$(NC%)
        Text10.TEXT = CSTRING$(MKD$(SALDCLI#(NC%)), 4, 11, 2, 2)
        Text11.TEXT = CSTRING$(MKS$(LIMICRE(NC%)), 4, 11, 2, 2)
        Refresh
        Text6.TEXT = CSTRING$(MKD$(CHEPEACRE#(NC%)), 4, 11, 2, 2)
        DISPONI = Val(Text11.TEXT) - Val(Text10.TEXT) - Val(Text6.TEXT)
...
20              If TRIM$(SALTEX$) <> "" Then
    ...
    If Abs(SARRAS# - SALDCLI#(NC%)) >= 0.005 Then
        ...
        Text10.TEXT = CSTRING$(MKD$(SARRAS#), 4, 11, 2, 2)
        Refresh
    End If
    Screen.MousePointer = 1
    '
    ...
    If Left$(App.EXEName, 7) = "AMACLI0" Then
      ...
      Else
         If List1.ListCount > 0 Then
           SUMARRAS# = Val(Mid$(List1.List(List1.ListCount - 1), 63, 14))
         End If
         SUMADEUP# = Val(Label5.Caption)
