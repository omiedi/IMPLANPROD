...
Begin VB.Form FICALIB04 
   ...
   Begin VB.ListBox List1 
      ...
      EndProperty
      Height          =   1860
      ItemData        =   "FICALIB04.frx":36CA
      Left            =   210
      List            =   "FICALIB04.frx":36CC
      TabIndex        =   33
      Top             =   4200
      Width           =   10605
   End
...
Private Sub COMMAND21_CLICK()
   ...
   Call GRADAFICAL
   '
   RECALIB04.Label37 = Label37
   RECALIB04.Label14 = Label14
   RECALIB04.Label28 = Label28
   RECALIB04.Label16 = Label16
   '
   For KKI% = 0 To 8
     RECALIB04.Label2(KKI%) = Label2(KKI%)
   Next KKI%
   '
   RECALIB04.List2.Clear
   For KKI% = 1 To List2.ListCount
     RECALIB04.List2.AddItem FICALIBRA.List2.List(KKI% - 1)
   Next KKI%
   '
   RECALIB04.Label15.Caption = 1 + ULTREG&("RECALIB")
   RECALIB04.Show 1
   Call CARECALIB
   '
...
Private Sub List1_DblClick()
   ...
   Next KKI%
   '
   RECALIB04.Label15.Caption = TRIM$(Mid$(List1.TEXT, 75, 8))
   RECALIB04.Show 1
   Call CARECALIB
   '
End Sub
