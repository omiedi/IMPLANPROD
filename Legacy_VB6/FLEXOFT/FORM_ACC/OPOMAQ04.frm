VERSION 5.00
Begin VB.Form OPOMAQ04 
   BackColor       =   &H00C0E0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Orden de Mantenimiento - Configuración"
   ClientHeight    =   2610
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   6285
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00C0E0FF&
      Caption         =   "Orden de Mantenimiento"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   510
      Left            =   5040
      Picture         =   "OPOMAQ04.frx":2AD4
      Top             =   6950
      Width           =   2010
   End
End
Attribute VB_Name = "OPOMAQ04"
...
Private Sub Command2_Click()
    ...
    Call GRACONTROL("", "CODORMAN", CMO$)
    '
    Call GRACONTROL("", "FORMOMAN", Text4.TEXT)
    '
    Call CIERRARCH("*.*")
    Hide
    '
