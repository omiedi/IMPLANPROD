...
Begin VB.Form IMPORCCORRVEN 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ListBox List1 
         ...
         ItemData        =   "IMPORCCORRVEN.frx":0000
         Left            =   120
         List            =   "IMPORCCORRVEN.frx":0002
         TabIndex        =   31
         Top             =   2910
         Width           =   10400
      End
      Begin VB.CommandButton Command3 
         ...
         Height          =   750
         Left            =   10650
         Picture         =   "IMPORCCORRVEN.frx":0004
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   735
         Left            =   10680
         Picture         =   "IMPORCCORRVEN.frx":030E
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.ListBox List4 
            ...
            Height          =   1700
            IntegralHeight  =   0   'False
            ItemData        =   "IMPORCCORRVEN.frx":0618
            Left            =   0
            List            =   "IMPORCCORRVEN.frx":061A
            TabIndex        =   20
            Top             =   250
            Width           =   40000
         End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "IMPORCCORRVEN.frx":061C
         Height          =   3750
         Left            =   150
         OleObjectBlob   =   "IMPORCCORRVEN.frx":062C
         TabIndex        =   17
         Top             =   360
         Width           =   11295
      End
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   750
      Left            =   11040
      Picture         =   "IMPORCCORRVEN.frx":0FDE
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   750
      Left            =   11025
      Picture         =   "IMPORCCORRVEN.frx":12E8
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "IMPORCCORRVEN"
...
Private Sub Option1_Click(Index As Integer)
   ...
   Case 0
     ...
     List2.AddItem " 11  Stock Actual               Num      +/- 999999"
     Label8 = "Código           C-Int  Descripcion                                                         TM  UM        St.Min     Lote Ec  Costo Unit  MC  Fecha       Pr-H     Stock"
   Case 1
   ...
   Case 6
     ...
     Label8 = "Cta.  Razón Social                                    Domicilio                                       C.Postal    Localidad                       " + _
     "Teléfono                Fax                     Contacto                CUIT            T.   Cod.Cta.    Pr. IVA    " '"Teléfono                Fax                     Contacto                CUIT            Tipo Codigo Cta.
     '\\\OT-05-0202-WAR-FIN///
   Case 7
...
12   Call REPLA(TTXX$, CODEX$, 1, 5)
     ...
     VENDE$ = FORMATNUM$(Val(TRIM$(DBGrid1.TEXT)), "I4")
     ...
     CIVA$ = FORMATNUM$(Val(TRIM$(DBGrid1.TEXT)), "I4")
     Call REPLA(TTXX$, CIVA$, 261, 4)
     '
     DBGrid1.Col = 14                    ' CONDICION DE PAGO
     COPA$ = FORMATNUM$(Val(TRIM$(DBGrid1.TEXT)), "I4")
...
Sub PREIMPORPRO()
   ...
   For U& = 1 To URECORD&
     ...
     '
     DBGrid1.Col = 0
     NUPROV = Val(TRIM$(DBGrid1.TEXT))   ' NUMERO DE CUENTA
...
30   CoComCor$ = TRIM$(Mid$(TTXX$, 95, 12))
     ...
     CodiEmp% = 0
     CodiSuc% = 0
     NumeClie% = Val(Mid$(TTXX$, 13, 6))
     NumeProv% = 0
     FechEmi = CVDAT(FECHANUM(Mid$(TTXX$, 53, 8)))
       NC% = Val(Mid$(TTXX$, 13, 6))
     Referen$ = RASOCLI$(NC%)
     ...
     TiMovi$ = "FVEN"
       ...
       '
     OpMovi$ = OPMOVIX$
     VaMovi$ = Mid$(TTXX$, 98, 1)
     Descrip$ = CoComLar$
     NumeTal = Val(Mid$(CoComLar$, 5, 4))
     NumeCom = Val(Mid$(CoComLar$, 11))
     StatInit = 0
     ImpoDeb = Val(Mid$(TTXX$, 107, 12))
     Observa$ = RASOCLI$(NC%)
     Call GRACABAN
     '
     IBruTot# = Val(Mid$(TTXX$, 107, 12))
     IIvaTot# = 0
     NuorVen% = 0
     FeVenc = CVDAT(FECHANUM(Mid$(TTXX$, 63, 8)))
     ImVenc# = Val(Mid$(TTXX$, 119, 12))
     Call GRADEUPEN
     '
   Next U&
   '
...
Sub IMPORCLI()
   ...
   For U& = 1 To FIN&
     ...
     CPOST% = 0: If Val(CPOSTX$) < 32767 Then CPOST% = Val(CPOSTX$)
     ...
     GRUCLI% = Val(Mid$(TTXX$, 235, 4))
     CODICUEN$ = Mid$(TTXX$, 241, 12)
     '\\\OT-05-0192-WAR-18/04/05///
     PIVA% = Val(Mid$(TTXX$, 261, 4))
     CONDI% = Val(Mid$(TTXX$, 253, 4))
     PROVI$ = TRIM$(Mid$(TTXX$, 259, 2))
     LIPRE% = 0
     COVEN% = Val(Mid$(TTXX$, 265, 4))
     LICRE = Val(Mid$(TTXX$, 269, 12))
     CUEMA% = 0
...
Sub IMPORPRO()
   ...
   For U& = 1 To FIN&
     ...
     NCI% = Val(Mid$(TTXX$, 1, 5))
     If NCI% < 1 Then GoTo 19
     If Asc(Mid$(PUNUPRO$, NCI%, 1)) > 0 Then GoTo 19
     '
     RASO$ = Mid$(TTXX$, 7, 48)
     DOMI$ = Mid$(TTXX$, 55, 48)
     CPOSTX$ = Mid$(TTXX$, 103, 12)
     ...
     CUIT$ = TRIM$(Mid$(TTXX$, 219, 16))
       If CUIT$ <> "" Then VCC% = VALICUIT%(CUIT$)
     TIPOCTA% = Val(Mid$(TTXX$, 235, 4))
     CODICUEN$ = Mid$(TTXX$, 240, 12)
     CODIPROVI1$ = Mid$(TTXX$, 253, 2)
     CODIVA1% = Val(Mid$(TTXX$, 255, 4))
     'PIVA% = 1
     IBRU$ = ""
     CONDI% = 0
     LIPRE% = 0
