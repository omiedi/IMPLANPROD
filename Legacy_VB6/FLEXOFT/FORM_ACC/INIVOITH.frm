...
Begin VB.Form INIVOITH 
   ...
   Begin VB.CommandButton Command13 
      ...
      Height          =   600
      Left            =   8295
      Picture         =   "INIVOITH.frx":2648
      Style           =   1  'Graphical
      TabIndex        =   24
      ToolTipText     =   "Ordenes de Trabajo"
      Top             =   4515
      Width           =   600
   End
...
Private Sub Command13_Click()
   ...
   Call CONECRUN("ORTRAB04", "Ordenes de Trabajo")
...
Private Sub Command31_Click()
   ...
   Call CONECRUN("CONMOD04", "Control de Mano de Obra")
...
Private Sub Command9_Click()
   ...
   Call CONECRUN("PRESUP04", "Gestión de Presupuestos a Clientes")
...
Private Sub ped_clientes_Click()
  Call CONECRUN("PEDIDO04", "Pedido de Clientes")
End Sub
...
Private Sub Res_cuenta_Click()
  'ESTO LO COMENTE XQ EL COMMAND15 DEL GESVAL04
  'ESTA OCULTO... WAR 30/03/05
'  GESVAL04.Option5.Value = True ' opcion impresora
'  Call GESVAL04.Command17_Click ' Ejecuta la consulta
...
Private Sub Subdia_CajaBan_Click()
  ...
  'ESTA OCULTO... WAR 30/03/05
  'GESVAL04.Option4.Value = True ' opcion impresora
  'Call GESVAL04.Command15_Click ' Ejecuta la consulta
End Sub
