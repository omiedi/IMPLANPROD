...
Sub Command13_Click()
   ...
   If DERACCE%("MODIORMA", "Modifica Orden de Mantenimiento") < 1 Then GoTo 99
...
End Sub
 ...
 Sub Command14_Click()
   ...
   '
   If DERACCE%("ANUORMA", "Anulacion de Orden de Mantenimiento") < 1 Then GoTo 99
   '
...
End Sub
 ...
 '
   ...
   '
   If DERACCE%("CIEORMA", "Cierre Orden de Mantenimiento") < 1 Then GoTo 99
