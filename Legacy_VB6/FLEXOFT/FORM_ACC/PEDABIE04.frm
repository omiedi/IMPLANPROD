...
Private Sub Form_Load()
    ...
    If CONTROL("NEWASPEC", "CAMBIOAS") = "SI" Then
      ...
      Me.Label21(0).BackColor = &HFCD7B6
      Me.Label21(1).BackColor = &HFCD7B6
    End If
