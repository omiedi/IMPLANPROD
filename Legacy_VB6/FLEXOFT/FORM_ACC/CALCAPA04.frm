...
Begin VB.Form CALCAPA04 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ListBox List5 
         ...
         EndProperty
         Height          =   1500
         ItemData        =   "CALCAPA04.frx":36EA
         Left            =   90
         List            =   "CALCAPA04.frx":36EC
         TabIndex        =   20
         Top             =   3150
         Width           =   4080
      End
      ...
      Begin VB.ListBox List4 
         ...
         EndProperty
         Height          =   1500
         ItemData        =   "CALCAPA04.frx":36EE
         Left            =   90
         List            =   "CALCAPA04.frx":36F0
         TabIndex        =   15
         Top             =   660
         Width           =   4080
      End
           ...
           With SecopTemp
             ...
             Do Until .EOF = True
               If IsNull(!AltOper) = True Or !AltOper < 1 Then
                 ...
                 EQUIPO$ = AJUSTI$(!CodMaq0, 6)
                 EQUIP1$ = AJUSTI$(!CodMaq1, 6)
                 EQUIP2$ = AJUSTI$(!CodMaq2, 6)
                 EQUIP3$ = AJUSTI$(!CodMaq3, 6)
                 '
