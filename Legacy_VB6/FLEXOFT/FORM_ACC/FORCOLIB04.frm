...
98  OcomEnca.Close
    OcomDeta.Close
    'SE VUELVE A ABRIR PORQUE EN OTROS LUGARES SE UTILIZA ASUMIENDO QUE YA ESTA ABIERTO EL RECORDSET
    Call APERBASDAT("COMPRAS")
    Screen.MousePointer = 1
