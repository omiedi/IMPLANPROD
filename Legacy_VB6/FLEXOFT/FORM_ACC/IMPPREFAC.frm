...
Begin VB.Form IMPREFAC 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Procesos de Re-Importacion "
   ClientHeight    =   7125
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11910
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "IMPPREFAC.frx":0000
         Height          =   4380
         Left            =   105
         OleObjectBlob   =   "IMPPREFAC.frx":0010
         TabIndex        =   9
         Top             =   315
         Width           =   11295
      End
