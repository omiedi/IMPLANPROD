...
Private Sub Command8_Click()
    ...
    End If
    '
    RESUMENCO04.MESAN.TEXT = MESAN.TEXT
    RESUMENCO04.Text4(0).TEXT = Text4(0).TEXT
    RESUMENCO04.Text4(1).TEXT = Text4(1).TEXT
    Command8.Enabled = True
    RESUMENCO04.Show 1
End Sub
...
Private Sub IMPOGRA_Change(Index As Integer)
   If Index > 0 Then
      VALOR# = 0
      For KKI% = 1 To 8
         VALOR# = VALOR# + Val(IMPOGRA(KKI%).Caption)
      Next KKI%
      IMPOGRA(0).Caption = TRIM$(CSTRING$(MKD$(VALOR#), 4, 12, 2, 2))
      If Abs(Val(IMPOGRA(Index).Caption)) > 0.005 Then
         TASARE = 100 * Val(IMPOIVA(Index).Caption) / Val(IMPOGRA(Index).Caption)
         TAREAL(Index).Caption = TRIM$(CSTRING$(MKS$(TASARE), 4, 12, 2, 2))
         TAREAL(Index).Refresh
      End If
     Else
      Call CALTOTA
   End If
...
Private Sub IMPOIVA_Change(Index As Integer)
   If Index > 0 Then
      VALOR# = 0
      For KKI% = 1 To 8
         VALOR# = VALOR# + Val(IMPOIVA(KKI%).Caption)
      Next KKI%
      IMPOIVA(0).Caption = TRIM$(CSTRING$(MKD$(VALOR#), 4, 12, 2, 2))
      If Abs(Val(IMPOGRA(Index).Caption)) > 0.005 Then
         TASARE = 100 * Val(IMPOIVA(Index).Caption) / Val(IMPOGRA(Index).Caption)
         TAREAL(Index).Caption = TRIM$(CSTRING$(MKS$(TASARE), 4, 12, 2, 2))
         TAREAL(Index).Refresh
...
Sub CALTOPER()
   ...
   SUTOPER.Caption = TRIM$(CSTRING$(MKD$(VALOR#), 4, 12, 2, 2))
   SUTOPER.Refresh
End Sub
'
Sub CALTOTA()
   ...
   TOTAGEN.Caption = TRIM$(CSTRING$(MKD$(VALOR#), 4, 12, 2, 2))
   TOTAGEN.Refresh
End Sub
