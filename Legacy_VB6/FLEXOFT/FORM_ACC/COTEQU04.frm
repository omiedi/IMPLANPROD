VERSION 5.00
Begin VB.Form COTEQU04 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00E0FFE0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Presupuestación - Cotización de Equipos"
   ClientHeight    =   7785
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11910
   Icon            =   "COTEQU04.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   4200
         ItemData        =   "COTEQU04.frx":0442
         Left            =   -30
         List            =   "COTEQU04.frx":0444
         TabIndex        =   48
         Top             =   360
         Width           =   10830
      End
...
10    NUPRESU$ = TRIM$(Label31)
    ...
    ATRI$ = ATRI$ + "/TITUPAN=Detalle de Cotización - Equipos/"
    ...
    'BORRA LOS REGISTROS
      With DetaPresu
20      .FindFirst "Nro_PRESU = '" & NUPRESU$ & "' AND rubro_det = 4 "
...
Private Sub text38_change()
  '
  TOTCAM1# = Val(Text38)
  FORPRE04.Label44 = FORMATNUM(TOTCAM1#, "F11.2")
  '
End Sub
