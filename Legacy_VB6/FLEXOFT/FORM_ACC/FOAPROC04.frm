...
Begin VB.Form FOAPROC04 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image2 
         Height          =   390
         Left            =   -315
         Picture         =   "FOAPROC04.frx":0D72
         Top             =   2310
         Width           =   1515
      End
   End
End
Attribute VB_Name = "FOAPROC04"
...
Private Sub Command14VIE_Click()
    Command14.Enabled = False
     '
     If DERACCE%("FOAPOCOM", "Aprobación de Ordenes de Compra") < 2 Then
        Exit Sub
