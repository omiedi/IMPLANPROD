VERSION 5.00
Begin VB.Form COTVAR04 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0F0F0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Presupuestación - Cotización de Varios"
   ClientHeight    =   7305
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11910
   Icon            =   "COTVAR04.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   4200
         ItemData        =   "COTVAR04.frx":0442
         Left            =   -30
         List            =   "COTVAR04.frx":0444
         TabIndex        =   48
         Top             =   360
         Width           =   10830
      End
...
Private Sub Form_Load()
  ...
  'LEO LA LISTA DE PRECIOS DE VARIOS
  TEXT21 = CONTROL("LIPREVEN", "VARIOS")
  '
End Sub
'
...
10    NUPRESU$ = TRIM$(Label31)
    ...
    ATRI$ = ATRI$ + "/TITUPAN=Detalle de Cotización - Varios/"
    ATRI$ = ATRI$ + "/BORDEIZQ=W" + TRIM$(Str$(Left + COTPUE04.Left + 650))
    ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(Str$(Top + COTPUE04.Top + 2250))
    VTB% = VENTABU%(PRF$ + ATRI$)
    If VTB% >= 0 Then
      'BORRA LOS REGISTROS///
      With DetaPresu
20      .FindFirst "Nro_PRESU = '" & NUPRESU$ & "' AND rubro_det = 5 "
...
Private Sub text38_change()
  '
  TOTCAM1# = Val(Text38)
  FORPRE04.Label47 = FORMATNUM(TOTCAM1#, "F11.2")
  '
End Sub
