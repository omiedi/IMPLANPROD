...
Begin VB.Form FSetupAcc 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton Command33 
         ...
         Left            =   3360
         TabIndex        =   40
         ToolTipText     =   "Actualiza el codigo de Empresa - Correr solo para Empresas con Bases Diferentes  (No Compartidas)"
         Top             =   1620
         Width           =   1170
      End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel999 
      ...
      Index           =   0
      Left            =   0
      OleObjectBlob   =   "FSETUPACC.frx":0FE2
      TabIndex        =   36
      Top             =   0
      Visible         =   0   'False
      Width           =   1590
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "FSETUPACC.frx":105C
      Top             =   1200
   End
   Begin VB.Image Image2 
      Height          =   510
      Left            =   4695
      Picture         =   "FSETUPACC.frx":1290
      Top             =   5145
      Width           =   2010
   End
End
Attribute VB_Name = "FSetupAcc"
...
Private Sub Command28_Click()
    ...
    '
    Call ABRECONEXION
5   NRODOC& = XVALO(InputBox("Ingreso numero de documento"))
    '
    If NRODOC& = 0 Then
        Call FRESHECHO("PDOCLST")
        Exit Sub
    End If
    Call ACTUREGISTRO("PDOC_TBL", "IMAGEN", "NUMEDOC='" & CStr(NRODOC&) & "'", "", REGAF&, "NOMESS")
    XX$ = FILTERGETRECORD("PDOCLST", 1, MKS$(NRODOC&))
    Call REPLA(XX$, Space(60), 5, 60)
    Call FILTERPUTRECORD("PDOCLST", 1, MKS$(NRODOC&), XX$)
    Call ACTUREGISTRO("PDOC_TBL", "REFERENCIA", "NUMEDOC=" & CStr(NRODOC&), "", REGAF&, "NOMESS")
    GoTo 5
    '
End Sub
...
'*****************************
   ...
   MARCATEMP.Open FILTSQL$(Condi$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
   ...
   CONSUTEMP.Open FILTSQL$(Condi$), FLEXCONN, adOpenKeyset, adLockPessimistic, adCmdText
