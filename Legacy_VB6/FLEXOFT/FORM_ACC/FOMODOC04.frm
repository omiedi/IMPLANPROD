VERSION 5.00
Begin VB.Form FOMODOC04 
   BackColor       =   &H00C0E0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Modificación de Ordenes de Compra - Proveedores Externos"
   ClientHeight    =   8040
   ClientLeft      =   45
   ClientTop       =   585
   ClientWidth     =   11910
   Icon            =   "FOMODOC04.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8040
...
20 Call GRACOMPRA(OKX%)
   If OKX% > 0 Then
     Call PRICOMPRA
     If RAI$ <> "" Then
       Call FORCOMP04.PRIREGLACOM 'IMPRIME REGLAMENTO DE COMPRA
     End If
     Call BLANFORMU
     Call SETULTREG("!OCOMDETA", 0)
     Call CIERRARCH("*.*")
    ...
    For J& = 1 To ULTREG&("!OCOMDETA")
      ...
      With OcomDeta
        .AddNew
         ...
         !DELIBRE = ""
         If COLTELIB% >= 0 Then
           !DELIBRE = RTrim(REGLEIDO$(ARCHILIB$, J&))
         End If
...
Sub CARLISCO()
   ...
   For U& = 1 To FIN&
     ...
     If FENTRESOL% <> CVI(Mid$(X$, 95, 2)) Then                ' EL 24 DE AGOSTO DE 2007
    ...
    If TRIM$(FORIPRE$) <> "" Then
      ...
      For J& = 1 To FIN&
         ...
         If COLTELIB% > 0 Then
           ...
           While Len(TELIBRE$) > 0
              If Asc(Mid$(TELIBRE$, Len(TELIBRE$), 1)) > 32 Then GoTo 102
              TELIBRE$ = Left$(TELIBRE$, Len(TELIBRE$) - 1)
          Wend
102       If REPLAORI% = 1 Then
             If CODDX$ <> CPROP$ Then
               If RECOPROP% > 0 Then
...
109   Next J&
      '
      If CAITAB1% >= 1024 Then
         Call MENSERR(24, "Exceso de Renglones de Impresion - Suprimidos")
      End If
      '
