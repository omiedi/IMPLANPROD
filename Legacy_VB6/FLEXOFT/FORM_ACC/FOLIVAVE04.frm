VERSION 5.00
Begin VB.Form FOLIVAVE04 
   BackColor       =   &H00FFFFC0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " Configuración Libro IVA Venta"
   ClientHeight    =   1650
   ClientLeft      =   45
   ClientTop       =   600
   ClientWidth     =   6360
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00FFFFC0&
      Caption         =   "Impresión de Libro IVA Venta"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Private Sub Command2_Click()
    ...
    Call GRACONTROL("FORIPRE", "LIVAVEN", Text4.TEXT)
    Call CIERRARCH("*.*")
    Hide
    '\\\OT-06-0558-RG-FIN///     '
End Sub
...
Private Sub Form_Load()
    '\\\OT-06-0558-RG-21/12/06///
    Text4.TEXT = CONTROL$("FORIPRE", "LIVAVEN")
