...
20 Call GRACOMPRA(OKX%)
   If OKX% > 0 Then
     Call PRICOMPRA
     If RAI$ <> "" Then
       Call FOROCAB04.PRIREGLACOM 'IMPRIME REGLAMENTO DE COMPRA
     End If
     Call BLANFORMU
     Call SETULTREG("!OCOMDETA", 0)
     Call CIERRARCH("*.*")
...
Sub CALTOCOM()
   ...
   For J& = 1 To ULTREG&("!OCOMDETA")
       ...
       If CANTU < 0.005 And CANSTXX < 0.05 Then GoTo 30
...
Call LISOCAB04.Command20_Click
End Sub

Private Sub UcoPro_Click()
Call LISOCAB04.Command12_Click
End Sub
