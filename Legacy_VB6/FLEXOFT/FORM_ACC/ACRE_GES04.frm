...
Begin VB.Form ACRE_GES04 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0D0F0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "A-B-M-L Base de Datos de Acreedores y Cuentas de Gastos"
   ClientHeight    =   8040
   ClientLeft      =   45
   ClientTop       =   585
   ClientWidth     =   11910
   Icon            =   "ACRE_GES04.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "ACRE_GES04.frx":82FC
      ...
      TabPicture(1)   =   "ACRE_GES04.frx":8318
      ...
      TabPicture(2)   =   "ACRE_GES04.frx":8334
   ...
   Begin VB.Menu Cons 
      ...
      Begin VB.Menu LidePo 
         ...
         Begin VB.Menu Pantalla3 
            Caption         =   "Pantalla"
         End
         Begin VB.Menu Impresora3 
            Caption         =   "Impresora"
         End
      End
...
OPMASPR04.Option1(6).Value = True
...
Private Sub Form_Load()
    ...
    If CONTROL("NEWASPEC", "CAMBIOAS") = "SI" Then
      ...
      Option1.BackColor = &HFCD7B6
      Option2.BackColor = &HFCD7B6
    End If
...
OPMASPR04.Option1(9).Value = True
Call OPMASPR04.Command16_Click
...
Private Sub impresora2_Click()
    AMAPRLIS04.Option2.Value = True
    AMAPRLIS04.Command8_Click

End Sub

Private Sub Impresora3_Click()
    AMAPRLIS04.Option2.Value = True
    AMAPRLIS04.Command4_Click

End Sub

Private Sub Impresora5_Click()
    AMAPRLIS04.Option2.Value = True
    AMAPRLIS04.Command2_Click

End Sub

Private Sub Impresora6_Click()
    AMAPRLIS04.Option2.Value = True
    AMAPRLIS04.Command3_Click
...
'Call AMAPRLIS04.Command8_Click
End Sub
...
Private Sub Pantalla2_Click()
    AMAPRLIS04.Option1(0).Value = True
    AMAPRLIS04.Command8_Click
    
End Sub


Private Sub Pantalla3_Click()
    AMAPRLIS04.Option1(0).Value = True
    AMAPRLIS04.Command4_Click
...
OPMASPR04.Option1(5).Value = True
Call OPMASPR04.Command16_Click
...
20    CLIENTECO.Close
      ...
      Call SETULTREG("INDIPROV", JJ&)
      Call SETULTREG("ACREDOR", J1&)
      Call CIERRARCH("ACREDOR")
      Call SETULTREG("INDIACRE", J1&)
