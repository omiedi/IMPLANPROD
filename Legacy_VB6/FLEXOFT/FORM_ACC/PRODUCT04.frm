...
20      JJ& = 0: SUVADIF = 0
    ...
    SQLX$ = SQLX$ + " WHERE cdbl(FeHorLib)>= " & DES1# & " "
    SQLX$ = SQLX$ + " AND INT(CDBL(FeHorLib))<= " & HAS1# & " "
    Call ABREORFAB
