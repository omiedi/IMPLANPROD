VERSION 5.00
Begin VB.Form COTACC04 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00D0E0D0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Presupuestación - Cotización de Accesorios"
   ClientHeight    =   7395
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   11910
   Icon            =   "COTACC04.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   4200
         ItemData        =   "COTACC04.frx":0442
         Left            =   -30
         List            =   "COTACC04.frx":0444
         TabIndex        =   48
         Top             =   360
         Width           =   10830
      End
...
10    NUPRESU$ = TRIM$(Label31)
    ...
    ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(Str$(Top + Picture2.Top + 80))
    VTB% = VENTABU%(PRF$ + ATRI$)
    If VTB% >= 0 Then
      'BORRA LOS REGISTROS///
      With DetaPresu
20      .FindFirst "Nro_PRESU = '" & NUPRESU$ & "' AND RUBRO_DET = 3 "
...
Private Sub text38_change()
  '
  TOTCAM1# = Val(Text38)
  FORPRE04.Label43 = FORMATNUM(TOTCAM1#, "F11.2")
  '
End Sub
