...
Begin VB.Form CVARS04 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.ListBox List1 
         ...
         EndProperty
         Height          =   4200
         ItemData        =   "CVARS04.frx":0442
         Left            =   -30
         List            =   "CVARS04.frx":0444
         TabIndex        =   48
         Top             =   360
         Width           =   10830
      End
...
10    NUPRESU$ = TRIM$(Label31)
    ...
    ATRI$ = ATRI$ + "/BORDEIZQ=W" + TRIM$(Str$(Left + 650))
    ATRI$ = ATRI$ + "/BORDESUP=W" + TRIM$(Str$(Top + 2250))
...
Private Sub text38_change()
  '
  TOTCAM1# = Val(Text38)
  REPRFLEX04.Label47 = FORMATNUM(TOTCAM1#, "F11.2")
  '
End Sub
