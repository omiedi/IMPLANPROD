...
Sub CARDATFORM()
     ...
     TIFORMED% = 2
     For II% = 0 To 31
       WEDTAB04.FILABEL(II%).Visible = False
       WEDTAB04.FIENTRA(II%).Visible = False
       WEDTAB04.FIECO(II%).Visible = False
       WEDTAB04.FIBOTSE(II%).Visible = False
       WEDTAB04.LINVER(II%).Visible = False
       If II% > 0 Then
         WEDTAB04.FILABEL(II%).AutoSize = WEDTAB04.FILABEL(0).AutoSize
         WEDTAB04.FILABEL(II%).Alignment = WEDTAB04.FILABEL(0).Alignment
         WEDTAB04.FILABEL(II%).Font = WEDTAB04.FILABEL(0).Font
         WEDTAB04.FILABEL(II%).FontName = WEDTAB04.FILABEL(0).FontName
         WEDTAB04.FILABEL(II%).FontSize = WEDTAB04.FILABEL(0).FontSize
         WEDTAB04.FILABEL(II%).FontBold = WEDTAB04.FILABEL(0).FontBold
       End If
     Next II%
     '
5800 GRABACT% = 0
...
5804 BLP% = Asc(Mid$(COD$, 4))
     VIV% = Asc(Mid$(COD$, 5))
     APQ% = Asc(Mid$(COD$, 6))
        WEDTAB04.BOTAGRE.Enabled = True
        If APQ% < 1 Then
            WEDTAB04.BOTAGRE.Enabled = False
        End If
     IDL% = Asc(Mid$(COD$, 7))
        WEDTAB04.BOTINSE.Enabled = True
        WEDTAB04.BOTERASE.Enabled = True
        If IDL% < 1 Then
            WEDTAB04.BOTINSE.Enabled = False
            WEDTAB04.BOTERASE.Enabled = False
        End If
     WEDTAB04.BOTEDIT.Enabled = False
     HDR& = Asc(Mid$(COD$, 8))
     RFT% = Asc(Mid$(COD$, 9))
...
'
HREN% = WEDTAB04.ScaleHeight / 25
WEDTAB04.Caption = TRIM$(S1$)
'
EPAC$ = TRIM$(EMPREAC$)
If EPAC$ <> "" Then
    WEDTAB04.Caption = WEDTAB04.Caption + "  -  " + EPAC$
End If
'
MAIZQ = 0
MAINT = 170
...
For KCL% = 1 To NCL%
      ...
      If Left$(ECL$(KCL%), 1) <> "@" Then
          ...
          ENCA$ = ENCA$ + ENCACO$
          ENCA$ = ENCA$ + " "
          WEDTAB04.TEPRUEBA.Caption = ENCA$
          CALINVE% = CALINVE% + 1
          WEDTAB04.LINVER(CALINVE% - 1).Left = WEDTAB04.TEPRUEBA.Width
        Else
...
ENCA$ = ENCA$ + "   "
WEDTAB04.TEPRUEBA.Caption = ENCA$
WEDTAB04.LITAB.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.FRAMENCA.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.ENCACOL.Caption = ENCA$
WEDTAB04.Picture1.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.ENCACOL.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.FRAMETOT.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.TOTALI.Width = WEDTAB04.TEPRUEBA.Width - 50
WEDTAB04.LITAB.Left = MAIZQ
WEDTAB04.FRAMENCA.Left = MAIZQ
WEDTAB04.ENCACOL.Left = 50
WEDTAB04.FRAMETOT.Left = MAIZQ
WEDTAB04.TOTALI.Left = 50
WEDTAB04.Width = MAIZQ + WEDTAB04.LITAB.Width + MAINT + WEDTAB04.FRAMEBOT1.Width + MADER
COEFH = WEDTAB04.LITAB.Width / Len(ENCA$)
'
For II% = 1 To NFT%
   '
   If TRIM$(ECLF$(II%)) <> "" Then
      CLL% = CLF%(II%) - 2
      WEDTAB04.FILABEL(II% - 1).Caption = ECLF$(II%) + " "
      WEDTAB04.FILABEL(II% - 1).Left = MAIZQ + COEFH * (CLF%(II%) - Len(ECLF$(II%)) - 3)
      WEDTAB04.FILABEL(II% - 1).Top = 150 + (0.5 + (RGFL&(II%) - RGFI%) * 1.5) * WEDTAB04.FIENTRA(II% - 1).Height
      WEDTAB04.FILABEL(II% - 1).Width = COEFH * (2 + Len(ECLF$(II%)))
      WEDTAB04.FILABEL(II% - 1).Visible = True
   End If
   '
   WEDTAB04.FIENTRA(II% - 1).Left = COEFH * (CLF%(II%) - 1)
   WEDTAB04.FIENTRA(II% - 1).Top = 70 + (0.5 + (RGFL&(II%) - RGFI%) * 1.5) * WEDTAB04.FIENTRA(II% - 1).Height
   '
   LCFF% = LCF%(II%)
   WEDTAB04.TEPRU.Font = WEDTAB04.FIENTRA(II% - 1).Font
   WEDTAB04.TEPRU.FontSize = WEDTAB04.FIENTRA(II% - 1).FontSize
   WEDTAB04.TEPRU.FontBold = WEDTAB04.FIENTRA(II% - 1).FontBold
   WEDTAB04.TEPRU.Caption = String$(LCFF%, "M") + "."
   WEDTAB04.FIENTRA(II% - 1).Width = WEDTAB04.TEPRU.Width
   If LCFF% >= 6 Then
        WEDTAB04.FIENTRA(II% - 1).Width = COEFH * (1 + LCFF%)
   End If
   '
   WEDTAB04.FIENTRA(II% - 1).Visible = True
   '
   If TRIM$(AEF$(II%)) <> "" Then
      If LEF%(II%) > 0 Then
         WEDTAB04.FIECO(II% - 1).Left = COEFH * (CEF%(II%) - 1)
         WEDTAB04.FIECO(II% - 1).Top = 70 + (0.5 + (RGFL&(II%) - RGFI%) * 1.5) * WEDTAB04.FIENTRA(II% - 1).Height
         WEDTAB04.FIECO(II% - 1).Width = COEFH * (LEF%(II%) + 1)
         WEDTAB04.FIECO(II% - 1).Visible = True
      End If
   End If
   '
   If TRIM$(AEF$(II%)) <> "" Or TVL%(CFF%(II%)) = 5 Then
      If Left$(UCase$(AEF$(II%)), 4) <> "AUTO" Then
         WEDTAB04.FIBOTSE(II% - 1).Top = WEDTAB04.FIENTRA(II% - 1).Top
         WEDTAB04.FIBOTSE(II% - 1).Height = WEDTAB04.FIENTRA(II% - 1).Height
         WEDTAB04.FIBOTSE(II% - 1).Width = WEDTAB04.FIBOTSE(II% - 1).Height * 0.6
         WEDTAB04.FIBOTSE(II% - 1).Left = WEDTAB04.FIENTRA(II% - 1).Left + WEDTAB04.FIENTRA(II% - 1).Width
         WEDTAB04.FIBOTSE(II% - 1).Visible = True
      End If
   End If
   '          '
Next II%
'
If NFT% > 0 Then
     WEDTAB04.Picture1.Visible = True
     WEDTAB04.FRAMENCA.Top = (2.5 + (RGFS% - RGFI%) * 1.5) * WEDTAB04.FIENTRA(0).Height
   Else
     WEDTAB04.Picture1.Visible = False
     WEDTAB04.FRAMENCA.Top = 0.5 * WEDTAB04.FIENTRA(0).Height
End If
WEDTAB04.FRAMENCA.Height = 2 * WEDTAB04.ENCACOL.Height
WEDTAB04.ENCACOL.Top = (WEDTAB04.FRAMENCA.Height - WEDTAB04.ENCACOL.Height) / 2
WEDTAB04.ENCACOL.Caption = ENCA$
WEDTAB04.LITAB.Top = WEDTAB04.FRAMENCA.Top + WEDTAB04.FRAMENCA.Height
'
WEDTAB04.FRAMETOT.Height = 2.2 * WEDTAB04.TOTALI.Height
WEDTAB04.LITAB.Height = WEDTAB04.Height - 200 - WEDTAB04.LITAB.Top - 0.2 * WEDTAB04.FIENTRA(0).Height - WEDTAB04.FRAMETOT.Height
WEDTAB04.FRAMETOT.Top = WEDTAB04.LITAB.Top + WEDTAB04.LITAB.Height
WEDTAB04.TOTALI.Top = (WEDTAB04.FRAMETOT.Height - WEDTAB04.TOTALI.Height) / 2
WEDTAB04.FRAMETOT.Visible = True
'
WEDTAB04.Picture1.Height = WEDTAB04.FRAMETOT.Top + WEDTAB04.FRAMETOT.Height
'
WEDTAB04.Image3.Top = WEDTAB04.FRAMETOT.Top '- 60
WEDTAB04.Image3.Left = WEDTAB04.FRAMETOT.Width - 370
'
For KKI% = 1 To CALINVE%
  WEDTAB04.LINVER(KKI% - 1).Top = WEDTAB04.FRAMENCA.Top
  WEDTAB04.LINVER(KKI% - 1).Height = WEDTAB04.FRAMETOT.Top - WEDTAB04.FRAMENCA.Top + WEDTAB04.FRAMETOT.Height
  WEDTAB04.LINVER(KKI% - 1).Visible = True
Next KKI%
'
WEDTAB04.Line1.X1 = WEDTAB04.FRAMETOT.Left
WEDTAB04.Line1.X2 = 12000 ' WEDTAB04.FRAMETOT.Left + WEDTAB04.FRAMETOT.Width
WEDTAB04.Line1.Y1 = WEDTAB04.FRAMETOT.Top + WEDTAB04.FRAMETOT.Height
WEDTAB04.Line1.Y2 = WEDTAB04.FRAMETOT.Top + WEDTAB04.FRAMETOT.Height
'
WEDTAB04.Line2.X1 = WEDTAB04.FRAMENCA.Left + WEDTAB04.FRAMENCA.Width
WEDTAB04.Line2.X2 = WEDTAB04.FRAMENCA.Left + WEDTAB04.FRAMENCA.Width
WEDTAB04.Line2.Y1 = 0  ' WEDTAB04.FRAMENCA.Top
WEDTAB04.Line2.Y2 = WEDTAB04.FRAMETOT.Top + WEDTAB04.FRAMETOT.Height
'
WEDTAB04.FRAMEBOT1.Top = WEDTAB04.FIENTRA(0).Height * 0.5
WEDTAB04.FRAMEBOT1.Left = MAIZQ + WEDTAB04.LITAB.Width + MAINT
WEDTAB04.FRAMEBOT2.Top = WEDTAB04.FRAMETOT.Top - 2560
WEDTAB04.FRAMEBOT2.Left = MAIZQ + WEDTAB04.LITAB.Width + MAINT
'
WEDTAB04.MARCOBARRA.Top = WEDTAB04.FRAMEBOT2.Top - 300
WEDTAB04.MARCOBARRA.Left = WEDTAB04.FRAMEBOT2.Left
WEDTAB04.MARCOBARRA.Width = WEDTAB04.FRAMEBOT2.Width
'
WEDTAB04.LITAB.Clear
While WEDTAB04.LITAB.TopIndex <= 0
   WEDTAB04.LITAB.AddItem "   "
   'Call VERISCROLL
   WEDTAB04.LITAB.ListIndex = WEDTAB04.LITAB.ListCount - 1
Wend
CARELI% = WEDTAB04.LITAB.ListCount - 1
' AQUI ESTA BIEN
WEDTAB04.LITAB.Clear
'Call VERISCROLL
'
WEDTAB04.VScroll1.Top = WEDTAB04.LITAB.Top
WEDTAB04.VScroll1.Height = WEDTAB04.LITAB.Height
WEDTAB04.VScroll1.Left = WEDTAB04.LITAB.Left + WEDTAB04.LITAB.Width - WEDTAB04.VScroll1.Width - 20
WEDTAB04.VScroll1.Visible = True
'
WEDTAB04.Refresh
'
End Sub
...
Sub CLEARFORM()
    ...
    Call VERISCROLL
    For FT% = 0 To 31
        WEDTAB04.FIENTRA(FT%).TEXT = ""
        WEDTAB04.FIENTRA(FT%).Enabled = True
    Next FT%
    '
    For K2% = 1 To 32
       TTX#(K2%) = 0
...
Sub ENTRAFIL()
    ...
    If YAFIL% < 1 Then
       ...
       '
       For FT% = 1 To NFT%
          WEDTAB04.FIENTRA(FT% - 1).Visible = True
          WEDTAB04.FIENTRA(FT% - 1).Enabled = True
          ARCHECO$ = UCase$(TRIM$(AEF$(FT%)))
          If ARCHECO$ = "AUTO" Then
             If Val(WEDTAB04.FIENTRA(FT% - 1).TEXT) < 1 Then
                REG& = ULTREG&(ARCHITRA$)
                ...
                WEDTAB04.FIENTRA(FT% - 1).TEXT = TRIM$(Str$(NRO))
             End If
          End If
       Next FT%
       '
       For FT% = 1 To NFT%
          If FT% = 1 Then
            If ATRIBU$ <> "" Then
               WEDTAB04.FIENTRA(0).TEXT = ATRIBU$
               ATRIBU$ = ""
            End If
          End If
          '
          If LKF%(FT%) > 0 Then
             If TRIM$(WEDTAB04.FIENTRA(FT% - 1).TEXT) = "" Then
                 WEDTAB04.FIENTRA(FT% - 1).Enabled = True
                 WEDTAB04.FIENTRA(FT% - 1).SetFocus
                 Exit Sub
             End If
             '
             If TRIM$(WEDTAB04.FIENTRA(FT% - 1).TEXT) = "." Then
       ...
       End If
       '
       If WEDTAB04.LITAB.ListCount > 0 Then
           YAFIL% = 2
           WEDTAB04.LITAB.ListIndex = 0
           '
           If TRIM$(UCase$(PROPRIN$)) = "KARDEX" Then
              If WEDTAB04.LITAB.ListCount > 20 Then
                 WEDTAB04.LITAB.TopIndex = WEDTAB04.LITAB.ListCount - 20
              End If
              WEDTAB04.LITAB.ListIndex = WEDTAB04.LITAB.ListCount - 1
           End If
           '
...
Sub CARLITAB(FINOVA%)
    ...
    FINOVA% = 0
    '
    WEDTAB04.SORTLIST.Clear
    WEDTAB04.LITAB.Visible = False
    WEDTAB04.LITAB.Clear
    Call VERISCROLL
    ...
    If NFT% > 0 Then
       ...
       For FT% = 1 To NFT%
          ...
          If LKF%(FT%) > 0 Then
             FT1% = FT%
             FI$(FT%) = CBIN$(WEDTAB04.FIENTRA(FT% - 1).TEXT, TVL%(CFF%(FT%)), LF%(CFF%(FT%)))
             If TRIM$(AEF$(FT%)) <> "" Then
...
650             '   POSI& = InStr(PINI&, IXT$, ARGU$)
    ...
    For U& = 1 To FIN&
        ...
        If (Timer - TINI) > 1 Then
            WEDTAB04.MARCOBARRA.Visible = True
        End If
        '
        Call TRACE(20, U&, FIN&)
        ...
        If CARESEL& = 1 Then
            For FT% = 1 To NFT%
               If LKF%(FT%) < 1 Then
                  ...
                  WEDTAB04.FIENTRA(FT% - 1).TEXT = TXT$
'                  WEDTAB04.FIENTRA(FT% - 1).Enabled = False
               End If
            Next FT%
...
' SELECCIONAR Y PRESENTAR FILTROS
        ...
        On Error GoTo 980
        If ORDE% = 1 Then
              WEDTAB04.SORTLIST.AddItem SORTAR$ + RELIB$ + "   " + Str$(U&)
            Else
              WEDTAB04.LITAB.AddItem RELIB$ + "   " + Str$(U&)
              'Call VERISCROLL
        End If
        On Error GoTo 0
        '
...
981 On Error GoTo 0
    ...
    '
990 WEDTAB04.LITAB.Visible = False
    If ORDE% = 1 Then
        For K2% = 1 To 32: TXX#(K2%) = 0: Next K2%
        FIN& = WEDTAB04.SORTLIST.ListCount
        For U& = 1 To WEDTAB04.SORTLIST.ListCount
            Call TRACE(1, U&, FIN&)
            WEDTAB04.SORTLIST.ListIndex = U& - 1
            RELIB$ = Mid$(WEDTAB04.SORTLIST.TEXT, 16)
            '
            For K2% = 1 To NCL%
               TTT% = TT%(CFT%(K2%))
               If TTT% > 0 Then
    ...
    '
    WEDTAB04.LITAB.Visible = False
    WEDTAB04.LIREGSEL.Clear
    FIN& = WEDTAB04.LITAB.ListCount
    For U& = 1 To WEDTAB04.LITAB.ListCount
        Call TRACE(1, U&, FIN&)
        WEDTAB04.LITAB.ListIndex = U& - 1
        RELIB$ = Mid$(WEDTAB04.LITAB.TEXT, ATOT% + 3)
        WEDTAB04.LIREGSEL.AddItem RELIB$
        '
        REGPRI& = Val(RELIB$)
    ...
    For K2% = 1 To NCL%
       ...
       End If
    Next K2%
    WEDTAB04.TOTALI.Caption = RELIB$
    '
999 On Error GoTo 0
    WEDTAB04.LITAB.Visible = True
    WEDTAB04.MARCOBARRA.Visible = False
    Screen.MousePointer = 1
    WEDTAB04.TOTALI.Visible = True
    Call VERISCROLL
    MODIFI% = 0
    '
End Sub
...
Sub GRABALI()
    '
    If WEDTAB04.BOTAGRE.Enabled = True Then GoTo 5
    If WEDTAB04.BOTINSE.Enabled = True Then GoTo 5
    If WEDTAB04.BOTERASE.Enabled = True Then GoTo 5
    If WEDTAB04.BOTEDIT.Enabled = True Then GoTo 5
    Exit Sub
    '
5   UU& = 0
    For U& = 1 To WEDTAB04.LITAB.ListCount
        ...
        For FT% = 1 To NFT%
            XXZ$ = WEDTAB04.FIENTRA(FT% - 1).TEXT
        ...
        REGGRA& = 0
        UU& = UU& + 1
        If UU& <= WEDTAB04.LIREGSEL.ListCount Then
            WEDTAB04.LIREGSEL.ListIndex = UU& - 1
            REGGRA& = Val(WEDTAB04.LIREGSEL.TEXT)
        End If
        '
        If REGGRA& < 1 Or REGGRA& > ULTREG&(ARCHITRA$) Then
              Call REGAPP(ARCHITRA$, XXX$)
              REGGRA& = ULTREG&(ARCHITRA$)
              WEDTAB04.LIREGSEL.AddItem TRIM$(Str$(REGGRA&))
            Else
    ...
    Next U&
    '
    For U& = UU& + 1 To WEDTAB04.LIREGSEL.ListCount
        WEDTAB04.LIREGSEL.ListIndex = U& - 1
        REGGRA& = Val(WEDTAB04.LIREGSEL.TEXT)
        If REGGRA& > 0 Then
...
Sub SELECFIL(Index)
    '
    WEDTAB04.FIENTRA(Index).TEXT = TRIM$(WEDTAB04.FIENTRA(Index).TEXT)
    '
    K2% = Index + 1
    If TRIM$(AEF$(K2%)) = "" Then
        Call COMUNI("No Existe Tabla de Selección\para el Campo Elegido")
        WEDTAB04.FIENTRA(Index).Enabled = True
        WEDTAB04.FIENTRA(Index).SetFocus
        Exit Sub
    End If
    '
...
'         End If
     ...
     'WLITAB04.ProgressBar1.Min = 0
     'If FINX& > 0 Then
     '   WLITAB04.ProgressBar1.Max = FINX&
     'End If
     '
     For K1& = HDR& + 1 To FINX&
        '
        'WLITAB04.ProgressBar1.Value = K1&
        ...
        If XXX$ = String$(RECLEN%(ARCHITRA$), "=") Then
            ...
            If K1& < ULTREG&(ARCHITRA$) Then
              ...
              If ARCHISAL$ = "SCREEN" Then
                  PREVIEW.List4.AddItem "   " ' LII$(0)
                  PREVIEW.List4.AddItem LII$(4)
                  PREVIEW.List4.AddItem "   " ' LII$(0)
                  Call INITOTA
                  Call ENCAHOJA1(XXX2$)
                  If TNC% > 0 Then
...
If HAYSUBTO% > 0 Then
  ...
  If ARCHISAL$ = "" Then
     ...
     ElseIf ARCHISAL$ = "SCREEN" Then
       PREVIEW.List4.AddItem RENGLO$
       PREVIEW.List4.AddItem TREN$
       PREVIEW.List4.AddItem "   "
    Else
       Print #ASAL%, RENGLO$
       Print #ASAL%, TREN$
       Print #ASAL%, "   "
    ...
    If TOTALI% > 0 Then
        ...
        If ULTIHOJ% = 0 Then
            If ARCHISAL$ = "" Then
                ...
                If INTERLIX > 0 Then CURRY = CURRY + INTERLIX: Printer.CurrentY = CURRY
              ElseIf ARCHISAL$ = "SCREEN" Then
                PREVIEW.List4.AddItem LII$(0)    ' renglon en blanco
                PREVIEW.List4.AddItem RETRA$
                PREVIEW.List4.AddItem LII$(0)
              Else
        ...
        If ULTIHOJ% = 1 Then
            ...
            If ARCHISAL$ = "" Then
              ...
              ElseIf ARCHISAL$ = "SCREEN" Then
               PREVIEW.List4.AddItem " "
               PREVIEW.List4.AddItem LII$(1)
               PREVIEW.List4.AddItem LII$(0)    ' renglon en blanco
                If CASBT% > 0 Then
                  For SBT% = 1 To CASBT%
                   PREVIEW.List4.AddItem HDRZ$(SBT%)
                  Next SBT%
                 PREVIEW.List4.AddItem LII$(0)
                End If
               PREVIEW.List4.AddItem RETRA$
               PREVIEW.List4.AddItem LII$(0)
               PREVIEW.List4.AddItem LII$(3)
              Else
                Print #ASAL%, " "
                Print #ASAL%, LII$(1)
                Print #ASAL%, LII$(0)    ' renglon en blanco
...
Sub CARDATSOR()
     ...
     WSORTB04.Text1.TEXT = ARCHITRA$
     WSORTB04.Text3.TEXT = TITUARCH$(ARCHITRA$)
     ARCHISAL$ = TRIM$(UCase$(Mid$(YYY$, 65, 8)))
     If ARCHISAL$ <> ARCHITRA$ Then
         Call COPYSTRU(ARCHITRA$, ARCHISAL$)
     End If
     WSORTB04.Text4.TEXT = ARCHISAL$
     WSORTB04.Text2.TEXT = TITUARCH$(ARCHISAL$)
     WSORTB04.Refresh
     '
...
109     Next I%
        ...
        WLITAB04.Text5.TEXT = FUENTESEL
        WLITAB04.Text5.Refresh
        WLITAB04.Text7.TEXT = CSTRING$(MKS$(TAFUESEL), 3, 6, 1, 1)
        WLITAB04.Text7.Refresh
       '
        ...
        End If
         ...
         For U& = 1 To CAENCA%
            If ARCHISAL$ = "" Then
               ...
               ElseIf ARCHISAL$ = "SCREEN" Then
                 If U& > 2 Then
                   PREVIEW.List4.AddItem Space$(OFS%) + HDRZ$(U&)
                 End If
               Else
              ...
              If LEYEN$ <> "" Then
                 If Left$(LEYEN$, 1) <> ":" Then
                    ...
                    If ARCHISAL$ = "" Then
                         ...
                         If INTERLIX > 0 Then CURRY = CURRY + INTERLIX: Printer.CurrentY = CURRY
                       ElseIf ARCHISAL$ = "SCREEN" Then
                         PREVIEW.List4.AddItem Space$(OFS%) + Left$(LEYEN$ + Space$(ATOT%), ATOT%)
                         PREVIEW.List4.AddItem Space$(OFS%) + Left$(SUBRA$ + Space$(ATOT%), ATOT%)
                       Else
                    ...
                    If Len(LEYF$) > 0 Then
                       If ARCHISAL$ = "" Then
                           ...
                           If INTERLIX > 0 Then CURRY = CURRY + INTERLIX: Printer.CurrentY = CURRY
                         ElseIf ARCHISAL$ = "SCREEN" Then
                           PREVIEW.List4.AddItem Space$(OFS%) + Left$(Space$(1 + Len(SUBRA$)) + LEYF$, ATOT%)
                         Else
         ...
         If HDR& > 0 Then
            ...
            For RI% = 1 To HDR&
               If ARCHISAL$ = "" Then
                    ...
                    If INTERLIX > 0 Then CURRY = CURRY + INTERLIX: Printer.CurrentY = CURRY
                  ElseIf ARCHISAL$ = "SCREEN" Then
                    PREVIEW.List4.AddItem Space$(OFS%) + Left$(SUBTI$(RI%), ATOT%)
                  Else
         ...
         If ARCHISAL$ = "" Then
              ...
              ElseIf ARCHISAL$ = "SCREEN" Then
                If TNC% > 0 Then
                     ...
                     PREVIEW.List4.AddItem LII$(1)
                     If CAENCOL% < 1 Then
                          PREVIEW.List4.AddItem ENCA$
                        Else
                          For KKCOL% = 1 To CAENCOL%
                            PREVIEW.List4.AddItem ENCATAB$(KKCOL%)
                          Next KKCOL%
                     End If
                     PREVIEW.List4.AddItem LII$(2)
                   Else ' LII$(1)
                     PREVIEW.List1.AddItem "  "
                     PREVIEW.List4.AddItem LII$(2)
                     If CAENCOL% < 1 Then
                          PREVIEW.List1.AddItem ENCA$
                        Else
                          For KKCOL% = 1 To CAENCOL%
                            PREVIEW.List1.AddItem ENCATAB$(KKCOL%)
                          Next KKCOL%
                     End If
                End If
              Else
    ...
    For CLIJ% = 1 To TNC%
        ...
        If TVL%(CLNC%(CLIJ%)) = 6 Then
            ...
            If ARCHISAL$ = "" Then
                ...
                If INTERLIX > 0 Then CURRY = CURRY + INTERLIX: Printer.CurrentY = CURRY
              ElseIf ARCHISAL$ = "SCREEN" Then
                PREVIEW.List4.AddItem TTXI1$
                If SUBRA1$ <> "" Then PREVIEW.List4.AddItem SUBRA1$
              Else
                Print #ASAL%, TTXI1$
...
Sub VERDATLIS()
    ...
    '
    If SALEXCEL% < 1 Then
      ASALI$ = TRIM$(UCase$(WLITAB04.Text2.TEXT))
      If ASALI$ = "" Then
         DATLISTOK% = 1
         Exit Sub
      End If
...
Sub SORTABU()
    ...
    '
    JJ& = 0
    FINPRO& = WSORTB04.LISORT.ListCount - 1
    URETRA& = ULTREG&(ARCHITRA$)
    For U& = 0 To WSORTB04.LISORT.ListCount - 1
       Call TRACE(20, U&, FINPRO&)
       RECNO& = Val(Mid$(WSORTB04.LISORT.List(U&), PPX% + 1))
       If RECNO& > 0 Then
...
Sub PRENTRA()
    ...
    '    Exit Sub
    'End If
    ACAREN = WEDTAB04.LITAB.Height / CARELI%
    RENGLOAC = WEDTAB04.LITAB.ListIndex - WEDTAB04.LITAB.TopIndex + 1
    If RENGLOAC < 1 Or RENGLOAC > CARELI% Then
        Exit Sub
    End If
    YAPRE% = 1
    BORDESUPE = WEDTAB04.Top + WEDTAB04.LITAB.Top + RENGLOAC * ACAREN
    KPLA% = 0: PRICA% = 0
    '
    BLANCO = &H80000005
    For II% = 0 To 31
    ...
    FORMEDIT.Left = WEDTAB04.Left
    FORMEDIT.Width = WEDTAB04.Width
    FORMEDIT.Height = ALTUCON% * 1.2
    '
    If MODEDI% = 5 Then
        ' FORMEDIT.Top = WEDTAB04.Top + WEDTAB04.FRAMETOT.Top
        FORMEDIT.Top = WEDTAB04.Top + WEDTAB04.LITAB.Top + (CARELI% + 1) * ACAREN + (WEDTAB04.FRAMETOT.Height - FORMEDIT.Height) / 2
    End If
    '
    FORMEDIT.command1.Left = WEDTAB04.FRAMEBOT2.Left
    FORMEDIT.command1.Width = WEDTAB04.BOTAGRE.Width * 0.6
    FORMEDIT.Command2.Left = FORMEDIT.command1.Left + FORMEDIT.command1.Width
    FORMEDIT.Command2.Width = WEDTAB04.BOTAGRE.Width * 0.4
    ...
    For II% = 1 To NCL%
       ...
       If CL%(II%) > 0 Then
          ...
          FORMEDIT.ENTRA(II% - 1).FontName = WEDTAB04.LITAB.FontName
          FORMEDIT.ENTRA(II% - 1).FontSize = WEDTAB04.LITAB.FontSize
          FORMEDIT.ENTRA(II% - 1).FontBold = WEDTAB04.LITAB.FontBold
          If PE%(II%) <> 1 Then
    ...
    If MODEDI% = 4 Then                     ' editar registro
        RELIB$ = WEDTAB04.LITAB.TEXT
        XXX$ = REGLEIDO(ARCHILOC$, WEDTAB04.LITAB.ListIndex + 1)
        For II% = 1 To NCL%
           If CL%(II%) > 0 Then
...
Sub ADDLISTA()
    ...
    End If
    '
    WEDTAB04.LITAB.AddItem Space$(ATOT%)
    Call VERISCROLL
    WEDTAB04.LITAB.ListIndex = WEDTAB04.LITAB.ListCount - 1
    If WEDTAB04.LITAB.TopIndex < WEDTAB04.LITAB.ListIndex - CARELI% Then
        WEDTAB04.LITAB.TopIndex = WEDTAB04.LITAB.ListCount - CARELI% - 3
    End If
    MODEDI% = 1
    NUREGIS& = WEDTAB04.LITAB.ListCount + 1
...
Sub INSLISTA()
    ...
    End If
    '
    ILISTA& = WEDTAB04.LITAB.ListIndex
    If ILISTA& < 0 Or ILISTA& > WEDTAB04.LITAB.ListCount - 1 Then
        ILISTA& = 0
    End If
    '
    WEDTAB04.LITAB.AddItem Space$(ATOT%), ILISTA&
    Call VERISCROLL
    WEDTAB04.LITAB.ListIndex = ILISTA&
    If WEDTAB04.LITAB.TopIndex < WEDTAB04.LITAB.ListIndex - CARELI% Then
        WEDTAB04.LITAB.TopIndex = WEDTAB04.LITAB.ListIndex - CARELI% / 2
    End If
    '
...
Sub BORLISTA()
    ...
    End If
    '
    WEDTAB04.LITAB.RemoveItem ILISTA&
    Call VERISCROLL
    ...
    '
    If ILISTA& > WEDTAB04.LITAB.ListCount - 1 Then
       ILISTA& = WEDTAB04.LITAB.ListCount - 1
    End If
    WEDTAB04.LITAB.ListIndex = ILISTA&
    '
    NUREGIS& = ILISTA& + 1
...
Sub EDLISTA()
    '
    If WEDTAB04.LITAB.ListIndex < 0 Then
        Exit Sub
    End If
    '
    If WEDTAB04.LITAB.ListIndex >= WEDTAB04.LITAB.ListCount Then
        Exit Sub
    End If
    '
    MODEDI% = 4
    NUREGIS& = WEDTAB04.LITAB.ListIndex + 1
    REACTIVO$ = REGLEIDO$(ARCHILOC$, NUREGIS&)
    '
    Call PRENTRA
    '
...
Sub BULISTA()
    ...
    Exit Sub
    '
    If WEDTAB04.LITAB.ListCount < 1 Then
        Exit Sub
    End If
    MODEDI% = 5
    Call PRENTRA
...
20  If ORIENTA% = 1 Then
         WLITAB04.Option2(0).Value = True        ' RETRATO
       Else
         WLITAB04.Option2(1).Value = True        ' PAISAJE
    End If
    WLITAB04.Text4(0).TEXT = CSTRING$(MKS$(ANCHOPAP), 3, 6, 1, 1)
    WLITAB04.Text4(1).TEXT = CSTRING$(MKS$(LARGOPAP), 3, 6, 1, 1)
    WLITAB04.Text4(2).TEXT = CSTRING$(MKS$(MARGENS), 3, 6, 1, 1)
    WLITAB04.Text4(3).TEXT = CSTRING$(MKS$(MARGENI), 3, 6, 1, 1)
    WLITAB04.Text6.TEXT = CACOPIAS%
    WLITAB04.Check2.Value = 0
    If RENULIS% = 1 Then
      WLITAB04.Check2.Value = 1
    End If
    '
End Sub
...
5   On Error GoTo 199
    ...
    On Error GoTo 0
    '
    If Val(WLITAB04.Text4(0).TEXT) > 0 Then
        If Val(WLITAB04.Text4(0).TEXT) < ANCHOPAP Then
            ANCHOPAP = Val(WLITAB04.Text4(0).TEXT)
        End If
    End If
    If Val(WLITAB04.Text4(1).TEXT) > 0 Then
        If Val(WLITAB04.Text4(1).TEXT) < LARGOPAP Then
            LARGOPAP = Val(WLITAB04.Text4(1).TEXT)
        End If
    End If
    MARGENI = Val(WLITAB04.Text4(3).TEXT)
    MARGENS = Val(WLITAB04.Text4(2).TEXT)
    ORIENTA% = 1
    If WLITAB04.Option2(1).Value = True Then
        ORIENTA% = 2
    End If
    CACOPIAS% = 1
    If Val(WLITAB04.Text6.TEXT) > 0 Then
        If Val(WLITAB04.Text6.TEXT) <= 32 Then
            CACOPIAS% = Val(WLITAB04.Text6.TEXT)
        End If
    End If
    '
    Dim PPZZ As String * 128
...
9   Close #NX%
    '
    RENULIS% = 0
    If WLITAB04.Check2.Value = 1 Then RENULIS% = 1
    '
...
29 Next I%
   ...
   '
   For U& = 1 To WEDTAB04.LITAB.ListCount
      If MODOSEL% = 0 Or WEDTAB04.LITAB.Selected(U& - 1) = True Then
35       POVERT = POVERT + HREN
         ...
         Printer.Print RTrim$(Mid$(WEDTAB04.LITAB.List(U& - 1), 2, ATOT% - 1))
      End If
   Next U&
   '
   If MODOSEL% = 0 Then
      ...
      Printer.Print RTrim$(Mid$(WEDTAB04.TOTALI.Caption, 2, ATOT% - 1))
   End If
   '
   GoSub LEPIEPA
   Printer.EndDoc
...
IMPREFORM:
   ...
   '
   VFILMAX = 0
   COEF = ATEXTO / (WEDTAB04.LITAB.Width - 240)
   For II% = 1 To NFT%
      If WEDTAB04.FILABEL(II% - 1).Visible = True Then
         V2 = 4 * HREN + WEDTAB04.FIENTRA(II% - 1).Top + HREN * 1.3
   ...
   For II% = 1 To NFT%
      ...
      If WEDTAB04.FILABEL(II% - 1).Visible = True Then
         '
         TTXX$ = WEDTAB04.FILABEL(II% - 1).Caption
         H1 = COEF * WEDTAB04.FILABEL(II% - 1).Left + MARGENI
         V1 = 4 * HREN + WEDTAB04.FILABEL(II% - 1).Top
         Printer.CurrentX = H1
         Printer.CurrentY = V1
         Printer.Print TTXX$
         '
         H1 = COEF * WEDTAB04.FIENTRA(II% - 1).Left + MARGENI
         H2 = H1 + COEF * WEDTAB04.FIENTRA(II% - 1).Width
         If H2 > MARGENI + ATEXTO - 150 Then H2 = MARGENI + ATEXTO - 150
         ANCHOCUA = H2 - H1 - 100
         V1 = 4 * HREN + WEDTAB04.FIENTRA(II% - 1).Top
         V2 = V1 + HREN * 1.3
         If V2 > VFILMAX Then VFILMAX = V2
         Printer.Line (H1, V1)-(H2, V2), QBColor(0), B
         '
         TTXX$ = WEDTAB04.FIENTRA(II% - 1).TEXT
34       If Printer.TextWidth(TTXX$) > ANCHOCUA Then
         ...
         Printer.Print TTXX$
         '
         If WEDTAB04.FIECO(II% - 1).Visible = True Then
            H1 = COEF * WEDTAB04.FIECO(II% - 1).Left + MARGENI
            H2 = H1 + COEF * WEDTAB04.FIECO(II% - 1).Width
            If H2 > MARGENI + ATEXTO - 150 Then H2 = MARGENI + ATEXTO - 150
            ANCHOCUA = H2 - H1 - 100
            V1 = 4 * HREN + WEDTAB04.FIECO(II% - 1).Top
            V2 = V1 + HREN * 1.3
            If V2 > VFILMAX Then VFILMAX = V2
            Printer.Line (H1, V1)-(H2, V2), QBColor(0), B
            '
            TTXX$ = WEDTAB04.FIECO(II% - 1).TEXT
...
Sub GRAENTRA()
  ...
  Else
    ...
    If MODEDI% = 1 Or MODEDI% = 2 Or MODEDI% = 4 Then  ' editar registro
       ...
       Next II%
       If TIFORTAB% <> 1 Then
            Call GRAREG(ARCHILOC$, XXX$, WEDTAB04.LITAB.ListIndex + 1)
          Else
       ...
       If TIFORTAB% <> 1 Then
            ILISTA& = WEDTAB04.LITAB.ListIndex
            WEDTAB04.LITAB.RemoveItem ILISTA&
            WEDTAB04.LITAB.AddItem RELIB$, ILISTA&
            Call VERISCROLL
            If ILISTA& < WEDTAB04.LITAB.ListCount Then
                 WEDTAB04.LITAB.ListIndex = ILISTA&
               Else
                 WEDTAB04.LITAB.ListIndex = WEDTAB04.LITAB.ListCount - 1
            End If
...
Sub CANCELENTRA()
  ...
  Else
    ...
    If TRIM$(RELIB$) = "" Then
         If TIFORTAB% <> 1 Then
              WEDTAB04.LITAB.RemoveItem ILISTA&
              REGRARE& = WEDTAB04.LITAB.ListCount + 1
            Else
              XFORTAB.LITAB.RemoveItem ILISTA&
...
Sub VERISCROLL()
    ...
    Static LIANT&
    If TIFORTAB% <> 1 Then
         If WEDTAB04.LITAB.ListCount <> LIANT& Then
             LIANT& = WEDTAB04.LITAB.ListCount
             If WEDTAB04.LITAB.ListCount > CARELI% Then
                 WEDTAB04.VScroll1.Visible = False
               Else
                 WEDTAB04.VScroll1.Visible = True
             End If
         End If
