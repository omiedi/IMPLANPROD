...
Function PORCENT_COSTO_NACIONALIZACION(NUMEBORE&, Optional MONEDX%, Optional MONECOMP%)
    ...
    If NUFACTU$ <> "" Then
       '
       CONDI$ = "FACTURAPROV_ASOC = '" & NUFACTU$ & "' AND MoneVal = " & 1 & " and Nume_cli = " & NPROV& & "and  TIPO_FACTURA = 'M'"
       ...
       End If
       '
       CONDI$ = "FACTURAPROV_ASOC = '" & NUFACTU$ & "' AND MoneVal = " & 2 & " and Nume_cli = " & NPROV& & "and  TIPO_FACTURA = 'M'"
