...
{
    /// <summary>
    /// Entidad que representa el encabezado de un programa de fabricación.
    /// Mapea a la tabla PROFABRI en la base de datos.
    /// Implementa IAuditableEntity para auditoría automática.
    /// </summary>
    [Table("PROFABRI")]
    public class Profabri : IAuditableEntity
    {
        /// <summary>
        /// Identificador único del programa (campo IDENTITY)
        /// </summary>
        [Key]
        ...
        /// <summary>
        /// Número único del programa de fabricación
        /// </summary>
        [Required]
        public int NumeroPrograma { get; set; }

        /// <summary>
        /// Descripción del programa de fabricación
        /// </summary>
        [Required]
        [MaxLength(48)]
        ...
        /// <summary>
        /// Estado del programa (0=Borrador, 1=Activo, 8=Anulado)
        /// </summary>
